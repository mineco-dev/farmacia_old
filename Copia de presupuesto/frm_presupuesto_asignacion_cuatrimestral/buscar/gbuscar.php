...
function enviardata(form,linea)
{
	alert(form['c['+valores+']'].value);
	alert(form['obj['+valores+']'].value);
	alert(form['id['+valores+']'].value);
	alert(form['me['+valores+']'].value);
//	location.href = "ppto_renglon.php"	
}
...
<body>
<form name="form1" id="form1" method="get"   enctype="multipart/form-data" >
					  ...
					  $i=1;					  
						...
						while($row_qry_insertados=$fetch_array($res_qry_insertados))
						{
							  ...
							  while ($cnt<=$no_campos_detalle) 
							  {
								...
								echo '<td class='.$clase.'><center><a href="../operar.php?id='.$row_qry_insertados[0].'&obj='.$obj.'&c=1"><img src="../../../images/iconos/ico_editar.gif" alt="Cuatrimestre 1" border="0"></a></center></td>';
								echo '<td class='.$clase.'><center><a href="../operar.php?id='.$row_qry_insertados[0].'&obj='.$obj.'&c=2"><img src="../../../images/iconos/ico_editar.gif" alt="Cuatrimestre 2" border="0"></a></center></td>';
								echo '<td class='.$clase.'><center><a href="../operar.php?id='.$row_qry_insertados[0].'&obj='.$obj.'&c=3"><img src="../../../images/iconos/ico_editar.gif" alt="Cuatrimestre 3" border="0"></a></center></td>';  
