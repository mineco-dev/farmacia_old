...
<table width="100%" border=1 cellspacing="0" id="tabla4">
  <tr>
    ...
    <th colspan="4" scope="col">Devengado</th>
  </tr>
  <tr>
    ...
    <th width="53" scope="col"><span class="Estilo2">Mes 1 </span></th>
    <th width="47" scope="col"><span class="Estilo2">Mes 2</span></th>
    <th width="54" scope="col"><span class="Estilo2">Mes 3 </span></th>
    <th width="78" scope="col"><span class="Estilo2">Mes 4 </span></th>
  </tr>
</table>
<br>
<input name="Bot&oacute;n" type="button" onClick="agregar4();cargaDatos(this.form);" value="Agregar l&iacute;nea">
<input name="Bot&oacute;n" type="button" onClick="borrarUltima4();desCargaDatos(this.form);" value="Borrar l&iacute;nea"> 
<a href="gppto_renglon2.php">update</a>
</body>
</html>