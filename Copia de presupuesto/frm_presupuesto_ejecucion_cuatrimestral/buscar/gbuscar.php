...
<table border="1" width="95%" cellpadding="0" cellspacing="0" align="center">
	<?			
				...
				{	   	  			
					 // echo '<tr><td align="right" colspan="'.$no_campos_detalle.'"><a href="../agregar.php"><img src="../../images/iconos/ico_agregar.gif" alt="Agregar registro" border="0"></a></td></tr>';
					  ...
					  $i=1;					  
						...
						echo '<td class="boxTitleBgLightBlue" align="center">C1</td>';
						echo '<td class="boxTitleBgLightBlue" align="center">C2</td>';
						echo '<td class="boxTitleBgLightBlue" align="center">C3</td>';						
						echo '</tr>';
						...
						while($row_qry_insertados=$fetch_array($res_qry_insertados))
						{
							...
							print $cadena;
							  ...
							  while ($cnt<=$no_campos_detalle) 
							  {
								...
								echo '<td class='.$clase.'><center><a href="../operar.php?id='.$row_qry_insertados[0].'&obj='.$obj.'&c=1"><img src="../../../images/iconos/ico_editar.gif" alt="Cuatrimestre 1" border="0"></a></center><select name="me" id="me"><option value="1">Ene</option><option value="2">Feb</option><option value="3">Mar</option><option value="4">Abr</option></select></td>';
								echo '<td class='.$clase.'><center><a href="../operar.php?id='.$row_qry_insertados[0].'&obj='.$obj.'&c=2"><img src="../../../images/iconos/ico_editar.gif" alt="Cuatrimestre 2" border="0"></a></center><select name="me" id="me"><option value="5">May</option><option value="6">Jun</option><option value="7">Jul</option><option value="8">Ago</option></select></td>';
								echo '<td class='.$clase.'><center><a href="../operar.php?id='.$row_qry_insertados[0].'&obj='.$obj.'&c=3"><img src="../../../images/iconos/ico_editar.gif" alt="Cuatrimestre 3" border="0"></a></center><select name="me" id="me"><option value="9">Sep</option><option value="10">Oct</option><option value="11">Nov</option><option value="12">Dic</option></select></td>';  					
		...
		{
			echo '<tr><td class="error" colspan="3" align="center">NO HA SELECCIONADO NINGUN OBJETO PARA LA BUSQUEDA, PARA INTENTARLO NUEVAMENTE <a href="buscar.php?obj=34">[HAGA CLIC AQUI]</a></td></tr>';
		}
	?>            	  
</table>
</body>
