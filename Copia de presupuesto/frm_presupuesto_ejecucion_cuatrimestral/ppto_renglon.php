...
<table width="100%"  border="0">
  ...
  <tr>
    <td rowspan="6">&nbsp;</td>
    <td width="11%" height="25" class="titulocategoria">Fuente:</td>
    <td width="59%"><span class="legal"><? echo $contenido[2]; ?><span class="titulocategoria"> Programa: </span><? echo $contenido[3]; ?></span></td>
    <td rowspan="6">&nbsp;</td>
  </tr>
  <tr>
    <td height="25" class="titulocategoria">Subprograma:</td>
    <td height="25"><? echo $contenido[5]; ?><span class="titulocategoria"> Subproyecto: <span class="legal"><? echo $contenido[6]; ?></span></span></td>
  </tr>
  
  <tr>
    <td height="25" class="titulocategoria">Actividad:</td>
    <td height="25"><span class="legal"><? echo $contenido[4]; ?></span></td>
  </tr>
  <tr>
    <td height="25" class="titulocategoria">Cuatrimestre:</td>
    <td height="25"><span class="legal"><? echo $c; ?><span class="titulocategoria"> A&ntilde;o: <? echo $contenido[7]; ?></span></span></td>
  </tr>
  <tr>
    <td height="25" class="titulocategoria">Grupo:</td>
    <td height="25"><span class="titulocategoria"><span class="legal"><? echo $nombre_grupo; ?></span></span></td>
  </tr>
  <tr>
    <td height="25" class="titulocategoria">Saldo COMPROMETIDO:</td>
    <td height="25">
	...
	<? 
				...
				$qry_codigo_grupo="select codigo_grupo from cat_grupo where nombre_grupo = '$nombre_grupo'";
				$salida_codigo_grupo = mssql_query($qry_codigo_grupo);
				$out_codigo_grupo = mssql_fetch_row($salida_codigo_grupo);
				$codigo_grupo_valor = $out_codigo_grupo[0];
	
	// $pr codigo_financiamiento_actividad
	// $codigo_grupo_valor  codigo_grupo
	// $c cuatrimestre codigo_periodo
	
				$consulta_tb_asignacion = "select d.monto_asignado,d.monto_solicitado,d.codigo_asignacion_cuatrimestral 
				from tb_asignacion_cuatrimestral  d 
				where d.codigo_financiamiento_actividad = $pr 
				and d.codigo_periodo = $c 
				and d.codigo_grupo = $codigo_grupo_valor";
				
				$resultado_tb_asignacion = mssql_query($consulta_tb_asignacion);								
				
//				print $consulta_tb_asignacion;
				
				
				$vector_tb_asignacion = mssql_fetch_row($resultado_tb_asignacion);
				
	
	
	
	echo 'Q'.number_format($vector_tb_asignacion[0], 2, '.', ',');
		//$txt_monto_solicitado_saldo = $saldo;
	 ?>
...
<table width="90%" border="0" align="center">		  
		   ...
		   <td>
			...
			<div id="TabbedPanels1" class="TabbedPanels">
				...
				<li class="TabbedPanelsTab style3" tabindex="0">EJECUCION PRESUPUESTARIA POR GRUPO Y CUATRIMESTRE</li>				
				</ul>
	...
	<tr>
	<td><center><input name="cmd_guardar" type="button" onClick="validar(this.form)" id="cmd_guardar" value="Guardar" <? echo $status?> >
