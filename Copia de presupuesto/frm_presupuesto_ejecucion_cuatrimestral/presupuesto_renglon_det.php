...
function agregar4() {
	...
	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"proveedor["+contLin4+"]\" type=\"text\" id=\"textfield\" size=\"40\" maxsize=\"100\">";

	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"no_orden["+contLin4+"]\" type=\"text\" id=\"select\" size=\"10\">";
	
	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"fecha["+contLin4+"]\" type=\"text\" id=\"select\" size=\"10\">";
	
	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"devengado["+contLin4+"]\" type=\"text\" id=\"select\" size=\"10\">";
	
	
	
	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"comprometido["+contLin4+"]\" type=\"text\" id=\"select\" size=\"10\"  >";
