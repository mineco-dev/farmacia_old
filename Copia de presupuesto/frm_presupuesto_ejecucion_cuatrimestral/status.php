...
<table width="100%"  border="0">
  <tr>
    ...
    <td width="10%"><div align="right"><img src="../../images/presupuesto.jpg" width="128" height="89"></div></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	{			
		...
		{				
			...
			conectardb($presupuesto);
				...
				if ($res_insert)
				{					
					echo '<tr><td class="titulocategoria" colspan="3" align="center">SE HA CAMBIADO EL ESTADO DEL REGISTRO CORRECTAMENTE<br><a href="buscar/buscar.php?obj='.$txt_obj.'">[REGRESAR]</a></td></tr>';															
	...
	{
		echo '<tr><td class="error" colspan="3" align="center">Para hacer otra modificación<a href="buscar/buscar.php?obj='.$txt_obj.'">[HAGA CLIC AQUI]</a></td></tr>';
	}
	?>            
	</td>
  </tr>
