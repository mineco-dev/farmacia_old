					...
					//inserta registro en tb_inventario_responsable_det	
					 $cnt=1; 		
					  ...
					  {						
						...
						$qry_presupuesto_grupo="insert into tb_presupuesto_anual(codigo_financiamiento_actividad, codigo_grupo,monto_presupuestado, activo) values ($codigo_financiamiento_enc, $codigo_grupo, $monto[$cnt], 1)";										
