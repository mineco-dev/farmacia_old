...
<table width="80%"  border="0" align="center">
  <tr>
    <td width="18%" height="25"><div align="center"><img src="../../images/logo_rpt.gif" width="82" height="95" onClick="
    ...
    <span class="titulocategoria"><img src="../../images/presupuesto.jpg" width="128" height="89"></span></td>
  </tr>
  <tr>
					  ...
					  echo '<tr>';  			
						...
						while($row_qry_insertados=$fetch_array($res_qry_insertados))
						{
							  ...
							  while ($cnt<=$no_campos_detalle) 
							  {
								...
								echo "<td><a href=\"javascript:void(1)\" onClick=\"window.opener.document.getElementById('$tipo"."[".$posi."][0]').value = '$completo'; 
window.opener.document.getElementById('$tipo"."[".$posi."][1]').value = '".$row_qry_insertados["codigo_grupo"]."';
window.opener.document.getElementById('$tipo"."[".$posi."][2]').value = '".$row_qry_insertados["nombre_grupo"]."';

						window.opener.focus();												
						window.close();
						return false;
						 \"   onClick=\"window.close();\"><center><img src=\"../../images/iconos/ico_ir.gif\" border=\"0\" alt=\"Seleccionar este rengl�n\"></a></center></td>";
							   echo '</tr>';
							$i++;
						}
