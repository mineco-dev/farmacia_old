...
if(validaSelect($selectDestino) && validaOpcion($opcionSeleccionada))
{
	...
	if ($tabla == "cat_producto")
		...
		$consulta=mssql_query("SELECT p.codigo_producto, (p.producto +' - '+ p.marca +' EN '+ m.unidad_medida) as producto, p.activo, p.codigo_subcategoria, p.codigo_categoria 
								FROM     cat_producto p
								...
								WHERE b.codigo_subcategoria='$opcionSeleccionada' and p.activo=1 and b.codigo_bodega=1 and b.codigo_categoria='$cbo_categoria' order by producto");	
	...
	{	
		...
		WHERE s.codigo_categoria='$opcionSeleccionada' and activo=1 and c.codigo_bodega=1 ORDER BY s.codigo_subcategoria");
