...
{	
		...
		$campo_condicion="codigo_subcategoria";
        ...
        <td><center>
            <table width="80%" border="0" align="center" cellspacing="5">
              ...
              <tr>
                ...
                <td colspan="2"><input name="txt_subcategoria" type="text" id="txt_categoria2" value="<? echo $subcategoria; ?>" size="50"></td>
              </tr>
              <tr>
                ...
                <input name="txt_id" type="hidden" id="txt_id2" value="<? echo $rowid; ?>">
                <input name="txt_categoria" type="hidden" id="txt_categoria" value="<? echo $categoria; ?>"></td>
              </tr>
            </table>
        </center></td>
      </tr>
