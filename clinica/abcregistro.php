...
<table width="500" border="1" cellpadding="2" cellspacing="4">
  <tr>
    <td width="126"><div align="left" class="titulomenu">Creado por:</div></td>
    <td width="258" align="left" class="titulomenu"><? echo $creado.' -- '.$fecha_creado; ?>
    <div align="left"></div></td>
  </tr>
  <tr>
    <td><div align="left" class="titulomenu">Modificado por: </div></td>
    <td align="left" class="titulomenu"><? echo $modifico.' -- '.$fecha_modificado; ?>
    <div align="left"></div></td>
  </tr>
  <tr>
    <td><div align="left" class="titulomenu">Desactivado por: </div></td>
    <td align="left" class="titulomenu"><? echo $desactivo.' -- '.$fecha_desactivado; ?>
    <div align="left"></div></td>
  </tr>
</table>
