...
{			
		...
		$producto=strtoupper($_REQUEST["txt_producto"]);
		...
		$qry_actualiza="UPDATE cat_producto SET producto='$producto', marca='$marca', punto_reorden='$minima', existencia_maxima='$maxima', 
						  codigo_subcategoria='$subcategoria', codigo_medida='$medida', codigo_estado='$estado', uso='$uso', usuario_modifico='$nombre_usuario', 
