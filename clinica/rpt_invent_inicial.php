...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <?
			...
			$existe=false;
			$qry_ingreso_enc = "select * from tb_ingreso_enc where numero_documento='$hoja_despacho' and codigo_tipo_documento=12";
			conectardb($almacen);
        ...
        <td height="60"><div align="left">
          <table width="98%"  border="1" align="left" cellpadding="0" cellspacing="0">
            <tr class="titulotabla">
              <td><div align="left">INGRESADO POR </div>                
	...
	?>
        ...
        <td width="44%">
          <table width="98%"  border="1" align="right" cellpadding="0" cellspacing="0">
            <tr class="titulotabla">
              <td width="49%"><div align="center">NO. INVENTARIO</div></td>
              <td width="51%"><div align="center">SOLICITUD</div></td>
            </tr>
            <tr>
  ...
  <tr>    
    ...
    <table width="95%"  border="1" align="center" cellpadding="0" cellspacing="0">
      <tr class="titulotabla">
        ...
        <td width="15%" colspan="2"><div align="center">Uni. Medida</div></td>
       <!-- <td width="15%"><div align="center">Cantidad solicitada</div></td> -->
        <td width="15%"><div align="center">Cantidad Ingresada</div></td>
      </tr>	  
	 <?	  	
		...
		{			
			...
			echo '<td align="center" width="15%" colspan="2"><span class="descripcionproducto">'.$row_ingreso_det["unidad_medida"].'</span></td>';
