            ...
            <table width="100%" border="0" cellspacing="5">
              ...
              <tr>
				...
				<? 
				  ...
				  {
				  ?>
				  	<input name="txt_ref2" type="hidden" id="txt_ref2" value="<? echo $_REQUEST["ref"]; ?>">
				  <?
				  }
				  ?>
      ...
      <tr align="center" bgcolor="#006699" class="thead">
		...
		<?
				...
				while($row=$fetch_array($result))
				{
					...
					$estado=$row["activo"];
					if ($estado==1)					
					echo '<tr class='.$clase.'><td colspan="3">'.$row["unidad_medida"].'</td><td><center><a href="editar_medida.php?id='.$row["codigo_medida"].'"><img src="../images/iconos/ico_editar.jpg" alt="Modificar información"></a></center></td><td><center><a href="cambia_stat.php?id='.$row["codigo_medida"].'&stat=2&ref=3"><img src="../images/iconos/ico_activo.gif" alt="Activo"></a></center></td></tr>';					
					else
						echo '<tr class='.$clase.'><td colspan="3">'.$row["unidad_medida"].'</td><td><center><a href="editar_medida.php?id='.$row["codigo_medida"].'"><img src="../images/iconos/ico_editar.jpg" alt="Modificar información"></a></center></td><td><center><a href="cambia_stat.php?id='.$row["codigo_medida"].'&stat=1&ref=3"><img src="../images/iconos/ico_desactivado.gif" alt="Desactivado"></a></center></td></tr>';										
					$i++;
				}
				$free_result($result);
			 ?>
