...
<br>
<form name="frm_solicitud" id="frm_solicitud" action="solicitud/solicitud_guarda.php">
...
<table  width="95%" border="0">
  ...
  <tr>
    <td>No. Formulario</td>
    <td colspan="3"><label>
      <input type="text" name="nexpediente" id="nexpediente" />
    (si utilizo  formulario preimpreso)</label></td>
  </tr>
  <tr>
    <td>Actua como</td>
    <td colspan="3">
