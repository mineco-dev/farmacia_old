...
<table width="100%"  border="0">
  <tr>
    ...
    <td width="72%"><p align="center" class="titulocategoria Estilo1">CENTRO DE INFORMACI&Oacute;N</p>
    <p align="center" class="titulocategoria"> MODULO DE: BIBLIOTECA VIRTUAL</p></td>
  ...
  <tr>
	...
	{			
		...
		if (($acceso>=4) && ($acceso<=8))
		{
			...
			while ($cnt<=count($campo)) //concatena lista de campos a grabar
				...
				if ($res_insert)
				{					
					echo '<tr><td class="titulocategoria" colspan="3" align="center">EL REGISTRO SE HA ACTUALIZADO CORRECTAMENTE<br></td></tr>';															
	...
	{
		echo '<tr><td class="error" colspan="3" align="center">UTILICE LAS OPCIONES DEL MEN� QUE SE ENCUENTRA A LA IZQUIERDA</a></td></tr>';
	}
	?>            
	</td>
  </tr>
