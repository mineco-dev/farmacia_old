...
<table width="100%"  border="0">
  <tr>
    ...
    <td width="77%"><p align="center" class="titulocategoria Estilo1">BIBLIOTECA VIRTUAL Y TECNOL&Oacute;GICA - BIVITEC</p>
    <p align="center" class="titulocategoria"> MODULO DE: DOCUMENTOS Y LIBROS</p></td>
    <td width="12%"><div align="right"><img src="../../images/libros.jpg" width="128" height="87"></div></td>
  </tr>
  <tr>
				...
				if (!$registro_encontrado)
				{
						...
						while ($cnt<=count($campo))  //concatena el contenido a grabar en los campos
						{
							...
							if (($tipo_campo[$cnt]=='8') || ($tipo_campo[$cnt]=='10'))
							{
								...
								if ($dia=="") $variable="";
								else $variable=$anio.'-'.$mes.'-'.$dia.' '.$hora.':'.$minutos.':00';							  					
							}
							else
						...
						$qry_insert.="'$nombre_usuario', getdate(), 2)";												
						session_unregister("ingresando_obj");																																													
						$res_insert=$query($qry_insert);									
						if ($res_insert)
						{
							echo '<tr><td class="titulocategoria" colspan="3" align="center">EL REGISTRO SE HA GRABADO CORRECTAMENTE<br><br>Para ingresar otro documento <a href="agregar.php">[HAGA CLIC AQUI]</a></td></tr>';															
