...
<table width="100%"  border="0">  
  <tr>
    <td height="8" colspan="3">    
      <div align="center"><span class="legal2">DOCUMENTOS RELACIONADOS CON LA B&Uacute;SQUEDA</span></div></td>   
  </tr>
</table>   
<table border="1" width="95%" cellpadding="0" cellspacing="0" align="center">
	<?			
		...
		if (isset($operador_and)) $operador='and';
		else $operador='or';
			...
			$qry_plantilla="SELECT c.codigo_campo, c.campo, c.codigo_tipo_campo, c.tb_origen, c.validar, c.texto_validacion, c.ayuda,
				...
				while ($cnt<=count($campo)) //si los campos traen algun contenido, los compara para filtrarlos
				{
					...
					{						
						if ($tipo_campo[$cnt]==1)
						{	
							$qry_condicion.=" $operador $tb_detalle.$campo[$cnt] like '%$variable%' ";									
						}
						else
						if ($tipo_campo[$cnt]==2)
						{
							$qry_condicion.=" $operador $tb_detalle.$campo[$cnt]='$variable' ";									
						}			
						else
						if ($tipo_campo[$cnt]==7)
						{
				...
				{	   	  			
					 // echo '<tr><td align="right" colspan="'.$no_campos_detalle.'"><a href="../agregar.php"><img src="../../images/iconos/ico_agregar.gif" alt="Agregar registro" border="0"></a></td></tr>';
					  ...
					  $i=1;					  
						...
						echo '</tr>';
						$no_campos_detalle=$no_campos_detalle-13;						
						while($row_qry_insertados=$fetch_array($res_qry_insertados))
						{
							  ...
							  while ($cnt<=$no_campos_detalle) 
							  {
								...
								echo '<td class='.$clase.'><center><a href="../editar.php?id='.$row_qry_insertados[0].'"><img src="../../../images/iconos/ico_ver.jpg" alt="Ver registro completo" border="0"></a></center></td>';  					
			if ($status==1)				
		    echo '<td class='.$clase.'><center><a href="../status.php?id='.$row_qry_insertados[0].'&st=2"><img src="../../../images/iconos/ico_activo.gif" alt="Desactivar" border="0"></a></center></td>';					
				else if ($status==2)
				echo '<td class='.$clase.'><center><a href="../status.php?id='.$row_qry_insertados[0].'&st=1"><img src="../../../images/iconos/ico_desactivado.gif" alt="Activar" border="0"></a></center></td>';					
										echo '</tr>';
										$i++;
						 }
