...
<div align="center">
  <table width="90%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <th width="12%" class="legal2" scope="row"><img src="../../../images/logo_rpt_mineco.gif" width="82" height="95"></th>
      <th width="78%" class="legal2" scope="row"><p align="center" class="titulocategoria Estilo1">BIBLIOTECA VIRTUAL Y TECNOL&Oacute;GICA - BIVITEC</p>
      <p align="center" class="titulocategoria"> MODULO DE: DOCUMENTOS Y LIBROS </p></th>
      <th width="10%" class="legal2" scope="row"><img src="../../../images/libros.jpg" width="128" height="87"></th>
    </tr>
    <tr>
      <th colspan="3" class="legal2" scope="row">BUSQUEDA DE DOCUMENTOS</th>
    </tr>
  </table>
</div>
<form name="form1" method="post" action="gautorizar.php">
  ...
  <tr>
    ...
    <img src="../../../images/linea.gif" width="100%" height="6"></td>   
	  ...
	  <table width="80%"  border="0" align="center" cellpadding="0" cellspacing="0">
		...
		{
		$acceso=permisosdb($biblioteca);											
		if (($acceso>=1) && ($acceso<=8))
		{			
			echo '<tr><td colspan="2" align="left" class="titulomenu"><img src="../../../images/iconos/ico_help.gif" alt="" border="0">&nbsp;Para una b�squeda espec�fica llene los campos necesarios, de lo contrario muestra todo el contenido de la BD.
			<br><input name="operador_and" type="checkbox" id="operador_and" value="SI" checked>&nbsp;Si est� casilla permanece activada cada registro buscado deber� cumplir todos los criterios de b�squeda ingresados, de lo contrario bastar� con que cumpla alguno de ellos.</td></tr>';	
			...
			$condicion_detalle="where $campo_detalle=2";
			$qry_orden="order by ";			
			$qry_datos_insertados.="$campo_detalle ";
  ...
  {	 
		...
		{		 
		 // echo '<tr><td align="right" colspan="'.$no_campos_detalle.'"><a href="../agregar.php"><img src="../../../images/iconos/ico_agregar.gif" alt="Agregar registro" border="0"></a></td></tr>';
		  $no_campos_detalle++;
		  echo '<tr><td class="boxTitleBgLightBlue" colspan="'.$no_campos_detalle.'" align="center">DOCUMENTOS INGRESADOS</td></tr>';		  
		  $no_campos_detalle--;		 
		  ...
		  $i=1;		  
			...
			echo '<td class="boxTitleBgLightBlue" align="center">Autorizar</td>';			
		  ...
		  while($row_qry_insertados=$fetch_array($res_qry_insertados))
		  {
			  ...
			  while ($cnt<=$no_campos_detalle) 
			  {
				...
				$cnt++;
		         ...
		         echo '<td class='.$clase.'><center><a href="../autoriza.php?id='.$row_qry_insertados[0].'&st=1"><img src="../../../images/iconos/transferencia.gif" alt="Autorizar" border="0"></a></center></td>';					
				 echo '<td class='.$clase.'><center><a href="../rechaza.php?id='.$row_qry_insertados[0].'&st=3"><img src="../../../images/iconos/ico_esperar.jpg" alt="Eliminar de la Biblioteca" border="0"></a></center></td>';					
			echo '</tr>';
			$i++;
		 }
