	...
	{			
		...
		{				
			...
			conectardb($biblioteca);
				...
				if ($res_insert)
				{					
					echo '<tr><td class="titulocategoria" colspan="3" align="center">SE HA CAMBIADO EL ESTADO DEL REGISTRO CORRECTAMENTE<br><br>Para ingresar otro registro <a href="index.php">[HAGA CLIC AQUI]</a></td></tr>';															
				} // fin del ingreso del encabezado
				else
				{
					echo '<tr><td class="error" colspan="3" align="center">Se produjo un error al grabar, NO se ha cambiado el estado del registro<br><br>Para intentar nuevamente <a href="index.php">[HAGA CLIC AQUI]</a></td></tr>';
				}	
