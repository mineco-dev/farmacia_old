      ...
      <table width="95%%" border="0" align="center">
        <tr>
          <td><div id="CollapsiblePanel1" class="CollapsiblePanel">
            <div class="CollapsiblePanelTab" tabindex="0"><img src="imagenes/punto3.jpg" width="16" height="16"> Solicitudes no atendidas</div>
      ...
      <table width="95%%" border="0" align="center">
        <tr>
          <td><div id="CollapsiblePanel3" class="CollapsiblePanel">
              <div class="CollapsiblePanelTab" tabindex="0"><img src="imagenes/punto1.jpg" alt="" width="16" height="16"> Solicitudes finalizadas</div>
            <div class="CollapsiblePanelContent"><? 
		  	$mtstatus = "3";
		  	include("../solicitud/ver/atendidas.php");
		  ?>
