...
<form action="usuarioguarda.php" method="post" enctype="multipart/form-data" name="form1">
<table width="97%" border="0" align="center" class="panel">
  <tr>
    <td><table width="100%%" border="0" class="grey">
      <tr>
        <td><strong> Solicitudes al <? print get_formatofecha(date("d")."-".date("m")."-".date("Y")); ?></strong></td>
      </tr>
    </table>
		<br>
      <table width="95%%" border="0" align="center">
        <tr>
          ...
          <?
		  	$mensaje = "";
          	if ($ver==1) $mensaje = "<img src=\"imagenes/punto3.jpg\"> Solicitudes no atendidas";
          	if ($ver==2) $mensaje = "<img src=\"imagenes/punto2.jpg\"> Solicitudes en proceso";
          	if ($ver==3) $mensaje = "<img src=\"imagenes/punto1.jpg\"> Solicitudes finalizadas";
		  	print $mensaje;
		  ?>          </td>
        </tr>
        <tr>
          ...
          <?
          	if ($ver==1) $mtstatus = "5";
          	if ($ver==2) $mtstatus = "1";
          	if ($ver==3) $mtstatus = "0,2,3,4,6,7,8";
			
		  	include("../solicitud/ver/atendidas.php");
          ?>          </td>
        </tr>
      </table>
      <p>&nbsp;</p>
