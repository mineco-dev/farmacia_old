...
if ((form['descripcion'].value) == ""){alert('Escriba una breve descripcion'); form['descripcion'].focus();  return};	
  ...
  <div class="TabbedPanelsContentGroup">
    ...
    <div class="TabbedPanelsContent">
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="panel">
        ...
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top">Departamento en UDAF</td>
          <td colspan="2">
          <div id="Div_departamento">
           <select name="iddepto"  id="iddepto" onchange="javascript:cargarCombo('departamento.php','iddepto','Div_gestion')">
         
              <?
					$dbms2=new DBMS(conectardb($bitacora));	
				  	$dbms2->bdd=$database_cnn;
                    $query = "select * from bdepartamento order by nombre";
                    $dbms2->sql=$query;
                    $dbms2->Query();
                    print "<option value = 0>- seleccione -</option>";
                    while($Fields=$dbms2->MoveNext())
                    {
                        print "<option value = ".$Fields["iddepto"]. ">".$Fields["nombre"]."</option>";
                    }
              	?>
              </select>
            </div></td>
        ...
        <tr>
          ...
          <td valign="top">Tipo de Gestion</td>
          <td colspan="2"><div id="Div_gestion">
        ...
        <tr>
          ...
          <td colspan="2"><input name="gestion" type="text" id="gestion" size="50"></td>
        </tr>
        <tr>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
          <td colspan="4"><div align="center">
      			<input name="btn1" type="button" class="grey" onClick="validar(this.form)" value="Guardar Solicitud"></div>		</td>
		</tr>
