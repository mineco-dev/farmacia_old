...
//ENVIO HACIA GERENCIA
	...
	if (strlen($descripcion)>0)
	{
		...
		$dbms->sql = "update docs_udaf set estado = 7 where estado = 6 and id_documento = $id_documento";
		$dbms->Query();
		...
		$dbms2=new DBMS(conectardb($bdespacho));	
                    ...
                    $query = "select * from usuario where activo=1 and codigo_usuario='$idusuario' (321) /*(94,289,650,825)*/";
                    $dbms2->sql=$query;
                    $dbms2->Query();
