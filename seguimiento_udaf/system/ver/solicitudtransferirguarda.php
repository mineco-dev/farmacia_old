...
<?
	...
	if (strlen($descripcion)>0)
	{
		...
		$dbms->sql = "update docs_udaf set estado = 2 where estado = 1 and id_documento = $id_documento";
		$dbms->Query();
		...
		$dbms2=new DBMS(conectardb($bitacora));	
                    ...
                    $query = "select * from usuario where activo=1 and codigo_usuario='$idusuario'";
                    $dbms2->sql=$query;
                    $dbms2->Query();
