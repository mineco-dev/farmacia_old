...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="0"><strong>Material a entregar</strong></li>
  </ul>
      ...
      <table width="98%" border="0" class="panel"><tr><td><table width="100%%" border="0"><tr><td><div align="right">
        <table width="98%" border="0" class="panel">
          <tr>
            ...
            <form action="solicitudmaterialguarda.php?idsolicitud=<? print $idsolicitud;?>" method="post" enctype="multipart/form-data" name="form1">
