      ...
      <div align="right">
        <table width="98%" border="0" class="panel"> 
          <tr>
            ...
            <form action="solicitudfinalizarguarda.php?id_documento=<? print $id_documento;?>" method="post" enctype="multipart/form-data" name="form1">
            ...
            <table width="100%%" border="0">
                ...
                <tr>
                  <td><div align="center">
                      <input name="btn2" type="button" class="grey" onClick="verificar(this.form)" value="Guardar motivo(s) ingresada(s)">
                  </div></td>
                </tr>
            </table>
            </form>
