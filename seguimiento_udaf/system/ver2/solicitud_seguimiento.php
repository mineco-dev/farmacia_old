...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="0"><strong>Observaciones</strong></li>
  </ul>
  <div class="TabbedPanelsContentGroup">
    ...
    <div class="TabbedPanelsContent"> 
      <table width="98%" border="0" class="panel"><tr><td>
      ...
      <div align="right">
        <table width="98%" border="0" class="panel"> 
          <tr>
            ...
            <form action="solicitudseguimientoguarda.php?id_documento=<? print $id_documento;?>" method="post" enctype="multipart/form-data" name="form1">
            ...
            <table width="100%%" border="0">
                ...
                <tr>
                  <td><div align="center">
                      <input name="btn2" type="button" class="grey" onClick="verificar(this.form)" value="Guardar observacion(es) ingresada(s)">
                  </div></td>
                </tr>
            </table>
            </form>
