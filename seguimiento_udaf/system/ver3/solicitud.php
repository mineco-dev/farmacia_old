...
<div id="TabbedPanels1" class="TabbedPanels">
  ...
  <div class="TabbedPanelsContentGroup">
    ...
    $Fields=get_valores("id_gestion,solicitante,doct_sfp,cantidad,dictamen_no,
	...
	$tiposolicitud = get_valores("nombre",
								"bgestion",
								"where idgestion = ".$Fields["idgestion"],"",$dbms);
								
	$$unidad_ejecutora = get_valores("nombre",
								"bunidad_ejecutora",
								"where idunidad = ".$Fields["id_ejecutora"],"",$dbms);W	
	...
	?>
      <table width="99%" cellspacing="4" class="panel">
        ...
        <tr>
          ...
          <td width="725" colspan="2"><? print $Fields["nombre"]; ?></td>
        </tr>
        <tr>
          <td valign="top">&nbsp;</td>
          <td bgcolor="#FEF8DE">No. Docto. Subgerencia Financiera</td>
        ...
        <tr>
          ...
          <td colspan="2"><? print $Fields["dictamen_no"]; ?></td>
                ...
                <tr>
          <td valign="top">&nbsp;</td>
          <td bgcolor="#FEF8DE">CUR No.</td>
          <td colspan="2"><? print $Fields["cur_no"]; ?></td>
        </tr>
        <tr>
          <td valign="top">&nbsp;</td>
