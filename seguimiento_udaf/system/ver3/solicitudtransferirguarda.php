...
//ENVIO HACIA GERENCIA
	...
	if (strlen($descripcion)>0)
	{
		...
		$dbms->sql = "update docs_udaf set estado = 5 where estado = 4 and id_documento = $id_documento";
		$dbms->Query();
		...
		$dbms2=new DBMS(conectardb($bgerencia));	
                    ...
                    $query = "select * from usuario where activo=1 and codigo_usuario='$idusuario' /*(222,225)*/";
                    $dbms2->sql=$query;
                    $dbms2->Query();
