...
<table width="100%"  border="0">
  <tr>
    <td width="17%" height="25"><div align="left"><img src="../images/logo_rpt.gif" width="82" height="95"></div></td>
    <td colspan="3"><p align="center" class="titulocategoria Estilo1">SUBGERENCIA DE INFORM&Aacute;TICA</p>
  ...
  <tr>
    <td height="25" colspan="2">CATEGORIA</td>
    <td>SUBCATEGORIA</td>
    <td height="25" colspan="2">OBJETO</td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="25" colspan="5"><div align="right" class="tituloproducto">
        <div align="left">Toma de inventario de --&gt;
          <?
		...
		if (isset($obj)) //verifico si hay objeto seleccionado
		{
			...
			while($row_qry_plantilla=$fetch_array($res_qry_plantilla))
			{
				...
				if ($row_qry_plantilla["codigo_tipo_propiedad"]==2)
				{
					...
					{
						$qry_cbo="SELECT * FROM $latabla where codigo_objeto=$obj and activo=1 order by $campoorigen"; 
					}
					else
					{
