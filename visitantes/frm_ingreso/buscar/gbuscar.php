			...
			$qry_plantilla="SELECT c.codigo_campo, c.campo, c.codigo_tipo_campo, c.tb_origen, c.validar, c.texto_validacion, c.ayuda, c.incluir_en_detalle,
				...
				{	   	  			
					 // echo '<tr><td align="right" colspan="'.$no_campos_detalle.'"><a href="../agregar.php"><img src="../../images/iconos/ico_agregar.gif" alt="Agregar registro" border="0"></a></td></tr>';
					  $no_campos_detalle++;
					  echo '<tr><td colspan="'.$no_campos_detalle.'" align="right"><a href="../agregar.php?obj='.$txt_obj.'"><img src="../../../images/iconos/icon_nuevo.gif" alt="Agregar nuevo visitante a la base de datos" border="0"></a></td></tr>';
					  ...
					  $i=1;					  
						...
						echo '<td class="boxTitleBgLightBlue" align="center">Cambiar</td>';						
						echo '<td class="boxTitleBgLightBlue" align="center">Ingresar</td>';
						echo '<td class="boxTitleBgLightBlue" align="center">Lista negra</td>';
						echo '<td class="boxTitleBgLightBlue" align="center">Borrar</td>';
						echo '</tr>';
						$no_campos_detalle=$no_campos_detalle-6;						
						$hay_registros=false;
						while($row_qry_insertados=$fetch_array($res_qry_insertados))
						{
							 ...
							 $status=$row_qry_insertados["activo"];							  
							  ...
							  {
								if ($status==3)
									  echo '<td class="lista_negra">'.$row_qry_insertados["$cnt"].'</td>'; 
									else
									if ($status==1)
								...
								if ($status==1)				
								{ 
								echo '<td class='.$clase.'><center><a href="../editar.php?id='.$row_qry_insertados[0].'&obj='.$txt_obj.'"><img src="../../../images/iconos/ico_editar.gif" alt="Modificar los datos del visitante" border="0"></a></center></td>';  																	
								echo '<td class='.$clase.'><center><a href="../ingreso.php?id='.$row_qry_insertados[0].'&obj='.$txt_obj.'"><img src="../../../images/iconos/ico_entrar.gif" alt="Operar el registro de esta visita" border="0"></a></center></td>';								
								echo '<td class='.$clase.'><center><a href="../lista_negra.php?id='.$row_qry_insertados[0].'&txt_obj='.$txt_obj.'"><img src="../../../images/iconos/ico_no_entrar.gif" alt="Poner en lista negra" border="0"></a></center></td>';
								echo '<td class='.$clase.'><center><a href="../status.php?id='.$row_qry_insertados[0].'&st=2&txt_obj='.$txt_obj.'"><img src="../../../images/iconos/ico_borrar.gif" alt="Eliminar este registro" border="0"></a></center></td>';							}				
								else
								if ($status==3)	
								{			
	echo '<td class='.$clase.'><center><img src="../../../images/iconos/ico_editar.gif" alt="No puede modificar los datos" border="0"></center></td>';  																	
								echo '<td class='.$clase.'><center><img src="../../../images/iconos/ico_entrar.gif" alt="No puede darle acceso a este visitante, est� en lista negra" border="0"></center></td>';	
								echo '<td class='.$clase.'><center><a href="../ver_motivo.php?id='.$row_qry_insertados[0].'&st=2&txt_obj='.$txt_obj.'"><img src="../../../images/iconos/ico_no_entrar.gif" alt="Para ver la raz�n por la cual est� en lista negra haga clic aqui." border="0"></a></center></td>';			
								echo '<td class='.$clase.'><center><img src="../../../images/iconos/ico_desactivado.gif" alt="Activar este usuario" border="0"></center></td>';												
								}									
									echo '</tr>';
									$i++;
						 }
				...
				{
					echo '<tr><td class="error" colspan="13" align="center">NO SE ENCONTRARON REGISTROS QUE COINCIDAN CON LA BUSQUEDA<br><br>Para Almacenar  este registro <a href="../crear_registro.php">[HAGA CLIC AQUI]</a></td></tr>';
				}
			}
