...
<div align="center">
  <table width="90%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <th class="legal2" scope="row"><p><img src="../../../images/e03.gif" alt="idea" width="21" height="21"> CONSULTE SI EXISTE EL VISITANTE EN LA BASE DE DATOS</p>      </th>
    </tr>
  </table>
</div>
...
<table width="90%"  border="0" align="center">   
	  <table width="80%"  border="0" align="center" cellpadding="0" cellspacing="0">
		...
		{	
			...
			$no_campos=$num_rows($res_qry_plantilla);							
			echo '<tr><td rowspan="'.$no_campos.'" align="center" class="boxTitleBgMidGrey"><img src="../../../images/iconos/buscar.gif" alt="Para una b�squeda especifica llene varios campos" border="0"></td></tr>';	
			$i=1;		
