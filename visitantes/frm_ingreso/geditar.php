	...
	{			
		...
		if (($acceso>=4) && ($acceso<=8))
		{
			...
			while ($cnt<=count($campo)) //concatena lista de campos a grabar
				...
				if ($res_insert)
				{					
					echo '<tr><td class="titulocategoria" colspan="3" align="center">EL REGISTRO SE HA ACTUALIZADO CORRECTAMENTE<br><br>SI DESEA REGISTRAR LA VISITA <a href="ingreso.php?id='.$txt_id.'">HAGA CLIC AQUI <img src="../../../images/iconos/ico_entrar.gif" alt="Registrar visita" border="0"> </a></td></tr>';															
