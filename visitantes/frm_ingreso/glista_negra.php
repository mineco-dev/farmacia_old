...
<table width="100%"  border="0">
  ...
  <tr>
	...
	{			
		...
		if (($acceso>=4) && ($acceso<=8))
		{
			...
			while ($cnt<=count($campo)) //concatena lista de campos a grabar
				...
				$qry_insert.="usuario_coloco_lista='$nombre_usuario', fecha_lista_negra=getdate(), activo=3 where $campo_llave_destino=$txt_id";														
				//session_unregister("ingresando_obj");	
				conectardb($visitantes);										
				$res_insert=$query($qry_insert);			
				if ($res_insert)
				{					
					echo '<tr><td class="titulocategoria" colspan="3" align="center">SE AGREGO CORRECTAMENTE EL VISITANTE A LA LISTA NEGRA<br><br>Para operar otro registro <a href="buscar/buscar.php">[HAGA CLIC AQUI]</a></td></tr>';															
	...
	{
		echo '<tr><td class="error" colspan="3" align="center">Para continuar registrando visitantes <a href="buscar/buscar.php">[HAGA CLIC AQUI]</a></td></tr>';
	}
	?>            
	</td>
  </tr>
