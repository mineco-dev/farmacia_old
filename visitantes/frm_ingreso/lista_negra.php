...
<table width="100%"  border="0">
  <tr>
    ...
    <td colspan="2"><p align="center" class="titulocategoria Estilo1">SUBGERENCIA ADMINISTRATIVA </p>
      <p align="center" class="titulocategoria">M&Oacute;DULO DE VISITANTES</p></td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
	  ...
	  <form name="form1" method="post" action="glista_negra.php" enctype="multipart/form-data">
	...
	<input name="cmd_guardar" type="button" onClick="validar(this.form)" id="cmd_guardar" value="Guardar comentarios" <? echo $status?>></td></tr>  
</table>	  	 		  
</tr> 
<br>
<br>  
