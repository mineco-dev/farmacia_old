...
<table width="100%"  border="0">
  ...
  <tr>
	...
	{			
		...
		{				
			...
			conectardb($visitantes);
				...
				if ($res_insert)
				{					
					echo '<tr><td class="titulocategoria" colspan="3" align="center">SE HA BORRADO EL REGISTRO CORRECTAMENTE<br>Para continuar<a href="buscar/buscar.php">[HAGA CLIC AQUI]</a></td></tr>';															
	...
	{
		echo '<tr><td class="error" colspan="3" align="center">Para continuar<a href="buscar/buscar.php">[HAGA CLIC AQUI]</a></td></tr>';
	}
	?>            
	</td>
  </tr>
