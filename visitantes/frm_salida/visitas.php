...
<table width="100%"  border="0">
 ...
 ?>
    ...
    <table width="90%" border="0" align="center">		  
		   ...
		   <td>
			...
			<div id="TabbedPanels1" class="TabbedPanels">
				...
				<li class="TabbedPanelsTab style3" tabindex="0">Personal que visit�</span></li>				
				</ul>
	...
	<input name="cmd_guardar" type="button" onClick="validar(this.form)" id="cmd_guardar" value="Operar salida" <? echo $status?>></td></tr>  
</table>	  	 		  
</tr> 
<br>
<br>    
