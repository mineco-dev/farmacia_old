...
WHERE seg_visita.codigo_estado<5
  ...
  {	 
		...
		{		 
		 // echo '<tr><td align="right" colspan="'.$no_campos_detalle.'"><a href="../agregar.php"><img src="../../../images/iconos/ico_agregar.gif" alt="Agregar registro" border="0"></a></td></tr>';
		  $no_campos_detalle++;
		  $no_campos_detalle++;
		  echo '<tr><td class="boxTitleBgLightBlue" colspan="'.$no_campos_detalle.'" align="center"></td></tr>';		  
		  $no_campos_detalle--;
		  ...
		  while($row_qry_insertados=$fetch_array($res_qry_insertados))
		  {
			  ...
			  while ($cnt<=$no_campos_detalle) 
			  {
				...
				if ($status==1)		
				{						 
				echo '<td class='.$clase.'><center><a href="../salida.php?id='.$row_qry_insertados[4].'&idv='.$row_qry_insertados[0].'"><img src="../../../images/iconos/ico_pend_confirmar.gif" alt="Visitante no confirmado" border="0">&nbsp;No confirmado</a></center></td>';  
				}
				else
				if ($status==2)		
				{						 
				echo '<td class='.$clase.'><center><a href="../salida.php?id='.$row_qry_insertados[4].'&idv='.$row_qry_insertados[0].'"><img src="../../../images/iconos/ico_salir.jpg" alt="Visita confirmada" border="0">Confirmado</center></a></td>';  
				
			  }	
			  else
				if ($status==3)		
				{						 
				echo '<td class='.$clase.'><center><a href="../confirmar.php?id='.$row_qry_insertados[4].'&idv='.$row_qry_insertados[0].'"><img src="../../../images/iconos/ico_trasladado.gif" alt="Trasladado, no confirmado" border="0">Traslado</a></center></td>';  
