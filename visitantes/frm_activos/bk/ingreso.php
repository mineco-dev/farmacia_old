...
<table width="100%"  border="0">
  ...
  <tr>
    <td height="25" colspan="3"><div align="right" class="tituloproducto">
      <div align="center"><span class="legal2">REGISTRO DE VISITA</span>        </div>
    </div></td>
  </tr>
  
  
  
	  <form name="form1" method="post" action="gingreso.php" enctype="multipart/form-data">
		   ...
		   <td>
			...
			<div id="TabbedPanels1" class="TabbedPanels">
				...
				<li class="TabbedPanelsTab style3" tabindex="0">Personal que visita <span class="error">**</span></li>				
   				<li class="TabbedPanelsTab style3" tabindex="0">Equipo que ingresa</li>	 			
				</ul>
