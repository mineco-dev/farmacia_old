...
<table width="100%"  border="0">
  ...
  <tr>
	...
	{			
		...
		if (($acceso>=4) && ($acceso<=8))
		{
			...
			while ($cnt<=count($campo)) //concatena lista de campos a grabar
				...
				if ($res_insert)
				{					
					echo '<tr><td class="titulocategoria" colspan="3" align="center">EL REGISTRO SE HA ACTUALIZADO CORRECTAMENTE<br><br>Para regresar al formulario de b�squeda <a href="buscar/buscar.php">[HAGA CLIC AQUI]</a></td></tr>';															
	...
	{
		echo '<tr><td class="error" colspan="3" align="center">Para regresar al formulario de b�squeda <a href="buscar/buscar.php">[HAGA CLIC AQUI]</a></td></tr>';
	}
	?>            
	</td>
  </tr>
