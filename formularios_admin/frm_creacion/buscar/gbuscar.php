					  ...
					  $i=1;					  
						...
						while($row_qry_insertados=$fetch_array($res_qry_insertados))
						{
							  ...
							  while ($cnt<=$no_campos_detalle) 
							  {
								...
								echo '<td class='.$clase.'><center><a href="../ed_catalogos.php?id='.$row_qry_insertados[0].'"><img src="../../../images/iconos/ico_editar.gif" alt="Modificar" border="0"></a></center></td>';  					
							if ($status==1)				
							echo '<td class='.$clase.'><center><a href="../status.php?id='.$row_qry_insertados[0].'"><img src="../../../images/iconos/ico_activo.gif" alt="Desactivar" border="0"></a></center></td>';					
								else
								echo '<td class='.$clase.'><center><a href="../status.php?id='.$row_qry_insertados[0].'"><img src="../../../images/iconos/ico_desactivado.gif" alt="Activar" border="0"></a></center></td>';					
							echo '</tr>';
							$i++;
						 }
