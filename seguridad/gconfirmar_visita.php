...
//		$dependencia_temp=($_SESSION["dependencia_temp"]);
...
//Actualiza la base de datos	
		...
		$consulta = "EXEC seg_visita_conf @vcodigo_visita='$codigo_visita', @vcodigo_dependencia='$dependencia', @vcodigo_usuario_visita='$usuario_visitado', @vcodigo_motivo='$motivo', @vcodigo_usuario='$user_id', @vespecifique_motivo='$especifique'";
