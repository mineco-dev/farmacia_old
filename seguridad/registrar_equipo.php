            ...
            <table width="99%" border="1" class="tablaazul">
              ...
              <?				
				...
				while($row3=mssql_fetch_array($result3))
				{
					...
					echo '<tr class='.$clase.'><td><center>'.$row3["gafete_asignado"].'</center></td><td><center>'.$row3["fecha_ingreso"].'</center></td><td><center>'.$row3["nombre_visitante"].'</a></center></td><td><center>'.$row3["nombres"].'&nbsp;'.$row3["apellidos"].'</center></td><td><center><a href="equipo_det.php?id='.$row3["codigo_visita"].'"><img src="../images/iconos/ico_equipo.jpg"></a></center></td></tr>';					
					$i++;
				}
				mssql_close($s);				
			  ?>
