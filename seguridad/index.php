...
<div align="left">
  <form name="form1" method="post" action="busqueda.php">
    ...
    <table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" id="table17">
      <td width="13%"><head>
        <tr>
          <td colspan="2" class="tcat"><div align="center"><span class="Estilo1"><a href="agregar.php" title="Agregar municipio al sistema" target="body"><strong><span class="Estilo2">[Nuevo visitante</span>]</strong></a></span></div></td>
		...
		<?
				...
				$consulta = "SELECT  top 100 codigo_visitante, nombre_visitante,  numero_cedula, numero_licencia, numero_pasaporte FROM seg_visitante order by codigo_visitante desc";
//				$consulta = "SELECT * FROM seg_visitante order by codigo_visitante desc";
				...
				while($row=$fetch_array($result))
				{
					...
					{
					 	$clase="lista_negra";
						echo '<tr class='.$clase.'><td colspan="2">'.$row["nombre_visitante"].'</td><td>'.$row["numero_cedula"].'</td><td>'.$row["numero_licencia"].'</td><td>'.$row["numero_pasaporte"].'</td><td><center><a href="editar.php?id='.$row["codigo_visitante"].'"><img src="../images/iconos/ico_editar.jpg"></a></center></td><td><center><img src="../images/iconos/ico_borrar.jpg"></center></td><td><center><a href="ver.php?id='.$row["codigo_visitante"].'"><img src="../images/iconos/ico_ver.jpg"></a></center></td></tr>';					
					}	
					else
						echo '<tr class='.$clase.'><td colspan="2"><a href="registrar_visita.php?id='.$row["codigo_visitante"].'">'.$row["nombre_visitante"].'</a></td><td>'.$row["numero_cedula"].'</td><td>'.$row["numero_licencia"].'</td><td>'.$row["numero_pasaporte"].'</td><td><center><a href="editar.php?id='.$row["codigo_visitante"].'"><img src="../images/iconos/ico_editar.jpg"></a></center></td><td><center><a href="eliminar.php?id='.$row["codigo_visitante"].'"><img src="../images/iconos/ico_borrar.jpg"></a></center></td><td><center><a href="ver.php?id='.$row["codigo_visitante"].'"><img src="../images/iconos/ico_ver.jpg"></a></center></td></tr>';										
					$i++;
				}
				$close($s);
			 ?>
