...
?>
		...
		if ($entro_equipo==1)		
		{
				...
				{					
					...
					//else $movimiento="Autorizado para salir";
						echo '<tr class='.$clase.'><td colspan="2">'.$row3["equipo"].'</td><td>'.$row3["numero_serie"].'</td><td>'.$row3["descripcion"].'</td><td><center><a href="sale_equipo.php?id='.$row3["codigo_equipo_det"].'"><img src="../images/iconos/ico_borrar.jpg"></a></center></td><td><center><a href="observacion_equipo_sale.php?id='.$row3["codigo_equipo_det"].'"><img src="../images/iconos/ico_ver.jpg"></a></center></td></tr>';										
					$i++;
				}
		}
		$close($s);				
    ...
    <p align="center"><span class="error">ANTES DE OPERAR LA SALIDA</span> del visitante debe operar la salida de cada uno de los equipos arriba descritos, cuando as&iacute; aplique. </p>
