<?
	...
	require_once('../../connection/helpdesk.php'); 
					$consulta1="SELECT * FROM seg_visitante where codigo_visitante='$visitante'";
...
<form name="form1" method="post" action="gconfirmar_visita.php">
  <table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" style="border-top-width:0px" id="table1">
    <tr>
      <td width="16%">Visitante:</td>
      <td colspan="4"><? echo $nombre_visitante; ?>	  <td width="2%"></td>
    </tr>
    <tr>
      <td align="left" class="alt1">Dependencia:</td>
      <td colspan="4" align="left" class="alt1"><?
    ...
    <tr>
      <td align="left" class="alt1">Visita a: </td>
      <td colspan="4" align="left" class="alt1"><?					
					...
					echo'<option value="0">'.$nombre_visitado.'</option>';
					while($row3=$fetch_array($result3))
					{
    ...
    <tr>
      <td width="16%" align="left" class="alt1">Especif&iacute;que: </td>
      <td colspan="4" align="left" class="alt1"><textarea name="txt_especifique" cols="40" id="txt_especifique"></textarea></td>
    </tr>
    <tr>
