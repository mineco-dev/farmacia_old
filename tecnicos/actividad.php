            ...
            <table width="99%" border="0" class="tablaazul">
              ...
              <?			  				
				...
				while($row3=mssql_fetch_array($result3))
				{
					...
					echo '<tr class='.$clase.'><td><center><a href="ver_seguimiento.php?id='.$row3["ticket"].'"><img src="imagenes/iconos/ico_ver.jpg" alt="Ver comentarios de seguimiento"></a></center></td><td><center><a href="comentario.php?id='.$row3["ticket"].'"><img src="imagenes/iconos/ico_msj.jpg" alt="Agregar un comentario de seguimiento"></a></center></td><td colspan="7"><center>'.$row3["detalle"].'</center></td></tr>';																										
					$i++;
				}
				mssql_close($s);				
			  ?>
