...
<form name="form1" method="post" action="asesoringreso.php">
  ...
  <tr class="Estilo1">
    <td class="Estilo1">Primer Nombre</td>
    ...
    <td colspan="-1"><input name="nombre2" type="text" class="Estilo1" id="nombre2" size="30">
  ...
  <tr class="Estilo7">
    ...
    <td class="Estilo7"><span class="Estilo22">
      <input name="estadocivil" type="text" class="Estilo7" id="estadocivil" size="30">
    </span></td>
    ...
    <td colspan="5" class="Estilo7"><span class="Estilo22">d&iacute;a
        <input name="dia" type="text" class="Estilo1" id="dia3" size="2">
mes
<input name="mes" type="text" class="Estilo1" id="mes3" size="2">
a&ntilde;o
<input name="ano" type="text" class="Estilo1" id="ano3" size="5"> 
Edad  
<input name="edad" type="text" id="edad" size="10"> 
Sexo: M 
<input name="sexo" type="radio" value="radiobutton"> 
F
<input name="sexo" type="radio" value="radiobutton">
</span></td>
  </tr>
...
<tr class="Estilo1">
    <td class="Estilo1">Empadronamiento</td>
    <td class="Estilo7">
...
adjunte copia de C&eacute;dula
...
<tr class="Estilo1">
    <td class="Estilo1">Departamento</td>
    <td class="Estilo7">
	<div align="left">
		    <select name="tema" class="TituloMedios" id="select2"  onChange="javascript:cargarCombo('subactividades.php', 'tema', 'Div_Subactividades')">
		...
		<div align="left">
  			<div id="Div_Subactividades"> 
				<label for="SubActividad"></label> 
				  <select name="idgrupo"  id="select3" class="TituloMedios">
  				  </select>
		    </div>
        </div>
	</span>
...
<tr class="Estilo1">
    <td class="Estilo1">Numero de Licencia </td>
    <td class="Estilo7">
    ...
    Grupo Etnico <select name="idgrupoetnico" id="idgrupoetnico" class="Estilo7" size="1">
<?
...
<td width="16%"><span class="Estilo7">
  ...
  <tr>
	...
	<div align="left">
		    <select name="tema2" class="TituloMedios" id="select2"  onChange="javascript:cargarCombo('subactividades2.php', 'tema2', 'Div_Subactividades2')">
            <option value=0> Seleccione </option>
            <? 
				$dbms->sql="select iddepartamento,nombre_departamento from asesor_departamento"; 
				$dbms->Query(); 
	...
	<div align="left">
  			<div id="Div_Subactividades2"> 
				<label for="SubActividad2"></label> 
				  <select name="idgrupo2"  id="select3" class="TituloMedios">
  				  </select>
		    </div>
        </div>
    </span></td>
  ...
  <tr>
    <td height="25"><span class="Estilo47"><span class="Estilo7"><span class="Estilo1">Tel&eacute;fono de casa </span></span></span></td>
    <td><span class="Estilo47"><span class="Estilo7">
...
<td width="16%"><span class="Estilo7">
    ...
    <td><div align="right"><span class="Estilo47"><span class="Estilo1">Correo electr&oacute;nico personal </span></span></div></td>
  ...
  <tr>
    <td class="Estilo1">Direccion para Notificacione </td>
...
$dbms->sql="select * from asesor_registro"; 
	$dbms->Query(); 
	while($Fields=$dbms->MoveNext()) 
	{
		print $Fields["idregistro"]." ".$Fields["registro"]."<br>"; 
	}
...
&nbsp;</td>
  ...
  <tr>
    <td colspan="7"><span class="Estilo1">Datos del Ministerio de Econom&iacute;a </span></td>
    </tr>
  <tr>
    <td><span class="Estilo1">Puesto</span></td>
    <td colspan="6"><span class="Estilo47"><span class="Estilo1">
      <input name="puesto" type="text" class="Estilo7" id="puesto">
 Descripcion del Puesto <span class="Estilo7"><span class="Estilo22">
 <input name="userfile2" type="file" id="userfile2" size="30">
 </span></span> </span></span></td>
  </tr>
  <tr>
    <td><span class="Estilo1">Contrato</span></td>
    <td colspan="6"><span class="Estilo1">
	Reglon 11
  ...
  <tr>
    <td><span class="Estilo64">Partida Presupuestaira No. </span></td>
    <td colspan="6"><span class="Estilo47"><span class="Estilo1">
    <input name="partida" type="text" class="Estilo7" id="partida">
    </span></span></td>
  </tr>
</table>
