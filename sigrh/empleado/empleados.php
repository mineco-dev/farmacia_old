...
<table width="97%" border="0" align="center" class="panel">
  <tr>
    <td><table width="100%%" border="0" class="grey">
      <tr>
        <td><strong>Todos los empleados al <? print get_formatofecha(date("d")."-".date("m")."-".date("Y")); ?></strong></td>
      </tr>
    </table>
<br>
<br>
      <table width="95%%" border="0" align="center">
        <tr>
          <td><div id="CollapsiblePanel1" class="CollapsiblePanel">
            <div class="CollapsiblePanelTab" tabindex="0"><img src="imagenes/punto1.jpg" width="16" height="16"> Empleados Activos</div>
            <div class="CollapsiblePanelContent"><? 
		  	$mtstatus = "1";
		  	include("ver/empleados.php");
		  ?>
            </div>
          </div></td>
        </tr>
     ...
     <table width="95%%" border="0" align="center">
        <tr>
          <td><div id="CollapsiblePanel2" class="CollapsiblePanel">
              <div class="CollapsiblePanelTab" tabindex="0"><img src="imagenes/punto3.jpg" alt="" width="16" height="16">Empleados Inactivos</div>
            <div class="CollapsiblePanelContent"><? 
		  	$mtstatus = "2";
		  	include("ver/empleados.php");
		  ?>
      ...
      <table width="95%%" border="0" align="center">
        <tr>
          <td><div id="CollapsiblePanel3" class="CollapsiblePanel">
              <div class="CollapsiblePanelTab" tabindex="0"><img src="imagenes/punto2.jpg" alt="" width="16" height="16">Todos los empleados</div>
            <div class="CollapsiblePanelContent"><? 
		  	$mtstatus = "1,2";
		  	include("ver/empleados.php");
		  ?>
