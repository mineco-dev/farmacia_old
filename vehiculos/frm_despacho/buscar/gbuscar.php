...
<!-- se esta agregando linea 15 a 21 para cambio del titulo linea 31-->
-->
</style>
</head>
...
<table width="100%"  border="0">  
  <tr>
    <td height="8" colspan="3">  
	  <div align="center" class="Estilo1"><span class="titulocategoria titulo"> SOLICITUDES DE VEHICULOS AUTORIZADAS Y EN TR&Aacute;NSITO</span></div></td>  
      <!--<div align="center" class="Estilo1"><span class="legal2 Estilo1"> SOLICITUDES DE VEHICULOS AUTORIZADAS Y EN TR&Aacute;NSITO</span></div></td>--> 
	   <!--<td width="18%" height="25"><div align="left"><img src="../../images/carro.gif" width="82" height="95"></div></td>-->  
  </tr>
  
</table>
<table border="5" width="95%" cellpadding="0" cellspacing="0" align="center">   
	...
	<?			
		...
		{			
			...
			$qry_plantilla="SELECT c.codigo_campo, c.campo, c.codigo_tipo_campo, c.tb_origen, c.validar, c.texto_validacion, c.ayuda,
				...
				if (strlen($qry_condicion)>=1) $qry_condicion.="and codigo_estado_salida_vehiculo in(3, 4) and tb_salida_vehiculo.activo=1";
							  ...
							  while ($cnt<=$no_campos_detalle) 
							  {
								...
								if ($color==3)
									...
									if ($color==4)
										...
										if (($color==2) || ($color==3))
										{
											echo '<td class='.$clase.'><center><a href="../despachar.php?id='.$row_qry_insertados[0].'&obj='.$obj.'"><img src="../../../images/iconos/transferencia.gif" alt="Despachar Vehiculo" border="0"></a></center></td>';  									
											/*if ($status==1)				
