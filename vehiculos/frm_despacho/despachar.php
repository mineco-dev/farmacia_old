...
<table width="100%"  border="0">
  <tr>
    ...
    <td colspan="2"><p align="center" class="titulocategoria Estilo1 Estilo2">SUBGERENCIA ADMINISTRATIVA </p>
      <p align="center" class="titulocategoria"> OPERANDO SOLICITUD DE VEHICULO </p></td>
  ...
  <tr>
    ...
    <td height="25"><span class="legal"><? echo $jefe; ?> - <? echo $dependencia; ?></span></td>
	  ...
	  <form name="form1" method="post" action="gdespachar.php" enctype="multipart/form-data">
	...
	<input name="cmd_guardar" type="button" onClick="validar(this.form)" id="cmd_guardar" value="Despachar vehiculo" <? echo $status?>></td></tr>  
