...
echo 'function pick(id, symbol) {';
echo '  if (window.opener && !window.opener.closed)';
echo '   window.opener.document.form1.'.$tipo.'_name.value = symbol;	';
echo '   window.opener.document.form1.'.$tipo.'_id.value = id;	';
echo  '  window.close();';
echo '}';
echo '</SCRIPT>';
?>
...
<table width="80%"  border="0" align="center">
  <tr>
  <!--se agrego <td width="18%" height="25"><div align="center"><img src="../../images/carro.gif" width="82" height="95"></div></td>-->
    <td width="18%" height="25"><div align="center"><img src="../../images/carro.gif" width="82" height="95"></div></td>
    <td width="72%"><p align="center" class="titulocategoria Estilo1 Estilo1">SUBGERENCIA ADMINISTRATIVA</p>
      
	  <p align="center" class="titulocategoria Estilo2"> RESULTADO DE LA BUSQUEDA </p></td>
...
<table border="5" width="90%" cellpadding="0" cellspacing="0" align="center">
	<?				
		...
		{			
			...
			conectardb($vehiculos);
				...
				{			
					...
					$qry_condicion="WHERE $tb_detalle.activo=1 and $tb_detalle.codigo_categoria=5  and $tb_detalle.codigo_estado in (1,2) and uso_fijo='NO' ";								
				$cnt=1;
				...
				$qry_condicion.=" and not exists 
									...
									and tb_salida_vehiculo.codigo_estado_salida_vehiculo IN (4))";
					  ...
					  echo '<tr>';  			
						...
						while($row_qry_insertados=$fetch_array($res_qry_insertados))
						{
							  ...
							  while ($cnt<=$no_campos_detalle) 
							  {
								...
								echo "<td class=".$clase."><A HREF=\"javascript:pick('$id_reg', '$completo')\"><center><img src=\"../../images/iconos/ico_ir.gif\" border=\"0\" alt=\"Seleccionar este vehiculo\"></a></center></td></a></center></td>";	
							   if ($color==3)
							   	echo '<td class='.$clase.' align="center"><img src="../../../images/punto_amarillo.jpg" alt="Vehiculo YA asignado, en espera de ser utilizado" border="0"></td>';
								else
