...
<table width="100%"  border="0">
  <tr>
    ...
    <td width="72%"><p align="center" class="titulocategoria Estilo1 Estilo2">SUBGERENCIA ADMINISTRATIVA</p>
      <p align="center" class="titulocategoria"><span class="Estilo3">FORMULARIO PARA BUSQUEDA DE VEHICULO</span>S</p></td>
    <!--<td width="10%"><div align="right"><img src="../../images/carro.gif" width="90" height="50"></div></td>-->
  </tr>
  <tr>
  ...
  <?   
    ...
    <td height="25" colspan="3"><div align="right" class="tituloproducto">
      <div align="center">INGRESE INFORMACION EN UNO O VARIOS CAMPOS PARA REALIZAR LA B&Uacute;SQUEDA         
      </div>
    </div></td>
    </tr>  
	  ...
	  <table width="90%" align="center" cellpadding="0" cellspacing="0">
		...
		{			
			...
			$qry_detalle=$qry_datos_insertados.' '.$qry_datos_insertados2.' '.$qry_datos_insertados3.' where asesor.activo=1 '.$qry_orden.' '.$qry_orden2;										
...
<br>
  ...
  {	 
   		if (($acceso==1) || ($acceso==3) || ($acceso==4) || ($acceso==5) || ($acceso==6) || ($acceso==7) || ($acceso==8))
		{
		  ...
		  {
			  $completo=$row_qry_insertados["nombre"].' '.$row_qry_insertados["nombre2"].' '.$row_qry_insertados["apellido"].' '.$row_qry_insertados["apellido2"];
			  ...
			  while ($cnt<=$no_campos_detalle) x
			  {
				...
				echo "<td class=".$clase."><a href=\"javascript:void(0)\" onClick=\"window.opener.document.getElementById('$tipo"."[".$posi."][0]').value = '$completo'; 
					...
					window.close();
					window.opener.focus(); 
					return false;\"><center><img src=\"../../images/iconos/ico_ir.gif\" border=\"0\" alt=\"Seleccionar este vehiculo\"></a></center></td></a></center></td>";	
			echo '</tr>';
			$i++;
		 }
