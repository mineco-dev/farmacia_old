...
<table width="80%"  border="0" align="center">
  <tr>
    ...
    <td width="72%"><p align="center" class="titulocategoria Estilo3">SUBGERENCIA ADMINISTRATIVA</p>
   <!-- se agrego <img src="../../images/camaro.jpg" width="129" height="126"></div>-->
    <td width="5%"><div align="right"><img src="../../images/carro.gif" width="90" height="95"></div></td>  
		...
		{			
			...
			conectardb($vehiculos);
				...
				{			
					...
					$qry_condicion="WHERE $tb_detalle.activo=1 and $tb_detalle.codigo_categoria=5  and $tb_detalle.codigo_estado in (1,2,3) ";								
				$cnt=1;
				...
				{		  			 
					  ...
					  echo '<tr>';  			
						...
						echo '<td class="boxTitleBgLightBlue" align="center">Mantenimiento</td>';
						echo '<td class="boxTitleBgLightBlue" align="center">Comisiones</td>';												
						echo '</tr>';						
						...
						while($row_qry_insertados=$fetch_array($res_qry_insertados))
						{
							  ...
							  $tipo=$row_qry_insertados["objeto"];
							  ...
							  while ($cnt<=$no_campos_detalle) 
							  {
								...
								echo '<td class='.$clase.'><center><a href="rpt_mantenimiento.php?id='.$row_qry_insertados[0].'&tipo='.$tipo.'"><img src="../../images/iconos/reparacion.gif" alt="Ver historial de mantenimiento" border="0"></a></center></td>';  												  								
								echo '<td class='.$clase.'><center><a href="rpt_comisiones.php?id='.$row_qry_insertados[0].'&tipo='.$tipo.'"><img src="../../images/iconos/mapa.gif" alt="Ver comisiones realizadas con este veh�culo" border="0"></a></center></td>';  												  								
							   echo '</tr>';
							$i++;
						}
