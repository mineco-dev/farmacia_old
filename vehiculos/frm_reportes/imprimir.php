...
////////////////SI ES UNA DB DISTINTA AQUI CAMBIA LA CONEXION
  ...
  <tr>
    ...
    <td width="78%" height="25"><div align="right" class="tituloproducto Estilo3">
      <div align="center">
        <p class="Estilo4">SOLICITUD DE VEHICULO PARA <? echo $contenido[8]; ?><br>
          MINISTERIO DE ECONOMIA          </p>
        </div>
    </div></td>
    <td width="7%" height="25"><img src="../../images/escudo.jpeg" width="79" height="79"></td>
  </tr>
</table>
        <table width="612" height="792"  border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <th colspan="2" scope="row"><div align="left" class="legal">Fecha solicitud: <? echo $contenido[2]; ?></div>              </th>
            <th colspan="2" scope="row"><div align="left">Hasta: <? echo $contenido[3]; ?></div>              </th>
          </tr>
          <tr>
            <th scope="row"><div align="left" class="legal">Solicitante: </div>              </th>
            <th scope="row"><div align="left"><span class="legal"><? echo $contenido[9]; ?></span></div></th>
            <th scope="row"><div align="left">Dependencia:</div>              </th>
            <th scope="row"><div align="left"><span class="legal"><? echo $dependencia[9]; ?></span></div></th>
          </tr>
          <tr>
            <th height="29" scope="row"><div align="left" class="legal">Jefe de dependencia:</div></th>
            <th height="29" scope="row"><div align="left"><span class="legal"><? echo $jefe[9]; ?></span></div></th>
            <th scope="row"><div align="left">
              <p>Firma______________</p>
              </div></th>
            <th rowspan="2" scope="row"><img src="../../images/sello.gif" width="126" height="46"></th>
          </tr>
          <tr>
            <th width="23%" height="19" scope="row">&nbsp;</th>
            <th width="25%" scope="row">&nbsp;</th>
            <th scope="row">&nbsp;</th>
          </tr>
          <tr>
            <th scope="row"><div align="left">Lugar de comisi&oacute;n:</div></th>
            <th colspan="3" scope="row"><div align="left"><? echo $contenido[7].', ZONA '.$contenido[6].' '.$contenido[5].', '.$contenido[4]; ?></div></th>
          </tr>
          <tr>
            <th height="27" scope="row"><div align="left">Firma:_____________</div></th>
            <th height="27" scope="row"><div align="right">______________Vo.Bo.</div></th>
            <th scope="row"><div align="left">___________________</div></th>
            <th rowspan="2" scope="row"><div align="center"><img src="../../images/sello.gif" width="126" height="46">
	        </div></th>
          </tr>
          <tr>
            <th height="30" colspan="2" valign="top" scope="row"><div align="left"></div>              <div align="left" class="style3">
              <div align="center">Solicitante</div>
              </div></th>
            <th align="center" valign="top" scope="row"><div align="left" class="style3">
              <div align="center">Gerente o Subgerente de Admon. </div>
            </div></th>
          </tr>
          <tr>
            <th height="252" colspan="4" scope="row">
			
			<p>CONTROL DE VEHICULO </p>
			<p><img src="../../images/vehiculo.gif" width="286" height="150"></p></th>
          </tr>
          <tr>
            <th height="36" colspan="2" scope="row"><div align="left">Nombre Piloto:<span class="legal">&nbsp;<? echo $contenido[10]; ?></span></div>              </th>
            <th height="36" colspan="2" scope="row"><div align="left">Firma:_________________________________</div></th>
          </tr>
          <tr>
            <th height="39" colspan="2" scope="row"><div align="left">Veh&iacute;culo: <span class="legal"><? echo $contenido[11]; ?></span></div>              </th>
            <th height="39" colspan="2" scope="row"><div align="left">Placa: <span class="legal"><? echo $numero_placa; ?></span></div></th>
          </tr>
          <tr>
            <th height="39" colspan="2" scope="row"><div align="left">Fecha y hora salida: <span class="legal"><? echo $contenido[12]; ?></span></div></th>
            <th colspan="2" scope="row"><div align="left">Fecha y hora entrada____________________</div></th>
          </tr>
          <tr>
            <th height="42" scope="row"><div align="left">Kilometraje Salida: </div>              </th>
            <th height="42" scope="row"><div align="left"><span class="legal"><? echo $contenido[14]; ?> </span></div></th>
            <th height="42" scope="row"><div align="left">Entrada:_____________</div></th>
            <th height="42" scope="row">Total__________</th>
          </tr>
          <tr>
          ...
          <tr>
            <th colspan="4" scope="row"><div align="left">Otros: <span class="legal"><? echo $contenido[18]; ?> Gasolina proporcionada: <? echo $contenido[16]; ?></span></div></th>
          </tr>
          <tr>
