...
<table width="100%"  border="0">
  <tr>
    <td width="16%" height="25"><div align="left"></div></td>
    <td colspan="2"><p align="center" class="titulocategoria Estilo1">SUBGERENCIA ADMINISTRATIVA </p>
      <p align="center" class="titulocategoria Estilo2"> OPERANDO SOLICITUD DE VEHICULO </p></td>
  ...
  <tr>
	...
	<input name="cmd_guardar" type="button" onClick="validar(this.form)" id="cmd_guardar" value="Autorizar" <? echo $status?>></td></tr>  
