...
<table width="100%"  border="0">
  <tr>
    <td width="15%" height="25"><div align="left"><strong></strong></div>
  ...
  <?   
	...
	$obj=14;
	if (isset($obj)) //filtro objeto seleccionado<em></em>
	{	
    ...
    <td height="25" colspan="3"><div align="right" class="tituloproducto">
      <div align="center" class="Estilo3">FORMULARIO PARA <? echo $nombre_objeto; ?>      </div>
    </div></td>
    </tr>  
      <form name="form1" method="post" action="gagregar.php" enctype="multipart/form-data"> 
	  <table width="50%" align="center" cellpadding="5" cellspacing="5" border="10"><!--se agrego  border="10"-->
		...
		{			
			...
			while($row_qry_plantilla=$fetch_array($res_qry_plantilla))
			{
				...
				if ($row_qry_plantilla["codigo_tipo_campo"]==2)
				{
						...
						//$qry_cbo="SELECT * FROM $latabla where $condicion order by $campoorigen";  // marca el inicio de salida de comision	linea 190 a 205	se elimino la condicion
						$qry_cbo="SELECT * FROM $latabla $campoorigen";			
						...
						{							
							...
							echo'<option value="0">--Ingrese--</option>';				
							while($row_qry_cbo=$fetch_array($res_qry_cbo))
							{
								echo'<option value="'.$row_qry_cbo["$campollave"].'">'.$row_qry_cbo["$campoorigen"].'</option>';
							}
...
<td height="5"></tr> 
<br>
  <table width="90%"  border="5" align="center" cellpadding="0" cellspacing="0"> 
  <?  		
