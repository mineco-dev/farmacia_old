...
<table width="100%"  border="0">
  <tr>
    ...
    <td width="72%"><p align="center" class="titulocategoria Estilo1">SUBGERENCIA ADMINISTRATIVA</p>
        <p align="center" class="titulocategoria Estilo2"> MANTENIMIENTO DE VEHICULOS</p></td>
  ...
  <form name="form1" method="post" action="gagregar.php" enctype="multipart/form-data">
    <table width="75%" border= "10" align="center" cellpadding="5" cellspacing="5"><!--se agrego border= "10"-->
      <?
		if (isset($obj)) //verifico si hay objeto seleccionado
		{
			...
			while($row_qry_plantilla=$fetch_array($res_qry_plantilla))
			{
				...
				{					
					echo '<textarea name="'.$row_qry_plantilla["campo"].'" cols="'.$row_qry_plantilla["tamano"].'" rows="4"></textarea>';
				}
	...
	?>
      <tr>
      <tr>
        <td><span class="error">**Campos Obligatorios</span> </td>
        <td><input  name="txt_obj" type="hidden" id="txt_obj"  value="<? echo $obj?>"/>
            <input name="cmd_guardar" type="button" onClick="validar(this.form)" id="cmd_guardar" value="Guardar" ></td>
      </tr>
    </table>
    <br>
    <table width="75%"  border="10" align="center" cellpadding="0" cellspacing="0"> <!--se cambio <table width="90%"-->
      <?
 ...
 ?>
  ...
  <!--se agrego <td width="30%" height="25"><div align="center"><img src="../../images/pc.gif" width="120" height="95"></div></td>-->
