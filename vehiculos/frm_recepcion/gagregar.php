...
<!--<body se agrego style="background:#CEECF5">-->
<<body style="background:#CEECF5">>
<table width="100%"  border="0">
  <tr>
    <td width="11%" height="25"><div align="center"><img src="../../images/" width="82" height="95"></div></td>
    <td width="77%"><p align="center" class="titulocategoria Estilo1 Estilo1">SUBGERENCIA DE INFORM&Aacute;TICA</p>
    ...
    <td width="12%"><div align="right"><img src="../../images/pc.gif" width="112" height="113"></div></td>
  </tr>
  <tr>
		...
		if (($acceso==2) || ($acceso==3) || ($acceso==6) || ($acceso==7) || ($acceso==8))
		{
			...
			conectardb($inventarioadmin);
				...
				if (!$registro_encontrado)
				{
						...
						$qry_insert.="usuario_creo, fecha_creado, activo, codigo_estado_salida_vehiculo) values (";			
						$cnt=1;			
						...
						$qry_insert.="'$nombre_usuario', getdate(), 1, 1)";												
