...
<table width="100%"  border="0">
  <tr>
    <td width="16%" height="25"><div align="left"><!--<img src="../../images/pc.gif" width="82" height="95"></div>--></td>
    <td colspan="2"><p align="center" class="titulocategoria Estilo1">SUBGERENCIA ADMINISTRATIVA </p>
      <p align="center" class="titulocategoria Estilo1">&nbsp;</p>
      <p align="center" class="titulocategoria"> OPERANDO RECEPCION DE VEHICULO </p></td>
    <td width="14%"><div align="right"><img src="../../images/carro.gif" width="129" height="126"></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td rowspan="4">&nbsp;</td>
    <td width="11%" height="25" class="titulocategoria">Ingrese Lugar:</td>
    <td width="59%"><? echo $contenido[7].', ZONA '.$contenido[6].' '.$contenido[5].', '.$contenido[4]; ?></td>
    <td rowspan="4">&nbsp;</td>
  </tr>
  <tr>
    <td height="25" class="titulocategoria">Fecha Del:</td>
    <td height="25"><span class="legal"><? echo $contenido[2]; ?></span> <span class="titulocategoria">Al:</span> <? echo $contenido[3]; ?></td>
  </tr>
  <tr>
    <td height="25" class="titulocategoria">Solicitante:</td>
    <td height="25"><span class="legal"><? echo $contenido[9]; ?></span></td>
  </tr>
  <tr>
    <td height="25" class="titulocategoria">Jefe:</td>
    <td height="25"><span class="legal"><? echo $jefe; ?> - <? echo $dependencia; ?></span></td>
  </tr> 
	  <form name="form1" method="post" action="grecibir.php" enctype="multipart/form-data">
	...
	<input name="cmd_guardar" type="button" onClick="validar(this.form)" id="cmd_guardar" value="Recibir vehiculo" <? echo $status?>></td></tr>  
