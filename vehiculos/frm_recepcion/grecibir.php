...
<table width="100%"  border="0">
  <tr>
    <td width="18%" height="25"><div align="left"><img src="../../images/pc.gif" width="82" height="95"></div></td>
    <td width="72%"><p align="center" class="titulocategoria Estilo1 Estilo1">SUBGERENCIA DE INFORM&Aacute;TICA</p>
    <p align="center" class="titulocategoria Estilo2"> INVENTARIO DE HARDWARE Y SOFTWARE </p></td>
    <td width="10%"><div align="right"><img src="../../images/carro.gif" width="112" height="113"></div></td>
  ...
  <tr>
	...
	{			
		...
		if (($acceso>=4) && ($acceso<=8))
		{
			...
			while ($cnt<=count($campo)) //concatena lista de campos a grabar
				...
				$qry_insert.="usuario_opero_entrada='$nombre_usuario', fecha_opero_entrada=getdate(), activo=1, codigo_estado_salida_vehiculo=5, fecha_entrada=getdate() where $campo_llave_destino=$txt_id";														
				//session_unregister("ingresando_obj");	
				conectardb($vehiculos);										
				$res_insert=$query($qry_insert);			
				if ($res_insert)
				{					
					echo '<tr><td class="titulocategoria" colspan="3" align="center">SE HA RECIBIDO EL VEHICULO CORRECTAMENTE<br><br>Para operar otro registro <a href="buscar/buscar.php">[HAGA CLIC AQUI]</a></td></tr>';															
				} // fin del ingreso del encabezado
				else
				{
					echo '<tr><td class="error" colspan="3" align="center">Se produjo un error durante la autorización, El registro NO ha cambiado<br><br>Para intentar nuevamente <a href="buscar/buscar.php">[HAGA CLIC AQUI]</a></td></tr>';
				}	
			}
			else
			{
	...
	{
		echo '<tr><td class="error" colspan="3" align="center">Para recibiendo vehiculos <a href="buscar/buscar.php">[HAGA CLIC AQUI]</a></td></tr>';
	}
	?>            
	</td>
  </tr>
