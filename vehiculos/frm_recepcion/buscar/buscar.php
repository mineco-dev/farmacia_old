   ...
   <!-- <img src="../../../images/linea.gif" width="100%" height="6"></td>-->   
     ...
     <!--<table width="80%"  border="0" align="center" cellpadding="0" cellspacing="0">--> 
	  <table width="50%"  border="10" align="center" cellpadding="0" cellspacing="0">
       <!-- muestra la tabla de datos linea 97 a <?
		$obj=14;
		...
		{			
			...
			$condicion_detalle.="and codigo_estado_salida_vehiculo in (4,5)";
			  ...
			  if ($color==4)
				{
					...
					echo '<td class='.$clase.'><center><a href="../recibir.php?id='.$row_qry_insertados[0].'&obj='.$obj.'"><img src="../../../images/iconos/transferencia.gif" alt="Recibir Vehiculo" border="0"></a></center></td>';  									
						/*if ($status==1)				
				...
				if ($color==5)
				{
					echo '<td class='.$clase.'><center><a href="../status.php?id='.$row_qry_insertados[0].'&st=4&txt_obj='.$obj.'"><img src="../../../images/parqueo.gif" alt="Quitar de la lista" border="0"></a></center></td>';														 									
