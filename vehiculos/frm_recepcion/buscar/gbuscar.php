...
<table width="100%"  border="0">  
  <tr>
    <td height="8" colspan="3">  
	 <div align="center"><span class="legal2"> SOLICITUDES DE VEHICULOS AUTORIZADAS Y EN TR&Aacute;NSITO</span></div></td>  
      <!--<div align="center"><span class="legal2"> SOLICITUDES DE VEHICULOS AUTORIZADAS Y EN TR&Aacute;NSITO</span></div></td>-->   
  </tr>
</table>   
<!--<table border="1" width="95%" cellpadding="0" cellspacing="0" align="center">-->
<table border="10" width="85%" cellpadding="0" cellspacing="0" align="center">
	<?			
		...
		{			
			...
			$qry_plantilla="SELECT c.codigo_campo, c.campo, c.codigo_tipo_campo, c.tb_origen, c.validar, c.texto_validacion, c.ayuda,
				...
				if (strlen($qry_condicion)>=1) $qry_condicion.="and codigo_estado_salida_vehiculo in (4,5) and tb_salida_vehiculo.activo=1";
				...
				{	   	  			
					 // echo '<tr><td align="right" colspan="'.$no_campos_detalle.'"><a href="../agregar.php"><img src="../../images/iconos/ico_agregar.gif" alt="Agregar registro" border="0"></a></td></tr>';
					  ...
					  $i=1;					  
						...
						echo '<td class="boxTitleBgLightBlue" align="center">Recibir</td>';
							  ...
							  while ($cnt<=$no_campos_detalle) 
							  {
								...
								$cnt++;
									...
									if ($color==4)
									{
										...
										echo '<td class='.$clase.'><center><a href="../recibir.php?id='.$row_qry_insertados[0].'&obj='.$obj.'"><img src="../../../images/iconos/transferencia.gif" alt="Despachar Vehiculo" border="0"></a></center></td>';  									
											/*if ($status==1)				
									...
									if ($color==5)
									{
															echo '<td class='.$clase.'><center><a href="../status.php?id='.$row_qry_insertados[0].'&st=3&txt_obj='.$obj.'"><img src="../../../images/parqueo.gif" alt="Quitar de la lista" border="0"></a></center></td>';														 									
