...
<!--se agrego linea 76 a 82 para el titulo-->
-->
</style>
...
<table width="100%"  border="0">
  <tr>
    ...
    <!--<td width="72%"><p align="center" class="titulocategoria Estilo1 Estilo2">SUBGERENCIA ADMINISTRATIVA</p>-->
      <p align="center" class="titulocategoria Estilo3"> INVENTARIO DE VEHICULOS </p></td>
  ...
  <?   
    ...
    <td height="25" colspan="3"><div align="right" class="tituloproducto">
	  ...
	  <table border = "10%" width="50%" align="center" cellpadding="0" cellspacing="0">
        <?		
		...
		{			
			...
			while($row_qry_plantilla=$fetch_array($res_qry_plantilla))
			{
				...
				{					
					...
					{							
						echo '<a href="javascript:void(0)" onclick="buscar=window.open(\'../frm_buscar_vehiculo/buscar.php?tipo='.$row_qry_plantilla["campo"].'&posi=0\',\'Buscar\',\'width=650,height=425,menubar=no,scrollbars=yes,toolbar=no,location=no,directories=no,resizable=no,top=100,left=250\'); return false;"><input name="'.$row_qry_plantilla["campo"].'_name" type="text" id="'.$row_qry_plantilla["campo"].'_name" value="CLIC AQUI PARA SELECCIONAR VEHICULO" size="55" disabled /></a>';
