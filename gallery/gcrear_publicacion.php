		...
		{ 
		   ...
		   $nombre_archivo_def=$codigo_archivo.".".$extension;		   
			...
			{ 
			   ...
			   $query = "EXEC proc_publicacion_add @vcodigo_usuario='$user', @vcodigo_dependencia='$dependencia', @vdescripcion='$descripcion', @vip='$ip', @vnombre_archivo='$nombre_archivo_def', @vpalabras_clave='$claves', @vtipo_publicacion='$tipo_publicacion', @vvigencia='$vigencia'";
    		   $result=mssql_query($query);
