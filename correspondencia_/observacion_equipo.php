...
<div align="left">
  <table width="100%" border="0">
    <tr>
      <td width="23%"><div align="left">Observaciones: </div></td>
      <td width="77%">&nbsp;</td>
    </tr>
  </table>
</div>
<form name="form1" method="post" action="gobservacion_equipo.php">
  <table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" style="border-top-width:0px" id="table1">
    <tr>
	  ...
	  <?
					...
					$consulta = "SELECT a.nombre_equipo as equipo, b.numero_serie, b.codigo_equipo_det, b.observacion FROM seg_equipo a inner join seg_equipo_det b on a.codigo_equipo=b.codigo_equipo where b.codigo_equipo_det='$id'";
      ...
      <td width="5%">Serie:</td>
      <td colspan="8"><input name="txt_serie" type="text" id="txt_serie" value="<? echo $serie ?>"></td>
    </tr>
    <tr>
    
    <td height="133" align="left" class="alt1">Observaciones:</td>
    <td colspan="10" align="left" class="alt1">
    <p>
      <textarea name="txt_observacion" cols="50" wrap="PHYSICAL" id="txt_observacion"><? echo $observacion ?></textarea>
</p>
      </td>
    </tr>
    <tr>
   ...
   <input name="bt_enviar" onClick="Validar(this.form)" type="button" value="Actualizar">
      ...
      <td colspan="7" align="left" class="alt1"><span class="alt2">
        <input name="txt_codigo" type="hidden" id="txt_codigo" value="<? echo $id ?>">
  </span>
  </td>
  
  <td width="21%" align="left" class="alt1">
