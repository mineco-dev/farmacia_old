        ...
        <td colspan="4"><center>
            <table width="99%" border="1" class="tablaazul">
              <tr bordercolor="#333333">
                <td width="8%"><div align="center"><strong>Ver visita </strong></div></td>
                <td width="8%"><div align="center"><strong>Gafete</strong></div></td>
                <td width="18%"><div align="center"><strong>Fecha ingreso</strong></div></td>
                <td width="29%"><div align="center"><strong>Nombre del visitante</strong></div></td>
                <td width="18%"><div align="center"><strong>Ingresado por: </strong></div></td>
                <td width="19%"><strong>Sale?</strong></td>
              </tr>
              <?				 	
				...
				while($row3=mssql_fetch_array($result3))
				{
					...
					if (($grupo_id==3) && ($estado==2)) echo '<tr class='.$clase.'><td><center><a href="visitas_activas_det.php?id='.$row3["codigo_visita"].'"><img src="../imagenes/iconos/ico_ver.jpg"></a></center></td><td><center><a href="visita_det.php?id='.$row3["codigo_visita"].'">'.$row3["gafete_asignado"].'</a></center></td><td><center>'.$row3["fecha_ingreso"].'</center></td><td><center>'.$row3["nombre_visitante"].'</a></center></td><td><center>'.$row3["nombres"].'&nbsp;'.$row3["apellidos"].'</center></td><td><center><a href="salida.php?id='.$row3["codigo_visita"].'"><img src="../imagenes/iconos/ico_salir.jpg"></a></center></td></tr>';
					else
					if (($grupo_id==3) && ($estado==1)) echo '<tr class='.$clase.'><td><center><a href="visitas_activas_det.php?id='.$row3["codigo_visita"].'"><img src="../imagenes/iconos/ico_ver.jpg"></a></center></td><td><center><a href="visita_det.php?id='.$row3["codigo_visita"].'">'.$row3["gafete_asignado"].'</a></center></td><td><center>'.$row3["fecha_ingreso"].'</center></td><td><center>'.$row3["nombre_visitante"].'</a></center></td><td><center>'.$row3["nombres"].'&nbsp;'.$row3["apellidos"].'</center></td><td><center><img src="../imagenes/iconos/ico_salir.jpg"></center></td></tr>';
					else echo '<tr class='.$clase.'><td><center><a href="visitas_activas_det.php?id='.$row3["codigo_visita"].'"><img src="../imagenes/iconos/ico_ver.jpg"></a></center></td><td><center>'.$row3["gafete_asignado"].'</center></td><td><center>'.$row3["fecha_ingreso"].'</center></td><td><center>'.$row3["nombre_visitante"].'</a></center></td><td><center>'.$row3["nombres"].'&nbsp;'.$row3["apellidos"].'</center></td><td><center><img src="../imagenes/iconos/ico_salir.jpg"></center></td></tr>';									
					$i++;
				}
				mssql_close($s);				
			  ?>
