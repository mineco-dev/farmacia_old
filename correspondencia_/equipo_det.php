		...
		<?				
				...
				{					
					...
					if ($i % 2 == 0) 
					{
						...
						echo '<tr class='.$clase.'><td colspan="2">'.$row3["equipo"].'</td><td>'.$row3["numero_serie"].'</td><td colspan="2">'.$row3["descripcion"].'</td><td><center><a href="observacion_equipo.php?id='.$row3["codigo_equipo_det"].'"><img src="../imagenes/iconos/ico_editar.jpg"></a></center></td></tr>';										
					$i++;
				}
				$close($s);				
				session_write_close();
