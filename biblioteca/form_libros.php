...
-->
  ...
  <?
	...
	$fecha_ingreso = date("Y-m-d H:i:s");
		...
		$consulta = "insert into tb_libros (codigo,tip_documento,tema,titulo,autor,lugar,fecha_impresion,resumen,palabras_clave,anaquel,entrepano,fecha_ingreso,existencia,file1) values ('$codigo','$tip_documento','$tema','$titulo','$autor','$lugar','$fecha_impresion','$resumen','$palabras_clave','$anaquel','$entrepano','$fecha_ingreso',$existencia,'$nombre_archivo_def')";	
  ...
  <tr>
    <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="4">
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td><label>
          <input name="file1" type="file" class="BasicFontInBorder4" id="file1" onKeyUp="javascript:this.value=this.value.toUpperCase();" />
        </label></td>
      </tr>
      <tr>
