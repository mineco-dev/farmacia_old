...
<table width="100%"  border="0">
  ...
  <tr>
    ...
    <td height="25" class="tituloproducto"><span class="legal"><? echo $c; ?> <span class="titulomenu">A&ntilde;o: </span><? echo $contenido[8]; ?> </span></td>
	  ...
	  <form name="form1" method="post" action="ppto_renglon.php" enctype="multipart/form-data">
					  ...
					  $i=1;					  
						...
						while($row_qry_insertados=$fetch_array($res_qry_insertados))
						{
							  ...
							  while ($cnt<=$no_campos_detalle) 
							  {
								...
								echo '<td class='.$clase.'><center><a href="ppto_renglon.php?id='.$row_qry_insertados[0].'&pr='.$id.'&c='.$c.'"><img src="../../../images/iconos/ico_editar.gif" alt="Ingresar presupuesto por rengl�n" border="0"></a></center></td>';							  					
	...
	<input  name="txt_id_financiamiento_actividad" type="hidden" id="txt_id"  value="<? echo $id?>"/>
	<input  name="txt_cuatrimestre" type="hidden" id="txt_cuatrimestre"  value="<? echo $c?>"/> 			</td></tr>  
</table>	  	 		  
</tr> 
<br>
<br>    
