...
function agregar4() {
	...
	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"mes1["+contLin4+"][4]\" type=\"text\" id=\"select\" size=\"10\">";
...
<table width="100%" border=1 cellspacing="0" id="tabla4">
  <tr>
    ...
    <th width="82">Año-Mes-Dia</th>
    <th width="77">Pagado</th>
	<th width="50">Renglon</th>
  </tr>
  
  <?
  	$query_ejecucion = "select codigo_ejecucion_presupuesto,proveedor,no_orden,convert(varchar(10),fecha,126),devengado,codigo_mes,codigo_ejecucion_presupuesto,codigo_renglon 	
	from tb_ejecucion_presupuesto where codigo_financiamiento_actividad = '$pr' and
	codigo_presupuesto_anual = '$id' and
	codigo_periodo = '$c'";

	//print $query_ejecucion;
...
{	
	...
	print '<th width="77"><input name="'.$umes1[$cnt][5].'" value="'.$vector_ejecucion[7].'" type="text" ></th>';
