...
<table border="0" cellspacing="0" cellpadding="4" id="mycalendar">
  ...
  <tr>
    <td class="btn" width="50%"><a href="javascript:move('<?=$previous_month;?>', '<?=$previous_year;?>');">&lt;&lt; anterior</a> </td>
    <td align="right" class="btn" width="50%"><a href="javascript:move('<?=$next_month;?>', '<?=$next_year;?>');">siguiente &gt;&gt;</a> </td>
  </tr>
</table>
