...
<table width="100%"  border="0">
  ...
  <?   
	...
	<tr><td height="25" colspan="3">    
    	<img src="../../images/linea.gif" width="100%" height="6"></td></tr></table>
	<table width="90%" border="0" align="center">		  
		   ...
		   <td>
			...
			<div id="TabbedPanels1" class="TabbedPanels">
				...
				<li class="TabbedPanelsTab style3" tabindex="0">Presupuesto por Rengl�n <span class="error">**</span></li>				
				</ul>
				<div class="TabbedPanelsContentGroup">					
					<div class="TabbedPanelsContent">
						<?  include("presupuesto_det.php"); ?>
						<br>
					</div>											
				</div>
			</div>
	...
	<center><input name="cmd_guardar" type="button" onClick="validar(this.form)" id="cmd_guardar" value="Guardar" <? echo $status?> </center>		  	 		  
