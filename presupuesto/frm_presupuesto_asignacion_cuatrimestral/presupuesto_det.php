...
function agregar4() {
	...
	td = tr.insertCell();
	td.innerHTML = 	"<a href=\"javascript:void(0)\" onDblClick=\"buscar=window.open(\'../frm_buscar_grupo/buscar.php?tipo=bien&posi="+contLin4+"\',\'Buscar4\',\'width=700,height=500,menubar=no, scrollbars=yes,toolbar=no,location=no,directories=no,resizable=no,top=100,left=250\'); return false;\"><input name=\"bien["+contLin4+"][0]\" type=\"text\" value=\"\" id=\"textfield\"  alt=\"Doble clic para consultar el catalogo\" size=\"10\"></a>";
	
	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"bien["+contLin4+"][2]\" type=\"text\" id=\"textfield\" disabled size=\"50\" maxsize=\"100\">";

	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"monto["+contLin4+"]\" type=\"text\" id=\"textfield\" size=\"7\">";
...
<table width="100%" border=1 cellspacing="0" id="tabla4">
  <tr>
    ...
    <th width="78" scope="col"><span class="Estilo2">Grupo</span></th>
    <th width="700" scope="col"><div align="center" class="Estilo2">Descripcion</div></th>
    <th width="71" scope="col"><span class="Estilo2">Monto Anual </span></th>
  </tr>
</table>
<br>
