...
<table width="100%"  border="0">
  ...
  <tr>
	...
	{			
		...
		if (($acceso>=4) && ($acceso<=8))
		{
			...
			while ($cnt<=count($campo)) //concatena lista de campos a grabar
				...
				if ($res_insert)
				{					
					echo '<tr><td class="titulocategoria" colspan="3" align="center">EL REGISTRO SE HA ACTUALIZADO CORRECTAMENTE<br><br>Para ingresar otro registro <a href="buscar/buscar.php?obj='.$txt_obj.'">[HAGA CLIC AQUI]</a></td></tr>';															
				} // fin del ingreso del encabezado
				else
				{
					echo '<tr><td class="error" colspan="3" align="center">Se produjo un error durante la actualización, El registro NO ha cambiado<br><br>Para intentar nuevamente <a href="buscar/buscar.php?obj='.$txt_obj.'">[HAGA CLIC AQUI]</a></td></tr>';
				}	
			}
			else
			{
	...
	{
		echo '<tr><td class="error" colspan="3" align="center">Para editar otro registro <a href="buscar/buscar.php?obj='.$txt_obj.'">[HAGA CLIC AQUI]</a></td></tr>';
	}
	?>            
	</td>
  </tr>
