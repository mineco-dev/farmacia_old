...
and tb1.codigo_descripcion = 1 and tb2.fecha >= "'.$fecha1.'" and tb2.fecha <= "'.$fecha2.'" and tb2.activo = 1'*/
	...
	$sql="select count(tb1.codigo_consulta) canti
				 from
					tb_consulta tb1
				 where
					month(tb1.fecha_consulta) = $ids and  
					year(tb1.fecha_consulta) = $ta";
