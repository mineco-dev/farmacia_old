...
<!--form name="form1" method="post" action="asesoringreso.php"-->
  ...
  <tr bgcolor="#0066CC">
    <td colspan="7"><div align="center"><span class="Estilo1 Estilo2"> GRUPO</span></div></td>
    </tr>
  <tr>
  	<td>&nbsp;</td>
...
//	$sqlsel = "SELECT * FROM ( SELECT *, ROW_NUMBER() OVER (ORDER BY id_grupo) as row FROM grupo ) as grupo WHERE row > $rangoini and row <= $rangofin";
	...
	<tr>
		...
		<td bgcolor="#C9CDED"><a href="editar_grupo.php?codigo=<? echo $cod; ?>"> <img src="images/iconos/b_edit.png" width="16" height="16" border="0"></a></td>
