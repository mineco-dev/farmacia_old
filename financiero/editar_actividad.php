...
$codi = $_GET['codigo'];
 ...
 $result2 = mssql_query ("select  id_actividad, actividad from actividad where id_actividad = $codi");
...
</span>Ministerio de Econom�a de Guatemala </p></th>
</tr>
  <tr bgcolor="#0066CC">
    <td colspan="7"><div align="center"><span class="Estilo1 Estilo2">Edita Datos Actividad</span></div></td>
  </tr>
		  ...
		  <form name="form1" method="post" action="guardar_actividad.php ">
 ...
 <tr class="Estilo1" >
    <td class="Estilo22" align="right">Codigo<font color="#FF0000"></font></td>
				...
				<td class="Estilo7">
						...
						<input name="id_actividad"  disabled="disabled" type="text" id="id_actividad"  maxsize="1"  size="1" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['id_actividad'];  ?>">
...
<tr class="Estilo1">
    <td class="Estilo22" align="right">Actividad<font color="#FF0000"></font></td>

                <th width="467" scope="col">
                  <div align="left">
                    <input name="actividad" type="text" class="Estilo7" id="actividad" maxsize="50"  size="50"   onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['actividad'];  ?>">                
                  </div></th>
