...
$codi = $_GET['codigo'];
 ...
 $result2 = mssql_query ("select  id_grupo, grupo from grupo where id_grupo = $codi");
...
<th colspan="2" scope="col" align="center"><p class="Estilo3"><span class="Estilo1 Estilo8">
  ...
  <tr bgcolor="#0066CC">
    <td colspan="7"><div align="center"><span class="Estilo1 Estilo2">Edita Datos Grupo</span></div></td>
  </tr>
		  ...
		  <form name="form1" method="post" action="guardar_grupo.php ">
 ...
 <tr class="Estilo1" >
    <td class="Estilo22" align="right">Codigo<font color="#FF0000"></font></td>
				...
				<td class="Estilo7">
						...
						<input name="id_grupo"  disabled="disabled" type="text" id="id_grupo"  maxsize="1"  size="1" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['id_grupo'];  ?>">
...
<tr class="Estilo1">
    <td class="Estilo22" align="right">Grupo<font color="#FF0000"></font></td>
                ...
                <th width="467" scope="col">
                  <div align="left">
                    <input name="grupo" type="text" class="Estilo7" id="grupo" maxsize="50"  size="50"   onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['grupo'];  ?>">                
                  </div></th>
