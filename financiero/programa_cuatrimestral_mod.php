...
//	conectar();
	$consulta=mssql_query("SELECT id_grupo, grupo, ident_grupo FROM grupo");

	// Voy imprimiendo el primer select compuesto por los paises
	echo "<select name='grupo' id='grupo' onChange='cargaContenido(this.id)'>";
...
//*** 		 se utiliza la variable de sesion con que hara login
			...
			$sql_pro = "select b.ident_programa, b.programa from empleado_programa a, programa b where id_asesor = ".$_SESSION['empleado']." and a.id_programa = b.id_programa"; 
  ...
  <td width="200" bgcolor="#3399FF"  id="fila_1" class="Estilo22"><span lang="es-gt"> <span lang="es-gt">
        <span lang="es-gt"><span lang="es-gt">
        <select name="grupo" id="grupo"  onChange="javascript:cargarCombo('subactividades1.php', 'grupo', 'Div_Subactividades1')">
          ...
          <? 
				...
				{
					print "<option value=\"".$Fields["id_grupo"]."\">".$Fields["ident_grupo"].' '.$Fields["grupo"]."</option>"; 
				}
			?>
        </select>
	...
	<!--tr class="Estilo1">
		...
		<td class="Estilo7">
			 <div align="left">
            <div id="Div_Subactividades1">
              <label for="SubActividad1"></label>
              <select name="renglon"  id="select1" >
              </select>
            </div>
          </div>
	...
	<tr class="Estilo1">
		...
		<td class="Estilo7"-->
			<!--div id="demo" style="width:600px;">
				<div id="demoDer">
					<select disabled="disabled" name="renglon" id="renglon">
						<option value="0">Selecciona opci&oacute;n...</option>
					</select>
				</div>
				<div id="demoIzq"><?php //generaGrupo(); ?></div>				
			</div-->				
		<!--/td>
	</tr-->
	</table>
