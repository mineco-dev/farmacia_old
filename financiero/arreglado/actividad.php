...
<table border="0" align="center" class="Estilo1 ">
  <tr>
    <td bgcolor="#C9CDED"><strong>Programa</strong></td>
    <td bgcolor="#99CCFFF" width="500" align="center"><strong>Actividad</strong></td>
...
//	$sqlsel = "SELECT * FROM ( SELECT *, ROW_NUMBER() OVER (ORDER BY id_grupo) as row FROM grupo ) as grupo WHERE row > $rangoini and row <= $rangofin";
	...
	<tr>
	    ...
	    <td bgcolor="#99CCFF"><a href="subgrupo.php?eli=1&id=<? echo $row["id_actividad"]; ?>" title="Eliminar" target="self"><img src="images/iconos/button_drop.png" width="16" height="16" border="0"></a></td>
	</tr>
	<?
 		}
