...
<!--form name="form1" method="post" action="asesoringreso.php"-->
  ...
  <tr class="Estilo1" >
    ...
    <td class="Estilo7"><input name="ident_subgrupo" type="text" class="Estilo7" maxsize="2"  size="2" onKeyUp="javascript:this.value=this.value.toUpperCase();"></td>
  </tr>
...
//	$sqlsel = "select id_grupo, grupo from grupo where id_grupo >= $rangoini and id_grupo <= $rangofin order by 1";
	$sqlsel = "select a.grupo, a.ident_grupo, b.id_subgrupo, b.subgrupo, b.ident_subgrupo from grupo a, subgrupo b where a.id_grupo = b.id_grupo ";//where id_grupo >= $rangoini and id_grupo <= $rangofin order by 1";
//	echo $sqlsel;
