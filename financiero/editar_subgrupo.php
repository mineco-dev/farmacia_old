...
$codi = $_GET['codigo'];
 ...
 $result2 = mssql_query ("select  id_subgrupo, subgrupo from subgrupo where id_subgrupo = $codi");
...
<th colspan="2" scope="col" align="center"><p class="Estilo3"><span class="Estilo1 Estilo8">
  ...
  <tr bgcolor="#0066CC">
    <td colspan="7"><div align="center"><span class="Estilo1 Estilo2">Edita Datos SubGrupo</span></div></td>
  </tr>
		  ...
		  <form name="form1" method="post" action="guardar_Subgrupo.php ">
 ...
 <tr class="Estilo1" >
    <td class="Estilo22" align="right">Codigo<font color="#FF0000"></font></td>
				...
				<td class="Estilo7">
						...
						<input name="id_subgrupo"  disabled="disabled" type="text" id="id_subgrupo"  maxsize="1"  size="1" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['id_subgrupo'];  ?>">
...
<tr class="Estilo1">
    <td class="Estilo22" align="right">SubGrupo<font color="#FF0000"></font></td>

                <th width="467" scope="col">
                  <div align="left">
                    <input name="subgrupo" type="text" class="Estilo7" id="subgrupo" maxsize="50"  size="50"   onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['subgrupo'];  ?>">                
                  </div></th>
