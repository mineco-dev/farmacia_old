...
<!-- style="background:#CEECF5" se agrego-->
<body  style="background:#CEECF5">
<table width="100%"  border="0">
  <tr>
    <td width="18%" height="25"><div align="center"><img src="../images/pc.gif" width="90" height="95"></div></td>
    <td width="72%"><p align="center" class="titulocategoria Estilo1 Estilo1">SUBGERENCIA DE RECURSOS HUMANOS</p>
					  ...
					  echo '<tr>';  			
						...
						while($row_qry_insertados=$fetch_array($res_qry_insertados))
						{
							  ...
							  while ($cnt<=$no_campos_detalle) 
							  {
								...
								echo "<td class=".$clase."><A HREF=\"javascript:pick('$id_reg', '$completo')\"><center><img src=\"../images/iconos/ico_ir.gif\" border=\"0\" alt=\"Seleccionar este empleado\"></a></center></td></a></center></td>";	
							   echo '</tr>';
							$i++;
						}
