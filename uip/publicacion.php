...
<?	
	...
	{	
		if ($txt_buscar!="")
		{
			$consulta = "SELECT i.codigo_grupo, i.codigo_inciso, i.titulo, g.nombre_grupo FROM uip_inciso i
						inner join uip_dependencia d on d.codigo_inciso=i.codigo_inciso and d.codigo_grupo=i.codigo_grupo 
						inner join uip_grupo g on g.codigo_grupo=d.codigo_grupo
						where d.codigo_dependencia='$dependencia' and i.titulo like '%$txt_buscar%'
						order by i.codigo_grupo, i.codigo_inciso";
		}
		else
		{
			$consulta = "SELECT i.codigo_grupo, i.codigo_inciso, i.titulo, g.nombre_grupo FROM uip_inciso i
						inner join uip_dependencia d on d.codigo_inciso=i.codigo_inciso and d.codigo_grupo=i.codigo_grupo 
						inner join uip_grupo g on g.codigo_grupo=d.codigo_grupo
						where d.codigo_dependencia='$dependencia'
						order by i.codigo_grupo, i.codigo_inciso";	
		}	
	}
	else
  ...
  <form name="form1" method="post" action="">
    <table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" id="table17">
        ...
        <tr>
          ...
          <td colspan="3" class="tcat"><div align="center">Informaci&oacute;n p&uacute;blica de oficio </div></td>
        </tr>
