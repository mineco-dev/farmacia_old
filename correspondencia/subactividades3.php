...
<select name="SubActividades3"  id="SubActividades3" > 
<? 
	if ($_SESSION['sstipo'] == 3)
	 {
		$dbms->sql="select  idasesor, nombre, nombre2, nombre3, apellido, apellido2, apellidocasada from asesor where iddireccion = $IdActividad and id_puesto=14 order by 2"; 
	 }
	else
	 {
