...
/**
 * object for saving and restoring properties of the given object - SRProp (Save Restore O)
ect Properties)
 ...
 * @ param recursive [boolean] searches in childs.
 */
Zapatec.Utils.initDragObjects Nafunction(className, el, recursive, attribObject){
	if (!className) return;
	el = Zapatec.Utils.idOrObject(el);
