// $Id: dropdown.js 4461 2006-09-18 09:17:34Z andrew $
/*
 * <pre>
...
Zapatec.DropDown.prototype.show = function(){
	...
	var self = this;.othis.container.onclick = function(){self.isVisible = true;}
	...
	this.container.style.left = (pos.x + (Zapatec.is_ie ? 1 : 0)) + "px";
