...
// valida ingreso unicamente numerico con puntos
...
<td>
<input type="text" name="hijos" size="2" maxlength="2" value="<? if ( $row['hijos'] > 0) { echo $row['hijos']; } else { echo '0'; } ?>" onkeypress="return validar_n(event)">&nbsp;&nbsp;&nbsp;&nbsp;<? if ( $row['hijos'] > 0) { ?> <a href="actualiza_familia.php?paramas=<? echo $_GET['paramas']; ?>&numhi=<? echo $row['hijos']; ?>" target="_self"><font color='#FF0000'><strong> Actualizar Familiaridad</strong></font></a><? } ?>
</td>
  </tr>
...
<input name="cedula" type="text" class="Estilo7" id="cedula" size="6" value="<? print $row['cedula'];  ?>" onkeypress="return validar_n(event)"></span></td>
...
<tr class="Estilo1">
    ...
    <td class="Estilo7">
      <input name="licencia" type="text" class="Estilo7" id="licencia" size="30" value="<? print $row['licencia'];  ?>" onkeypress="return validar_n_g(event)"></td>
...
<!--input name="tipolicencia" type="text" class="Estilo1" id="tipolicencia" size="30"-->
	...
	while($Fields=$dbms->MoveNext()) 
	{
	  if ($Fields['idgrupoetnico'] == $row['idgrupoetnico'] )
	   {
...
<tr>
	...
	<td class="Estilo7">
	          	<div align="left">
					<input name="zona" type="text" class="Estilo7" id="zona" size="2"  maxlength="2" value="<? print $row['zona'];  ?>" onkeypress="return validar_n(event)" >
				</div>
 ...
 <option value=''> Seleccione </option>
  ...
  <tr>
    ...
    <td><span class="Estilo47"><span class="Estilo7">
      <input name="telefono" type="text" class="Estilo7" id="telefono" size="8" maxlength="8" value="<? print $row['telefonocasa'];  ?>" onkeypress="return validar_n(event)">
    </span></span></td>
...
<input name="celular" type="text" class="Estilo7" id="celular" size="8" maxlength="8" value="<? print $row['telefonocelular'];  ?>"  onkeypress="return validar_n(event)">
</span></td>
...
<select name="anoi" class="Estilo1" <? if ($anoi != ''  && $sstipo != 1 ) { ?> disabled  <? } ?> >
  ...
  <tr>
    ...
    <td><span class="Estilo47"><span class="Estilo1"> <input name="partida" type="text" class="Estilo7" maxlength="50" size="35" id="partida" value="<?  print $row['partida'];  ?>"   <? if ( $sstipo != 1) { echo 'disabled'; } ?> onkeypress="return validar_n_g(event)" >
    </span></span></td>
...
<td>
	  ...
	  <input name="extension" type="text" id="extension" size="10" value="<? print $row['extension'];  ?>"   <? if ( $sstipo != 1) { echo 'disabled'; } ?> onkeypress="return validar_n(event)">
</td>
...
<td>
<input name="gafete" type="text" id="gafete" size="10" value="<? print $row['gafete'];  ?>"   <? if ( $sstipo != 1) { echo 'disabled'; } ?> onkeypress="return validar_n(event)">
</td>
...
<td>
<input name="sueldo" type="text" id="sueldo" size="10" value="<? print $row['sueldo']; ?>"   <? if ( $sstipo != 1) { echo 'disabled'; } ?> onkeypress="return validar(event)">
</td>
