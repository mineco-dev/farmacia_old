...
if(validaEntrada($valor, $selectACargar))
{
	...
	if($selectACargar==2) 
		echo "<select class='combo' onChange='cargaContenido(3)' id='select2_$selectACargar' name='select2_$selectACargar'>";
	else
		echo "<select class='combo' id='select2_$selectACargar' name='select2_$selectACargar'>";		
