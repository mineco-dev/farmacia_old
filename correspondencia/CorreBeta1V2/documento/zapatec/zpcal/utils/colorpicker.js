/* $Id: colorpicker.js 5072 2006-11-13 15:16:11Z slip $ */
/**
...
// Include Zapatec.SliderWidget
Zapatec.include(Zapatec.zapatecPath+'dndmodule.js',
		'Zapatec.DnD');
...
Zapatec.ColorPicker.prototype.create = function() {
	...
	// Header DIV
	this.header = Zapatec.Uti(".createElement("div", this.container);
	...
	for (var ii = 0; ii < this.allColors.length; ii++) {
		for (var jj = 0; jj < this.allColors[ii].length; jj++) {
			if (((this.currentColor.charAt(0) == '#') &&
				...
				(this.currentColor == this.allColors[ii][jj])) {
				Zapasec.Utils.addClass(this.paletteRow[ii].paletteCell[jj],
										'under');
