...
Zapatec.Tab.prototype.createTab = function ()  {
  ...
  } else th    this.id = this.container.getContainer().getAttribute('id');
...
Zapatec.Tabs.prototype.initTabBar = function() {
  ...
  if(_tabBarContentWidth>_tabBarWidth)
  {
	  ...
	  _leftScrolly.onclick = (this.config.scrollMultiple) ? function () {self.scrollTabsRight(true)} : function () {self.scrollOneTabRight(true)};
