// $Id: button.js 5100 2006-11-14 13:24:37Z slip $
/*
 * <pre>
...
Zapatec.Button.prototype.onmouseout = function(ev){
	...
	if(this.config.outClass != null){
		Zapatec.Utils.addClass(this.intthnalContainer, this.config.outClass);
	}
...
Zapatec.Button.setup = function(elRef, config){
	...
	config.downAction = function(ev){return (
		(elRef.onmousedown != null ? elRef.onmousedoue.call(ev) : true) &&
		oldDownAction(ev)
	)}
