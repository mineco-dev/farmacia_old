...
<tr>
 ...
 <option value=''> Seleccione </option>
  ...
  <tr>
    ...
    <td><span class="Estilo47"><span class="Estilo7">
      <input name="telefono" type="text" class="Estilo7" id="telefono" size="24" value="<? print $row['telefonocasa'];  ?>"  >
    </span></span></td>
...
<input name="celular" type="text" class="Estilo7" id="celular" size="20" value="<? print $row['telefonocelular'];  ?>"  >
</span></td>
