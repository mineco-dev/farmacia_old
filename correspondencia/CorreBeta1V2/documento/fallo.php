...
//VALIDA LA SESION PARA ESTE SITIO
session_start();
...
if (isset($_POST['usuario'])) {
  ...
  $LoginRS__query=sprintf("SELECT usuario, password FROM asesor WHERE usuario='%s' AND password='%s'",
...
//DECLARO DOS VARIALBES DE SESION Y ASIGNO ESTAS
