...
if(validaEntrada($valor, $selectACargar))
{
	...
	if($selectACargar==2) 
		echo "<select class='combo' onChange='cargaContenido5(3)' id='select5_$selectACargar' name='select5_$selectACargar'>";
	else
		echo "<select class='combo' id='select5_$selectACargar' name='select5_$selectACargar'>";		
