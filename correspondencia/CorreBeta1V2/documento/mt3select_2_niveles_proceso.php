...
if(validaEntrada($valor, $selectACargar))
{
	...
	if($selectACargar==2) 
		echo "<select class='combo' onChange='cargaContenido(3)' id='select3_$selectACargar' name='select3_$selectACargar'>";
	else
		echo "<select class='combo' id='select3_$selectACargar' name='select3_$selectACargar'>";		
