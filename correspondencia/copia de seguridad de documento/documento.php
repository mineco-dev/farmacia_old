...
/*			envia_msg($correlativo);
  ...
  <table width="97%"  border="0" align="center" cellpadding="0" cellspacing="5">
    ...
    <tr>
      ...
      <td width="12%"><table border="0" width="600px" style="border-style:none;">
          <tr>
...
<div align="left">
    ...
    <tr>
        ...
        <td rowspan="5">
          ...
          <table border="0" width="600px" style="border-style:none;">
          <tr>
            <td width="200" bgcolor="#3399FF" class="punteado" id="fila_31">
			<span lang="es-gt">
        ...
        <table border="0" width="600px" style="border-style:none;">
          <tr>
            <td width="200" bgcolor="#3399FF" class="punteado" id="fila_41"><span class="punteado"><span lang="es-gt">
...
<table width="98%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
      ...
      <tr bordercolor="#000000">
        <td width="43%" height="202" valign="top"><p><font face="Arial, Helvetica, sans-serif"><span class="Estilo10">La Correspondencia debe ser finalizada para </span></font></p>
          <p><font face="Arial, Helvetica, sans-serif"><span class="Estilo10">el d�a y hora: </span></font>
<SPAN style='display:inline;width:100;'>


<input type="text" name="date9" id="sel9" size="30"
