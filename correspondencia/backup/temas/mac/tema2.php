...
<table WIDTH=100% border=0 VALIGN=TOP cellpadding=1 cellspacing=0>
	<tr>
	<td width="100%" bgcolor="#767676" align="center">
	<table width="100%" height="100%" border="0" align="center" cellpadding="5" cellspacing="0" summary="" bgcolor="#EAEAEA">
		<tr>
		<td bgcolor="#EAEAEA" valign="top" width="100%" CLASS="content">
		<?php } elseif ($typ==1) { ?>
		<br><br><br>
		<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			$width=10+$wbfontsize;echo("<img src='temas/$wbtema/images/restaurar.gif' onclick='blockswitch(8);' border='0'><a href='index.php' title='Cerrar' >&nbsp;<img src='temas/$wbtema/images/cerrar.gif' onmouseOver=cambiar_imagen(this,'temas/$wbtema/images/cerrar2.gif') onmouseOut=cambiar_imagen(this,'temas/$wbtema/images/cerrar.gif') border='0'></a>"); ?></td>
