...
<table WIDTH=100% border=0 VALIGN=TOP cellpadding=1 cellspacing=0>
	...
	<table width="100%" height="100%" border="0" align="center" cellpadding="5" cellspacing="0" summary="" bgcolor="#F0EFE4">
		...
		<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			$width=10+$wbfontsize;echo("<img src='temas/$wbtema/images/restaurar.gif' id='pic8' onclick='blockswitch(8);' border='0'><a href='index.php' title='Cerrar' ><img src='temas/$wbtema/images/cerrar.gif' onmouseOver=cambiar_imagen(this,'temas/$wbtema/images/cerrar2.gif') onmouseOut=cambiar_imagen(this,'temas/$wbtema/images/cerrar.gif') border='0'></a>"); ?></td>
