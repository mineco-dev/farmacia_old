...
<table WIDTH=100% border=0 VALIGN=TOP cellpadding=1 cellspacing=0>
	...
	<table width="100%" height="100%" border="0" align="center" cellpadding="5" cellspacing="0" summary="" bgcolor="#F0EFE4">
		...
		<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<td height="1" nowrap background="<?php echo("temas/$wbtema/");?>images/frame_top.gif" class="frametitle" align="right"><?php 	echo("<img src='temas/$wbtema/images/frame_grip.gif' border=0><font color='#ffffff'><b>&nbsp;$titulotabla&nbsp;</b></font>"); $height=10+$wbfontsize;
			$width=10+$wbfontsize;echo("<img src='temas/$wbtema/images/restaurar.gif' onclick='blockswitch(8);' height=$height width=$width border='0'><a href='index.php' title='Cerrar' ><img src='temas/$wbtema/images/cerrar.gif' height=$height width=$width onmouseOver=cambiar_imagen(this,'temas/$wbtema/images/cerrar2.gif') onmouseOut=cambiar_imagen(this,'temas/$wbtema/images/cerrar.gif') border='0'></a>"); ?></td>
			...
			<table width="100%" height="100%" border="0" align="center" cellpadding="10" cellspacing="0" summary="" bgcolor="#FFFFFF">
				...
				<table width="168" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
					<td height="25" height="1" align="left" valign="middle" background="<?php echo("temas/$wbtema/");?>images/frameb_top.gif" onclick="blockswitch('7');" class="sidetitle">&nbsp;&nbsp;Descripción</td>
					</tr>
					<tr>
					<td bgcolor="#FFFFFF" align="center" height="100%" colspan="3">
					<div id="pe7" style="">
					<table width="100%" height="100%" border="0" align="center" cellpadding="5" cellspacing="1" summary="" bgcolor="#FFFFFF">
						<tr>
				...
				<table width="168" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
					<td height="25" height="1" align="left" valign="middle" background="<?php echo("temas/$wbtema/");?>images/frameb_top.gif" onclick="blockswitch('6');" class="sidetitle">&nbsp;&nbsp;Ayuda</td>
					</tr>
					<tr>
					<td bgcolor="#FFFFFF" align="center" height="100%" colspan="3">
					<div id="pe6" style="">
