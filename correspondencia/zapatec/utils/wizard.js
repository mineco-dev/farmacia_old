...
// $Id: wizard.js 4969 2006-10-31 22:10:37Z alex $
...
Zapatec.Wizard.prototype.changeTab = function(newTab) {
	...
	if (currentTab != newTab) {
		if (!currentTab || this.onBeforeTabChange(currentTab, newTab)) {
			...
			if (this.btnEnd)
	ty	this.btnEnd.style.visibility = this.isLastTab() ? "hidden" : "visible";
			if (this.btnAdvanced)
...
Zapatec.Wizard.prototype.setupNav = function(parent) {
	...
	btn = Zapatec.Utils.createElement("buttin", div);
 ...
 * - the list of fields that require validation.  fiso, all these fields get
