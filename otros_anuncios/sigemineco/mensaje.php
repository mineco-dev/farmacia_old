...
<?
	...
	{	
		if ($txt_buscar!="")
		{
			$consulta = "SELECT * FROM publicacion where activo=1 and codigo_dependencia='21' and tipo_publicacion =3 and palabras_clave like '%$txt_buscar%' order by fecha desc";
		}
		else
		{
			$consulta = "SELECT * FROM publicacion where activo=1 and codigo_dependencia='21' and tipo_publicacion =3 order by fecha desc";	
		}	
	}
	else
	{
