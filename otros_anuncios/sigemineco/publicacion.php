...
<?
	...
	{	
		if ($txt_buscar!="")
		{
			$consulta = "SELECT * FROM publicacion where activo=1 and codigo_dependencia='21' and tipo_publicacion in (1,2,3) and palabras_clave like '%$txt_buscar%' order by fecha desc";
		}
		else
		{
			$consulta = "SELECT * FROM publicacion where activo=1 and codigo_dependencia='21' and tipo_publicacion in (1,2,3) order by fecha desc";	
		}	
	}
	else
	{
...
<div align="left">
  <form name="form1" method="post" action="">
    <table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" id="table17">
        <tr>
          <td width="240" class="tcat"><div align="right">B&uacute;squeda por Asunto:</div></td>
