		...
		{ 
		   ...
		   $nombre_archivo_def=$codigo_archivo.".".$extension;		   
			...
			{ 
			   ...
			   $query = "
insert into publicacion (codigo_usuario, codigo_dependencia, descripcion, ip, nombre_archivo, palabras_clave, tipo_publicacion, vigencia)
values ('$user','36', '$descripcion','$ip','$nombre_archivo_def','$claves','$tipo_publicacion','$vigencia')";
    		   $result=mssql_query($query);
...
values ('$user','36', '$descripcion','$ip','$nombre_archivo_def','$claves','$tipo_publicacion','$vigencia')";
	...
	mssql_close($s);	
phpinfo();
//	header("Location: publicacion2.php"); 
?> 
