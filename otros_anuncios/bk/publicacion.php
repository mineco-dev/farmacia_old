...
<?
	...
	{	
		if ($txt_buscar!="")
		{
			$consulta = "SELECT * FROM publicacion where activo=1 and codigo_dependencia='$departament_id' and tipo_publicacion=3 and palabras_clave like '%$txt_buscar%' order by fecha desc";
		}
		else
		{
			$consulta = "SELECT * FROM publicacion where activo=1 and codigo_dependencia='$departament_id' and tipo_publicacion=3 order by fecha desc";	
		}	
	}
	else
	{
  ...
  <form name="form1" method="post" action="">
    <table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" id="table17">
        ...
        <tr>
          ...
          <td colspan="2" class="tcat"><div align="center">Anuncios y publicaciones previamente ingresadas</div></td>
