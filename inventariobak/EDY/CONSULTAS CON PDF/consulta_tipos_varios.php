...
<form method='post' action='consulta_tipos_varios.php'> 
  <div align="center">
    <p class="Estilo1">Listado General de Tipos Varios </p>
	
<table width = '925' border = '0'>         
	<tr>
	<td>
	<div align="right">   <a href="pdf_tipos_varios.php" class="Estilo4"> 
...
$result = mssql_query("SELECT id_tipos, tipo FROM cat_tipos_varios"); 
$i=0;
if ($row = mssql_fetch_array($result)){
 ...
 echo "<table width = '925' border = '2'> \n"; 
   ...
   echo "<tr><td width = '180'>Codigo tipos Varios/td><td>Tipos Varios</td></tr> \n"; 
   ...
   do {
	$cod = $row[0];
     ...
     $chk[ ] = "chk$i";
     echo "<tr><td>".$row["id_tipos"]."</td><td>"  .$row["tipo"]."</td>
