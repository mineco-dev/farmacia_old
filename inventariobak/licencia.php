...
//		echo	$codigo_grupo;
		$licen = $_POST['tipo_licencia'];
		//$usr = $_POST['usuario'];
		$consulta = "EXEC proc_add_licencia @v_tipo_licencia='$licen',  @v_codigo_usuario_creo='$usr'";		
		$result=$query($consulta);	
		$close($s);		
		session_write_close();
		envia_msg('Se Ingreso exitosamente la Licencia');	
...
<p class="Estilo8 Estilo7"></p>
 <table  border="0" align="center" cellspacing="0" class="Estilo1 Estilo18">
  <tr bgcolor="#0066CC">
		<td ><div align="center"><span class="Estilo1 Estilo2">  INGRESO DE TIPO DE LICENCIA  </span></div></td>
  </tr>
</table>

<form action="licencia.php" name="form1" method="post">
...
<tr>
<td align="right">Tipo Licencia</td>
<td>
<input type="text" size="30" maxlength="50" name="tipo_licencia">
</td>
</tr>
<tr>
<td>
