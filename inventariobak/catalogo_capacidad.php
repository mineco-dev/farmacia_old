...
<!--form name="form1" method="post" action="asesoringreso.php"-->
  <table width="91%"  border="0" align="center">
    <tr>
      ...
      </span>CATALOGO DE CAPACIDAD </p></th>
    </tr>
  </table>
  ...
  <tr class="Estilo1" >
    <td class="Estilo7" align="center" ><?
				 $cuatro = 4;
				//print $cuatro;
		print "<a href=capacidad4.php?pro=".$cuatro.">MEMORIA</a>";
  ...
  <tr class="Estilo1" >
	...
	<?
				 $cuatro = 5;
				//print $cuatro;
		print "<a href=capacidad4.php?pro=".$cuatro.">DISCO DURO</a>"; ?>
	<p></p>
	</td>
  </tr>
...
<tr class="Estilo1" >
	...
	<?
				 $cuatro = 6;
				//print $cuatro;
		print "<a href=capacidad4.php?pro=".$cuatro.">PROCESADOR</a>"; ?>
