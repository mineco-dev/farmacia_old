...
<table border="0" width="100%" class="Estilo1 Estilo18">
	<tr>
		...
		<a href="visita.php"><!--img src="tareas.gif" width="16" height="16" border="0"-->[ <-- Salir ]</a>
		</td>
		<!--td align="right" >
...
$conection = mssql_connect("server_appl","sa","sa") or die("no se puede conectar a SQL Server");
 mssql_select_db("inventario",$conection);
  ...
  <tr class="Estilo1" >
   ...
   <tr class="Estilo1" >
    <td class="Estilo22" align="right">No. Factura de Compra<font color="#FF0000"><strong></strong></font></td>
    <td class="Estilo7"><input name="factura" type="text" class="Estilo7" maxlength="15"  size="15" onkeypress="return validar(event)"></td>
  </tr>
