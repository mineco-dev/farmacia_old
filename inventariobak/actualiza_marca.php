...
$codi = $_GET['codigo'];
 ...
 $result2 = mssql_query ("select  id_marca, marca from cat_marca where id_marca = $codi");
...
<table width="797" border="0" align="center" cellspacing="0">
  <tr bgcolor="#0066CC">
    <td colspan="7"><div align="center"><span class="Estilo69 Estilo1">Edita Datos Marca</span></div></td>
  </tr>
...
<blockquote>
		  ...
		  <form name="form1" method="post" action="guardar_marca.php ">
	        ...
	        <table width="622" border="0" align="center">
			  ...
			  <td width="135"  scope="col" height="28" >
				...
				<td>
						...
						<input name="id_marca"  disabled="disabled" type="text" id="id_marca" size="10" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['id_marca'];  ?>">

				</td>
			  </tr>
			  
			                  <th width="135" scope="col"><div align="right"><span class="69">Marca</span></div></th>
                <th width="467" scope="col">
                  <div align="left">
                    <input name="marca" type="text" id="marca" size="35" maxlength="50" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['marca'];  ?>">                
                  </div></th>
...
<p align="center" class="Estilo69">&nbsp;</p>
