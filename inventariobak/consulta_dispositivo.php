...
<form method='post' action='consulta_dispositivo.php'> 
    ...
    <p class="Estilo69" colspan="20"> <span class="Estilo69"></span>Listado General de Tipos de Dispositivos </p>
	
<table width = '600' border = '0'>         
	<tr>
	<td>
	<div align="right">   <a href="pdf_tipo.php" class="Estilo69"> 
...
if ($row = mssql_fetch_array($result)){
 ...
 echo "<table width = '600' border = '0'> \n"; 
  ...
  echo "<tr class='Estilo69'>
			...
			<td bgcolor='#99CCFF' align ='center'>Dispositivo</td>
 ...
 echo "<tr class='Estilo67'>
 			<td class= 'Estilofondocol2'  width = '70' align = 'center'>".$row["id_tipo_dispositivo"]."</td>
			<td  bgcolor='#99CCFF' width= '440' class= 'Estilofondocol'>"  .$row["tipo_dispositivo"]."</td>



			<td align = 'center' bgcolor='#C9CDED' class= 'Estilofondocol2'>  
			<a href=\"actualiza_dispositivo.php?codigo=$cod\">  <img src=\"imagenes/b_edit.PNG\"  width = '16' border='0'>  </a>
			</td>
