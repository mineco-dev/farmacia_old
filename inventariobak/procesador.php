...
//		echo	$codigo_grupo;
		$proces = $_POST['procesador'];
		//$usr = $_POST['usuario'];
		$consulta = "EXEC proc_add_procesador @v_procesador='$proces',  @v_codigo_usuario_creo='$usr'";		
		$result=$query($consulta);	
		$close($s);		
		session_write_close();
		envia_msg('Se Ingreso exitosamente el Procesador');
...
<p class="Estilo8 Estilo7"></p>
 <table  border="0" align="center" cellspacing="0">
  <tr bgcolor="#0066CC">
		<td ><div align="center"><span class="Estilo1 Estilo2">  INGRESO DE PROCESADOR  </span></div></td>
  </tr>
</table>

<form action="procesador.php" name="form1" method="post">
...
<tr>
<td align="right">Procesador</td>
<td>
<input type="text" size="30" maxlength="50" name="procesador">
</td>
</tr>
<tr>
<td>
