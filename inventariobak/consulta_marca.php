...
<form method='post' action='consulta_marca.php'> 	
	<div align="center"><p class="Estilo69">
    <p class="Estilo69" colspan="20"> <span class="Estilo69"></span>Listado General de Marcas </p>
	
<table width = '600' border = '0'>         
	<tr>
	<td>
	<div align="right">   <a href="pdf_marca.php" class="Estilo69"> 
...
$result = mssql_query("SELECT id_marca, marca FROM cat_marca"); 
$i=0;
if ($row = mssql_fetch_array($result)){
 ...
 echo "<tr class='Estilo69'>
			...
			<td bgcolor='#99CCFF' align ='center'>Marca</td>
   ...
   do {
	$cod = $row[0];
     ...
     $numelentos = count($id_marca);

     $chk[ ] = "chk$i";
	echo "<tr class='Estilo67'>
			<td class= 'Estilofondocol2'  width = '70' align = 'center'>".$row["id_marca"]."</td>
			<td  bgcolor='#99CCFF' width= '440' class= 'Estilofondocol'>"  .$row["marca"]."</td>


			<td align = 'center' bgcolor='#C9CDED' class= 'Estilofondocol2'> 
			<a href=\"actualiza_marca.php?codigo=$cod\">  <img src=\"imagenes/b_edit.PNG\"  width = '16' border='0'>  </a>
			</td>
