...
<form name="form1" method="post" action="inventario.php" onSubmit="return Verifica()">
<!--form name="form1" method="post" action="asesoringreso.php"-->
  <table width="91%"  border="0" align="center">
    <tr>
      ...
      </span>Ministerio de Econom�a de Guatemala<br>SubGerencia de Inform�tica</p></th>
    </tr>
  </table>
  ...
  <tr bgcolor="#0066CC">
    <td colspan="7"><div align="center"><span class="Estilo1 Estilo2"> ASIGNACION DE INVENTARIO DE EQUIPO DE COMPUTO </span></div></td>
    </tr>
	      <?
$conection = mssql_connect("server_appl","sa","sa") or die("no se puede conectar a SQL Server");
 mssql_select_db("inventario",$conection);
  ...
  <tr class="Estilo1">
	  ...
	  <td class="Estilo7"><input type="text" name="sicoin" maxlength="30"></td>
  </tr>
   <tr class="Estilo1">
	  <td class="Estilo22" align="right">Codigo Antiguo<font color="#FF0000"><strong></strong></font>
	  <td class="Estilo7"><input type="text" name="cod_antiguo" maxlength="30"></td>
  </tr>
  
  <tr class="Estilo1" >
    <td class="Estilo22" align="right">Componente del Inventario No.<font color="#FF0000"><strong></strong></font></td>
    <td class="Estilo7"><input name="id_inventario_padre" type="text" class="Estilo7" maxlength="100"  size="50" onKeyUp="javascript:this.value=this.value.toUpperCase();"></td>
  </tr>
  <tr class="Estilo1" >
		<td class="Estilo22" align="right">Descripción Adicional del Equipo <font color="#FF0000">&nbsp;</font></td>
		<td class="Estilo7"><textarea name="desc_m_inv" class="Estilo7" rows="3" cols="60" onKeyUp="javascript:this.value=this.value.toUpperCase();"></textarea>
		</td>
  	</tr>					
   <tr class="Estilo1" >
    <td class="Estilo22" align="right">No. Serie </td><td><input name="serie_factura" type="text" class="Estilo7" maxlength="5"  size="5">
	 No. Factura de Compra<font color="#FF0000"><strong></strong></font>
    <input name="factura" type="text" class="Estilo7" maxlength="15"  size="15" onkeypress="return validar(event)"></td>
  </tr>
   <tr class="Estilo1" >
    <td class="Estilo22" align="right">Acta si no Existe Factura<font color="#FF0000"><strong></strong></font></td>
    <td class="Estilo7"><input name="acta" type="text" class="Estilo7" maxlength="15"  size="15" ></td>
  </tr>
   <tr class="Estilo1" >
  ...
  <tr class="Estilo1" >
	...
	<td class="Estilo7"><input type="text" name="fecha_factura" id="sel9" size="10" maxlength="10"
...
onclick="return showCalendar('sel9', '%d-%m-%Y', '24', true);"></td>
 ...
 <tr class="Estilo1" >
    ...
    <td class="Estilo7"><input name="valor" type="text" class="Estilo7" maxlength="12"  size="12" onkeypress="return validar(event)"></td>
  </tr>  
  <tr class="Estilo1" >
    <td class="Estilo22" align="right">Fecha de Finalización de Garant�a<font color="#FF0000"><strong></strong></font></td>
		<td class="Estilo7"><input type="text" name="fecha_garantia" id="sel8" size="10" maxlength="10"
><input type="reset" value=" ... " 
onclick="return showCalendar('sel8', '%d-%m-%Y', '24', true);"></td>
  ...
  <tr class="Estilo1">
	  ...
	  <!--select name="insti_reg_it"-->
	  <? $query = "select id_institucion_reg_it, institucion_reg_it from cat_institucion_reg_it order by 2";
	     $result = mssql_query($query);
		 while($row = mssql_fetch_array($result))
		  { 
		    if ($row[0] == $_SESSION['id_unidad'] ) 
			 { ?>
		 	  <input type="hidden" name="insti_reg_it" value="<? echo $row[0]; ?>"><? echo $row[1]; ?>
	 		   <!--option selected value="<? // echo $row[0]; ?>"><? //echo $row[1]; ?>
			 <? 
/*			 } 
			else 
			 {*/?>
	  ...
	  - <input type="text" name="reg_it"  size="6" maxlength="6" onkeypress="return validar(event)"></td>
  </tr>
  <?
	$conection = mssql_connect("server_appl","sa","sa") or die("no se puede conectar a SQL Server");
...
//			$sql= "select id_paq, paquete from cat_paquete order by 2";
	...
	<tr class="Estilo1" >
		...
		<td class="Estilo7"> <input name="lic_so_or" type="text" class="Estilo7" maxlength="100"  size="50" onKeyUp="javascript:this.value=this.value.toUpperCase();">
		</td>
  	</tr>		
	<tr class="Estilo1" >
		<td class="Estilo22" align="right">Licencia S.O. Instalada<font color="#FF0000"><strong></strong></font></td>
		<td class="Estilo7"> <input name="lic_so_ins" type="text" class="Estilo7" maxlength="100"  size="50" onKeyUp="javascript:this.value=this.value.toUpperCase();">
		</td>
  	</tr>		
  	</tr>		
	<tr class="Estilo1" >
		<td class="Estilo22" align="right">Licencia Paquete Intalado<font color="#FF0000"><strong></strong></font></td>
		<td class="Estilo7"> <input name="lic_paq_ins" type="text" class="Estilo7" maxlength="100"  size="50" onKeyUp="javascript:this.value=this.value.toUpperCase();">
		</td>
  	</tr>		
   <tr class="Estilo1" >
   ...
   <tr class="Estilo1" >
			...
			while ($row = mssql_fetch_array($result))
			  {
			  	if ($row[0] == 1)
				 {
				?> <option value="<? echo $row['id_marca']; ?>" selected><? echo $row['marca']; ?></option>
			  <? } 
			     else { ?>					
				 <option value="<? echo $row['id_marca']; ?>"><? echo $row['marca']; ?></option>
				 <? } ?>
			<? } ?>
			</select> 
		</td>
	...
	<tr class="Estilo1" >
		...
		<td class="Estilo7"><input name="serie_memoria" type="text" class="Estilo7" maxlength="100"  size="50" onKeyUp="javascript:this.value=this.value.toUpperCase();">
		</td>
  	</tr>					
	...
	<tr class="Estilo1" >
		...
		<td class="Estilo7"><input name="serie_disco" type="text" class="Estilo7" maxlength="100"  size="50" onKeyUp="javascript:this.value=this.value.toUpperCase();">
		</td>
  	</tr>					
	<tr class="Estilo1" >
		<td class="Estilo22" align="right">Descripción Adicionales del Detalle si es CPU <font color="#FF0000">&nbsp;</font></td>
