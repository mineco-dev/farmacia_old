...
$codi = $_GET['codigo'];
 ...
 $result2 = mssql_query ("select  id_capacidad, capacidad from cat_capacidad where id_capacidad = $codi");
...
<table width="797" border="0" align="center" cellspacing="0">
  <tr bgcolor="#0066CC">
    <td colspan="7"><div align="center"><span class="Estilo69 Estilo1">Edita Datos Capacidad </span></div></td>
  </tr>
</table>
<blockquote>
				  
		  <form name="form1" method="post" action="guardar_actualiza_capacidad.php ">
	        ...
	        <table width="622" border="0" align="center" >
			  ...
			  <td width="135"  scope="col" height="28" >
				...
				<td>
						...
						<input name="id_capacidad"  disabled="disabled" type="text" id="id_capacidad" size="10" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['id_capacidad'];  ?>">

				</td>
			  </tr>
			  
			                  <th width="135" scope="col"><div align="right"><span class="69">Capacidad</span><font color="#FF0000" size="1"></font> </div></th>
                <th width="467" scope="col">
                  <div align="left">
                    <input name="capacidad" type="text" id="capacidad" size="35" maxlength="50" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['capacidad'];  ?>">                
                  </div></th>
...
<p align="center" class="Estilo1 Estilo6">&nbsp;</p>K
