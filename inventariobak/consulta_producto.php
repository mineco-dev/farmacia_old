...
<form method='post' action='consulta_producto.php'> 
    ...
    <p class="Estilo69" colspan="20"> <span class="Estilo69"></span>Listado General de Productos </p>
	
<table width = '600' border = '0'>         
	<tr>
	<td>
	<div align="right">   <a href="pdf_producto6.php" class="Estilo69"> 
...
echo "<tr class='Estilo69'>
		...
		<td bgcolor='#99CCFF' align ='center'>Producto</td>
...
echo "<tr class='Estilo67'>
		<td class= 'Estilofondocol2'  width = '70' align = 'center'>".$row["id_producto"]."</td>
		<td  bgcolor='#99CCFF' width= '440' class= 'Estilofondocol'>"  .$row["descripcion"]."</td>


		<td align = 'center' bgcolor='#C9CDED' class= 'Estilofondocol2'>  
			<a href=\"actualiza_producto.php?codigo=$cod\">  <img src=\"imagenes/b_edit.PNG\"  width = '16' border='0'>  </a>
			</td>
