...
//		echo	$codigo_grupo;
		$pro = $_POST['descripcion'];
		//$usr = $_POST['usuario'];
		$consulta = "EXEC proc_add_producto @v_descripcion='$pro',  @v_codigo_usuario_creo='$usr'";		
		$result=$query($consulta);	
		$close($s);		
		session_write_close();
		envia_msg('Se Ingreso exitosamente el Producto');
...
<p class="Estilo8 Estilo7"></p>
 <table  border="0" align="center" cellspacing="0">
  <tr bgcolor="#0066CC">
		<td><div align="center"><span class="Estilo1 Estilo2">  INGRESO DE PRODUCTO  </span></div></td>
  </tr>
</table>


<form action="producto.php" name="form1" method="post">
...
<td>
<input type="text" size="30" maxlength="50" name="descripcion">
</td>
</tr>
<tr>
<td>
