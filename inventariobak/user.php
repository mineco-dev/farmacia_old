...
//{
	  ...
	  $query = 'select a.id_institucion_reg_it from RRHH.dbo.direccion a, RRHH.dbo.asesor b
				where b.idasesor = '.$registro['idasesor'].' and a.iddireccion = b.iddireccion';
	  $res = mssql_query($query);
	  while ($di = mssql_fetch_array($res))
	   {
	    $_SESSION['id_unidad'] = $di[0];
