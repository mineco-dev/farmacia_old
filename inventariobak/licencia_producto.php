...
//		echo	$codigo_grupo;
		$licen_pro = $_POST['licencia_producto'];
		$licen_tipo_pro = $_POST['id_tipo_licencia_prod'];
		//$usr = $_POST['usuario'];
		$consulta = "EXEC proc_add_licencia_producto @v_licencia_producto='$licen_pro',  @v_codigo_usuario_creo='$usr', 
		@v_id_tipo_licencia_prod = $licen_tipo_pro";		
		$result=$query($consulta);	
		$close($s);		
		session_write_close();
		envia_msg('Se Ingreso exitosamente la Licencia del Producto');
...
<p class="Estilo8 Estilo7"></p>
 <table  border="0" align="center" cellspacing="0" class="Estilo1 Estilo18">
  <tr bgcolor="#0066CC">
		<td><div align="center"><span class="Estilo1 Estilo2">  INGRESO DE LICENCIA  </span></div></td>
  </tr>
</table>

<form action="licencia_producto.php" name="form1" method="post">
...
<tr>
<td align="right">Licencia Producto</td>
<td><input type="text"  size="30" maxlength="50" name="licencia_producto">
</td>
</tr>


<tr>
<td align="right">Tipo Licencia Producto</td>
<td><select name="id_tipo_licencia_prod" id="id_tipo_licencia_prod" class="Estilo7">
