...
$codi = $_GET['codigo'];
 ...
 $result2 = mssql_query ("select  id_licencia_producto, licencia_producto from cat_licencia_producto where id_licencia_producto = $codi");
...
<table width="797" border="0" align="center" cellspacing="0">
  <tr bgcolor="#0066CC">
    <td colspan="7"><div align="center"><span class="Estilo69 Estilo1">Edita Datos Licencia Producto</span></div></td>
  </tr>
...
<blockquote>
		  ...
		  <form name="form1" method="post" action="guardar_licencia_producto.php ">
	        ...
	        <table width="622" border="0" align="center">
			  ...
			  <td width="135"  scope="col" height="28" >
				...
				<td>
						...
						<input name="id_licencia_producto"  disabled="disabled" type="text" id="id_licencia_producto" size="10" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['id_licencia_producto'];  ?>">

				</td>
			  </tr>
			  
			                  <th width="135" scope="col"><div align="right"><span class="69">Licencia Producto</span> </div></th>
                <th width="467" scope="col">
                  <div align="left">
                    <input name="licencia_producto" type="text" id="licencia_producto" size="35" maxlength="50" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['licencia_producto'];  ?>">                
                  </div></th>
