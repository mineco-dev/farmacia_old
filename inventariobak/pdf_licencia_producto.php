...
$pdf->Ln(4);
$pdf->Cell(0,1,'LICENCIA PRODUCTO',0,1,'C');
$pdf->SetFont('Arial','',8);
...
$pdf->SetFont('Arial','B',8);
$pdf->Cell(0,4,'LICENCIA PRODUCTO',1,1,'L',0);
...
$SQL = "SELECT id_licencia_producto, licencia_producto FROM cat_licencia_producto";
//			print $SQL;
