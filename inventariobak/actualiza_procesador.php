...
$codi = $_GET['codigo'];
 ...
 $result2 = mssql_query ("select  id_procesador, procesador from cat_procesador where id_procesador = $codi");
...
<table width="797" border="0" align="center" cellspacing="0">
  <tr bgcolor="#0066CC">
    <td colspan="7"><div align="center"><span class="Estilo69 Estilo1">Edita Datos Procesador</span></div></td>
  </tr>
...
<blockquote>
		  ...
		  <form name="form1" method="post" action="guardar_procesador.php ">
	        ...
	        <table width="622" border="0" align="center">
			  ...
			  <td width="135"  scope="col" height="28" >
				...
				<td>
						...
						<input name="id_procesador"  disabled="disabled" type="text" id="id_procesador" size="10" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['id_procesador'];  ?>">

				</td>
			  </tr>
			  
			                  <th width="135" scope="col"><div align="right"><span class="69">Procesador</span></div></th>
                <th width="467" scope="col">
                  <div align="left">
                    <input name="procesador" type="text" id="procesador" size="35" maxlength="50" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['procesador'];  ?>">                
                  </div></th>
