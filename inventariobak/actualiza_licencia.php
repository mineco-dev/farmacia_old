...
$codi = $_GET['codigo'];
 ...
 $result2 = mssql_query ("select  id_tipo_licencia, tipo_licencia from cat_tipo_licencia where id_tipo_licencia = $codi");
...
<table width="797" border="0" align="center" cellspacing="0">
  <tr bgcolor="#0066CC">
    <td colspan="7"><div align="center"><span class="Estilo69 Estilo1 ">Edita Datos Tipo Licencia</span></div></td>
  </tr>
...
<blockquote>
		  ...
		  <form name="form1" method="post" action="guardar_actualiza_licencia.php ">
	        ...
	        <table width="622" border="0" align="center">
			  ...
			  <td width="135"  scope="col" height="28" >
				...
				<td>
						...
						<input name="id_tipo_licencia"  disabled="disabled" type="text" id="id_tipo_licencia" size="10" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['id_tipo_licencia'];  ?>">

				</td>
			  </tr>
			  
			                  <th width="135" scope="col"><div align="right"><span class="69">Tipo Licencia</span></div></th>
                <th width="467" scope="col">
                  <div align="left">
                    <input name="tipo_licencia" type="text" id="tipo_licencia" size="35"   maxlength="50" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['tipo_licencia'];  ?>">                
                  </div></th>
