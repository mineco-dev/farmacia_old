...
<!--form name="form1" method="post" action="asesoringreso.php"-->
  <table width="91%"  border="0" align="center">
    <tr>
      ...
      </span>CONSULTA  DE CAPACIDAD </p></th>
    </tr>
  </table>
  ...
  <tr class="Estilo69" >
    <td class="Estilo69" align="center" ><?
				 $cuatro = 4;
				//print $cuatro;
		print "<a href=consulta_capacidad.php?pro=".$cuatro.">MEMORIA</a>";
  ...
  <tr class="Estilo69" >
	...
	<?
				 $cuatro = 5;
				//print $cuatro;
		print "<a href=consulta_capacidad.php?pro=".$cuatro.">DISCO DURO</a>"; ?>
	<p></p>
	</td>
  </tr>
...
<tr class="Estilo69" >
	...
	<?
				 $cuatro = 6;
				//print $cuatro;
		print "<a href=consulta_capacidad.php?pro=".$cuatro.">PROCESADOR</a>"; ?>
