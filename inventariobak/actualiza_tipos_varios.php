...
$codi = $_GET['codigo'];
 ...
 $result2 = mssql_query ("select  id_tipos, tipo from cat_tipos_varios where id_tipos = $codi");
...
<table width="797" border="0" align="center" cellspacing="0">
  <tr bgcolor="#0066CC">
    <td colspan="7"><div align="center"><span class="Estilo69 Estilo1">Edita Datos Tipos Varios</span></div></td>
  </tr>
...
<blockquote>
		  ...
		  <form name="form1" method="post" action="guardar_tipos_varios.php ">
	        ...
	        <table width="622" border="0" align="center">
			  ...
			  <td width="135"  scope="col" height="28" >
				...
				<td>
						...
						<input name="id_tipos"  disabled="disabled" type="text" id="id_tipos" size="10" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['id_tipos'];  ?>">

				</td>
			  </tr>
			  
			                  <th width="135" scope="col"><div align="right"><span class="69">Tipo</span><font color="#FF0000" size="1"></font> </div></th>
                <th width="467" scope="col">
                  <div align="left">
                    <input name="tipo" type="text" id="tipo" size="35"  maxlength="50" onKeyUp="javascript:this.value=this.value.toUpperCase();" value="<? print $row['tipo'];  ?>">                
                  </div></th>
