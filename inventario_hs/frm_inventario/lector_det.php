...
{	
	$qry_marcalector = mssql_query("select * from cat_marca where activo=1 and codigo_objeto=13 order by marca");																									
	if ($qry_marcalector)
		{
...
<table width="90%" border=1 cellspacing="0" id="tabla3">
  <tr>
    ...
    <th width="213" scope="col"><span class="Estilo2">Tipo de lector </span></th>
  </tr>
</table>
<br>
