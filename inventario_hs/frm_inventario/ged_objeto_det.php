  ...
  <tr>
	...
	{	
		if (isset($txt_obj)) //verifico si hay objeto seleccionado
		{
				...
				{													
					...
					{	
						...
						{								
							...
							{ 
								$mensaje= "La extensión o el tama�o de los archivos no es correcta. <br><br><table><tr><td><li>Se permiten archivos .gif - .jpg - .pdf<br><li>se permiten archivos de (25 MB) m�ximo.</td></tr></table>"; 
							}
							else
							{ 
			...
			{
				echo '<tr><td class="error" colspan="3" align="center">Ya se ha ingresado un objeto de este tipo con este n�mero de '.$mensaje_error.' <br><br>Para ingresar otro <a href="buscar/buscar.php">[HAGA CLIC AQUI]</a></td></tr>';
			}			
