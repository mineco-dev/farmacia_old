...
function agregar4() {
	...
	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"bien["+contLin4+"][5]\" type=\"text\" id=\"textfield\" size=\"10\" disabled>";
	

	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"bien["+contLin4+"][6]\" type=\"text\" id=\"textfield\" size=\"10\" disabled>";
	
	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"bien["+contLin4+"][8]\" type=\"text\" id=\"textfield\" size=\"7\" disabled>";
	
   td = tr.insertCell();
	td.innerHTML = 	"<input name=\"bien["+contLin4+"][9]\" type=\"hidden\" id=\"hiddenField["+contLin4+"]\" size=\"7\">";
