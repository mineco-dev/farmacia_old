...
function agregar4() {
	...
	td = tr.insertCell(); 
	td.innerHTML = 	"<select name=\"cbo_categoria["+contLin4+"]\" id=\"cbo_categoria\" onChange=\"javascript:cargarCombo(\'cbo_subcategoria2.php?
	\',\'cbo_categoria\',\'Div_subcategoria\');\">';
	echo $op2;
	echo '</select>";
	
	
    td = tr.insertCell();
	td.innerHTML = 	"<div name=\"subcategoria["+contLin4+"]\" id=\"Div_subcategoria\"><select name=\"cbo_subcategoria\" id=\"select3\">';
	echo '</select>'; 
	echo '</div>";
