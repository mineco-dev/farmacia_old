...
e.fecha_ingreso,  e.observaciones, dep.nombre, d.codigo_renglon, ac.actividad, e.codigo_programa, pro.programa, e.codigo_actividad, d.costo_unidad, d.precio_total, e.userfile, d.codigo_bodega, d.codigo_empresa, e.no_ingreso,
...
on e.codigo_programa = pro.codigo_programa
inner join cat_actividad ac
on ac.codigo_actividad = e.codigo_actividad and pro.codigo_programa = ac.codigo_programa
...
<tr>
              <td colspan="2">   <input name="bt_eliminar" onClick="validar(this.form)" type="button" id="bt_eliminar" value="Eliminar Ingreso">
              </td>
              </tr>       
</table>
</form>
