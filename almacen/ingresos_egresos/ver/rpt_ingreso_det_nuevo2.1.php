...
where codigo_ingreso_enc ='$hoja_ingreso'";
  ...
  <tr>
    ...
    <table width="807px" border="0">
      ...
      <tr>
        <td height="30">&nbsp;</td>
        <td width="100"><span class="red"><?PHP echo $dependencia; ?></span></td>
        <td width="100"><span class="enc">FACTURA </span></td>
        <td width="100"><span class="blue"><?PHP echo $noserie; ?>&nbsp;-&nbsp;<?PHP echo $nofactura; ?></span></td>
      </tr>
      <tr>
        <td height="30">&nbsp;</td>
        <td width="100"><span class="red"><?PHP echo $programa; ?></span></td>
		<td width="150" ><span class="enc">FECHA INGRESO: <?PHP echo substr($fecha_recepcion,0,12); ?></span></td>
        <td width="100"><span class="enc">FACTURA: <?PHP echo substr($fecha_factura,0,12); ?></span></td>
      </tr>
      <tr>
        <td width="100" height="30"></span></td>
        <td><span class="red"><?PHP echo $proveedor; ?></td>
        <td>&nbsp;</td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td height="750px" valign="top"><table width="807px" border="0" cellspacing="1" cellpadding="1">
      ...
      <tr> 
        ...
        <td width="282"><span class="style2"></span></td>
        <td width="120">&nbsp;</td>
...
where codigo_ingreso_enc = $codigo_ingreso_enc";
   ...
   <tr> 
        ...
        <td width="47">&nbsp;</td>
        <td width="282" align="justify">&nbsp;<span class="obs"><?PHP echo $observaciones; ?></span></td>
        <td width="120">&nbsp;</td>
        <td width="79"><div align="left"></div></td>
        <td width="76"><div align="left"></div></td>
        <td width="132">&nbsp;</td>
