...
span.enc {font-size:10px; font-weight:bold; }
...
where codigo_ingreso_enc ='$hoja_ingreso'";
  ...
  <tr>
    ...
    <table width="807px" border="0">
      ...
      <tr>
        <td height="30">&nbsp;</td>
        <td width="277"><span class="red"><?PHP echo $dependencia; ?></span></td>
        <td width="96"></td>
        <td width="109" height="30" valign="middle"><span class="enc">FACTURA </span></td>
        <td width="210" height="30" valign="middle"><span class="blue">&nbsp;&nbsp;&nbsp;<?PHP echo $noserie; ?>&nbsp;-&nbsp;<?PHP echo $nofactura; ?></span></td>
      </tr>
      <tr>
        <td height="22">&nbsp;</td>
        <td width="277"><span class="red"><?PHP echo $programa; ?></span></td>
		<td colspan="2" valign="middle" ><span class="enc">FECHA INGRESO: <?PHP echo substr($fecha_recepcion,0,12); ?></span></td>
		<td width="210" valign="middle"><span class="enc">FACTURA: <?PHP echo substr($fecha_factura,0,12); ?></span></td>
      </tr>
      <tr>
        <td width="93" height="22">&nbsp;</td>
        <td height="22" valign="top"><span class="red"><?PHP echo $proveedor; ?></span></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
    </table></td>
  ...
  <tr>
    <td height="750px" valign="top"><table width="807px" border="0" cellspacing="1" cellpadding="1">
      ...
      <tr> 
        ...
        <td width="265"><span class="style2"></span></td>
        <td width="52">&nbsp;</td>
...
where d.codigo_ingreso_enc = $codigo_ingreso_enc";
   ...
   echo '<td align="left" width="220">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="blue">'.$row_ingreso_det["codigo_categoria"].'-'.$row_ingreso_det["codigo_subcategoria"].'-'.$row_ingreso_det["codigo_producto"].'-'.$row_ingreso_det["descripcion"].'</span></td>';
   
			echo '<td align ="left"><span class="det">'.$row_ingreso_det["codigo_renglon"].'</span></td>';
			echo '<td>&nbsp;<span class="det">'.$row_ingreso_det[""].'</span></td>';
			echo '<td align ="left"><span class="det">Q '.number_format($row_ingreso_det["costo_unidad"],2).'</span></td>';
			echo '<td align ="left"><span class="det">Q '.number_format($row_ingreso_det["Precio_total"],2).'</span></td>';		
			echo '<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="det">'.$row_ingreso_det[""].'</span></td>';		
     ...
     ?>
   <?PHP
   $qry_total = "select sum(Precio_total) as total from tb_ingreso_det where codigo_ingreso_enc = $codigo_ingreso_enc";
   ...
   ?>
      <tr>         
        <td width="66" align="right">&nbsp;</td>
        <td width="220"><span class="style2"></span></td>
        <td width="52">&nbsp;</td>
        <td width="73"><div align="left"></div></td>
        <td width="77"><div align="left"></div></td>
        <td width="138">&nbsp;</td>
    ...
    <tr> 
        ...
        <td width="52">&nbsp;</td>
        <td width="73"><div align="left"></div></td>
        <td width="77" align="left"><span class="det">Total</span></td>
        <td width="138" align="left"><span class="det">&nbsp;&nbsp;Q <?PHP echo $total; ?></span></td>
        <td width="114">&nbsp;</td>
      </tr>
   ...
   <tr> 
        ...
        <td width="66">&nbsp;</td>
        <td width="220" align="left"><span class="obs"><?PHP echo $observaciones; ?></span></td>
        <td width="52">&nbsp;</td>
        <td width="73"><div align="left"></div></td>
        <td width="77"><div align="left"></div></td>
        <td width="138">&nbsp;</td>
