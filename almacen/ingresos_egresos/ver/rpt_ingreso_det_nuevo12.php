...
where codigo_ingreso_enc ='$hoja_ingreso'";
  ...
  <tr>
    ...
    <table width="807px" border="0">
      ...
      <tr>
        <td height="30">&nbsp;</td>
        <td width="288"><span class="red"><?PHP echo $dependencia; ?></span></td>
        <td width="134"></td>
        <td width="130"><span class="enc"> FACTURA </span></td>
        <td width="143"><span class="blue"><?PHP echo $noserie; ?>&nbsp;-&nbsp;<?PHP echo $nofactura; ?></span></td>
      </tr>
      <tr>
        <td height="30">&nbsp;</td>
        <td width="288"><span class="red"><?PHP echo $programa; ?></span></td>
		<td colspan="2" ><span class="enc">FECHA INGRESO: <?PHP echo substr($fecha_recepcion,0,12); ?></span></td>
		<td width="143"><span class="enc">FACTURA: <?PHP echo substr($fecha_factura,0,12); ?></span></td>
      </tr>
      <tr>
