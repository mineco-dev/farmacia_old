...
<!-- <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/dt/jszip-3.1.3/pdfmake-0.1.27/dt-1.10.15/b-1.3.1/b-colvis-1.3.1/b-flash-1.3.1/b-html5-1.3.1/b-print-1.3.1/r-2.1.1/datatables.min.css"/>
 
<script type="text/javascript" src="https://cdn.datatables.net/v/dt/jszip-3.1.3/pdfmake-0.1.27/dt-1.10.15/b-1.3.1/b-colvis-1.3.1/b-flash-1.3.1/b-html5-1.3.1/b-print-1.3.1/r-2.1.1/datatables.min.js"></script> -->
...
";
 ...
 $consulta=mssql_query("select producto, mit.unidad_medida from dbo.cat_producto as pro inner join cat_medida as mit on mit.codigo_medida=pro.codigo_medida   where pro.activo = 1");
		...
		echo "<center style='font-size:1.5em'>  REPORTE DE ARTICULOS</center>";
                ...
                customize: function ( win ) {
                    $(win.document.body)
                        ...
                        .prepend(
                            ...
                            '</tr></table>',
                            '<center >  CATALOGO GENERAL DE ARTICULOS</center>'
                        );
