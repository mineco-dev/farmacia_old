    ...
    <table width="100%" border="0" bordercolor="#ECE9D8">
      ...
      <tr>
        <td>        <div align="left" class="Estilo1">
          <div align="left">
            <p><strong><strong>            [<a href="producto_micro.php?in=A" alt="Muestra los registros que inician con A">A</a>] [<a href="producto_micro.php?in=B">B</a>] [<a href="producto_micro.php?in=C">C</a>] [<a href="producto_micro.php?in=D">D</a>] [<a href="producto_micro.php?in=E">E</a>] [<a href="producto_micro.php?in=F">F</a>] [<a href="producto_micro.php?in=G">G</a>] [<a href="producto_micro.php?in=H">H</a>] [<a href="producto_micro.php?in=I">I</a>] [<a href="producto_micro.php?in=J">J</a>] [<a href="producto_micro.php?in=K">K</a>] [<a href="producto_micro.php?in=L">L</a>] [<a href="producto_micro.php?in=M">M</a>] [<a href="producto_micro.php?in=N">N</a>] [<a href="producto_micro.php?in=O">O</a>] [<a href="producto_micro.php?in=P">P</a>] [<a href="producto_micro.php?in=Q">Q</a>] [<a href="producto_micro.php?in=R">R</a>] [<a href="producto_micro.php?in=S">S</a>] [<a href="producto_micro.php?in=T">T</a>] [<a href="producto_micro.php?in=U">U</a>] [<a href="producto_micro.php?in=V">V</a>] [<a href="producto_micro.php?in=W">W</a>] [<a href="producto_micro.php?in=X">X</a>] [<a href="producto_micro.php?in=Y">Y</a>] [<a href="producto_micro.php?in=Z">Z</a>] <a href="producto_micro.php?in=all">[TODO]</a>
                </strong></strong></p>
            <p><strong><strong>
...
INNER JOIN cat_empresa e ON e.codigo_empresa = i.codigo_empresa
							where (p.producto like '%$busqueda%' or p.uso like '%$busqueda%') and p.activo=1 and i.codigo_empresa=2 and i.codigo_bodega = 9 order by bodega";																		
				}
				else	
...
INNER JOIN cat_bodega b ON b.codigo_bodega = i.codigo_bodega
INNER JOIN cat_empresa e ON e.codigo_empresa = i.codigo_empresa
							        where p.producto like '$inicial%' and i.codigo_empresa=2 and i.codigo_bodega = 9";
						else
							$consulta = "SELECT     (p.producto +' - '+ p.marca +' EN '+ m.unidad_medida) as producto, i.rowid, p.codigo_subcategoria,
p.codigo_categoria,  p.activo, i.existencia, p.codigo_producto, p.uso, b.bodega, e.empresa, i.codigo_bodega, i.ultimo_ingreso, i.rowid  
FROM     cat_producto p
...
INNER JOIN cat_bodega b ON b.codigo_bodega = i.codigo_bodega
INNER JOIN cat_empresa e ON e.codigo_empresa = i.codigo_empresa
							where p.producto like 'A%' and i.codigo_empresa=2 and i.codigo_bodega = 9";
				}
				conectardb($almacen);
				...
				while($row=$fetch_array($result))
				{
					...
					if ($i % 2 == 0) 
					{
						...
						window.opener.document.getElementById('$tipo"."[".$posi."][8]').value = '".$row["existencia"]."';
						window.close();
						window.opener.focus(); 
						return false;\"><center><img src=\"../images/iconos/ico_ir.gif\" border=\"0\" alt=\"Seleccionar este producto\"></a></center></td>";					
						echo '<td>'.$row["codigo_producto"].'</td><td>'.$row["producto"].'</td><td>'.$row["existencia"].'</td><td>'.$row["bodega"].'</td><td>'.$row["ultimo_ingreso"].'</td></tr>';																				
					$i++;
				}
				$free_result($result);
			 ?>
