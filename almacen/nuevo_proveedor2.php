...
{	
	...
	{	
		...
		$proveedor=strtoupper($_REQUEST["txt_nombre"]);	
      ...
      <tr align="center" bgcolor="#006699" class="thead">
		...
		<?PHP
				...
				while($row=$fetch_array($result))
				{
					...
					{										
					echo '<tr class='.$clase.'>';								
					echo '<td>'.$row["nit"].'</td><td>'.$row["nombre"].'</td><td>'.$row["direccion"].'</td><td>'.$row["telefonos"].'</td><td><center><a href="editar_proveedor.php?id='.$row["rowid"].'"><img src="../images/iconos/ico_editar.png" width ="27"  height= "29" alt="Modificar información"></a></center></td></tr>';					
					}
					else
					echo '<tr class='.$clase.'><td>'.$row["nit"].'</td><td>'.$row["nombre"].'</td><td>'.$row["direccion"].'</td><td>'.$row["telefonos"].'</td><td><center><a href="editar_proveedor.php?id='.$row["rowid"].'"><img src="../images/iconos/ico_editar.png" width ="27"  height= "29" alt="Modificar información"></a></center></td></tr>';										
					$i++;
				}
				$free_result($result);
			 ?>
