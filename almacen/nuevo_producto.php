        ...
        <tr>
         ...
         <tr>
          ...
          <td colspan="2">&nbsp;</td>
             ...
             <td valign="top">&nbsp;</td>
                <td>Producto</td>
                <td colspan="2"><input name="txt_producto" type="text" id="txt_subcategoria2" value="" size="75"></td>
              </tr>
          ...
          <td colspan="2">&nbsp;</td>
              ...
              <tr>
               <td valign="top">&nbsp;</td>
                <td>Marca</td>
                <td colspan="2"><input name="txt_marca" type="text" id="txt_marca" size="40">
          ...
          <td colspan="2">&nbsp;</td>
              ...
              <tr>
               <td valign="top">&nbsp;</td>
                <td>Uso</td>
                <td colspan="2"><input name="txt_uso" type="text" id="txt_uso" size="70">
                 <div align="left"></div></td>
              </tr>
      <tr>
     <tr>
...
<p align="center">
  <input name="bt_guardar" type="button"onClick="validar(this.form)" id="bt_guardar" value="Guardar hoja de ingreso" >
</p>
  ...
  <div class="TabbedPanelsContentGroup">
    <div class="TabbedPanelsContent">
      ...
      <tr>
        <td>        <div align="left" class="Estilo1">
          <div align="left"><strong><strong>            [<a href="nuevo_producto.php?in=A" alt="Muestra los registros que inician con A">A</a>] [<a href="nuevo_producto.php?in=B">B</a>] [<a href="nuevo_producto.php?in=C">C</a>] [<a href="nuevo_producto.php?in=D">D</a>] [<a href="nuevo_producto.php?in=E">E</a>] [<a href="nuevo_producto.php?in=F">F</a>] [<a href="nuevo_producto.php?in=G">G</a>] [<a href="nuevo_producto.php?in=H">H</a>] [<a href="nuevo_producto.php?in=I">I</a>] [<a href="nuevo_producto.php?in=J">J</a>] [<a href="nuevo_producto.php?in=K">K</a>] [<a href="nuevo_producto.php?in=L">L</a>] [<a href="nuevo_producto.php?in=M">M</a>] [<a href="nuevo_producto.php?in=N">N</a>] [<a href="nuevo_producto.php?in=O">O</a>] [<a href="nuevo_producto.php?in=P">P</a>] [<a href="nuevo_producto.php?in=Q">Q</a>] [<a href="nuevo_producto.php?in=R">R</a>] [<a href="nuevo_producto.php?in=S">S</a>] [<a href="nuevo_producto.php?in=T">T</a>] [<a href="nuevo_producto.php?in=U">U</a>] [<a href="nuevo_producto.php?in=V">V</a>] [<a href="nuevo_producto.php?in=W">W</a>] [<a href="nuevo_producto.php?in=X">X</a>] [<a href="nuevo_producto.php?in=Y">Y</a>] [<a href="nuevo_producto.php?in=Z">Z</a>] <a href="nuevo_producto.php?in=all">[TODO]</a>                  <input name="txt_buscar" type="text" id="txt_buscar2" size="20">
    ...
    <table class="tborder" cellpadding="0" cellspacing="1" border="0" width="100%" id="table17">
      <tr align="center" bgcolor="#aeccf2" class="thead">
        <td width="37%" height="17" class="titulotabla"><strong><strong>Descripci&oacute;n</strong></strong></td>
        <td width="23%" class="titulotabla"><strong>Marca</strong></td>
        <td width="24%" class="titulotabla"><strong>Presentaci&oacute;n</strong></td>
		...
		<?PHP
				...
				while($row=$fetch_array($result))
				{
					...
					{										
					echo '<tr class='.$clase.'>';								
					echo '<td>'.$row["producto"].'</td><td>'.$row["marca"].'</td><td>'.$row["unidad_medida"].'</td><td><center><a href="editar_producto.php?id='.$row["rowid"].'"><img src="../images/iconos/ico_editar.jpg" alt="Modificar información"></a></center></td></tr>';					
					}
					else
						echo '<tr class='.$clase.'><td>'.$row["producto"].'</td><td>'.$row["marca"].'</td><td>'.$row["unidad_medida"].'</td><td><center><a href="editar_producto.php?id='.$row["rowid"].'"><img src="../images/iconos/ico_editar.jpg" alt="Modificar información"></a></center></td></tr>';										
					$i++;
				}
				$free_result($result);
			 ?>
