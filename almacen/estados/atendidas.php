...
and  e.codigo_requisicion_enc='$cris' --and e.codigo_jefe_dependencia <> 0
...
codigo_estatus in ($mtstatus)
and
e.fecha_requisicion between '2013-01-01' and getdate() --and e.codigo_jefe_dependencia <> 0
order by fecha_requisicion desc";
...
if ($mtstatus=="3") {
 ...
 getTabla2($query,8,$vec,$vec2,$vec3,$dbms,95,"","","ver/detalle_solicitud.php?id=");
 }

if ($mtstatus=="4") {

 getTabla2($query,8,$vec,$vec2,$vec3,$dbms,95,"","","ver/detalle_aprobacion.php?id=");
 }
 
if ($mtstatus==="5") {

getTabla2($query,8,$vec,$vec2,$vec3,$dbms,95,"","","ver/detalle_autorizado.php?id=");

 }

if ($mtstatus==="6") {

getTabla2($query,8,$vec,$vec2,$vec3,$dbms,95,"","","ver/detalle_despachadod.php?id=");
