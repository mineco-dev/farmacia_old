        ...
        <td width="8%" rowspan="3">
          <div align="center, ">
            <span class="titulomenu">
              <img src="../../../images/lOGO.png" width="106" height="95"> 
            </span></div></td>
...
where e.codigo_estatus = 4 and e.codigo_requisicion_enc = '$hoja_despacho'";
        ...
        $hora=$row_ingreso_enc["hora_requisicion"];
			...
			{								
		?>
    <span class="Estilo4"> Ministerio de Economia
    <br>
    SOLICITUD DE ALMACEN </span><br>
    <br>
            </p>
            </div>
          </div></td>
      ...
      <tr>
        ...
        <td width="39%"><table width="51%"  border="1" align="right" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><span class="titulomenu">N�mero: <?php echo $numero_requisicion; ?></span></td>
          </tr>
          <tr>
            <td height="20"><span class="titulomenu">Fecha: &nbsp;&nbsp;
  			...
  			?>&nbsp;&nbsp;
            </span><span class="titulomenu">Hora: &nbsp;&nbsp;
                  <?php
        echo $hora;
