...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td colspan="2"><table width="100%" height="98"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="8%" rowspan="3"><div align="center"><img src="../../images/logo_mineco.jpg" width="142" >
		  </div></td>
...
where e.codigo_estatus = 6 and e.codigo_requisicion_enc = '$hoja_despacho'";
			...
			while($row_ingreso_enc=$fetch_array($res_ingreso_enc))
			{
				...
				$observaciones=utf8_encode($row_ingreso_enc["observaciones"]);
...
where d.codigo_requisicion_enc = $numero_requisicion";
		...
		{			
			...
			echo '<tr><td align="center" width="15%"><span class="descripcionproducto">'.$row_ingreso_det["codigo_categoria"].' '.utf8_encode($row_ingreso_det["codigo_subcategoria"]).'-'. $row_ingreso_det["codigo_producto"].'</span></td>';
			echo '<td align="left" width="40%"><span class="descripcionproducto">'.utf8_encode($row_ingreso_det["producto"]).'</span></td>';
			echo '<td align="center" width="15%"><span class="descripcionproducto">'.utf8_encode($row_ingreso_det["unidad_medida"]).'</span></td>';
			echo '<td align="center" width="15%"><span class="descripcionproducto">'.utf8_encode($row_ingreso_det["cantidad_solicitada"]).'</span></td>';
			echo '<td align="center" width="15%"><span class="descripcionproducto">'.utf8_encode($row_ingreso_det["cantidad_autorizada"]).'</span></td></tr>';			
		}
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="titulomenu"><div align="center">(F)_____________________________________</div></td>
    <td class="titulomenu"><div align="center">(F)_____________________________________</div></td>
  </tr>
  <tr>
...
<p>&nbsp;</p>
<p><img src="../../images/ico_print2.gif" onclick="imprimir();"  alt="Clic para Imprimir este documento" width="30" height="30" />
<br><span class="defaulttext ">Operado por: <?PHP //echo $operador; ?> El <?PHP //echo $operado; ?></span></p>
<?PHP
}
else
{
