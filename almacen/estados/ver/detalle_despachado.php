...
<div id="TabbedPanels1" class="TabbedPanels">
 ...
 <tr>
      ...
      <tr>
             <p align="left"><a target="_blank" href="rpt_despacho.php"><img src="../../images/ico_print2.gif"  alt="Clic para Imprimir este documento" width="30" height="30" /></a>
            
             </tr> 
                    
			 <!-- src="../../../images/iconos/ico_print.gif" -->
		...
		for ($i=0; $i<$nfilas; $i++)
         {
			...
			print ("<TD>" . utf8_encode($resultado['estatus']) . "</TD>\n"); 
