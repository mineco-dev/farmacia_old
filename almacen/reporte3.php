...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 id="table23">
              ...
              <TD width="100%" bgColor=#ffffff style="font-size: 10pt; font-family: verdana,arial" align="center"><TABLE cellSpacing=0 cellPadding=0 width="83%" border=0 id="table25">
                  <TBODY>
                    <TR>
                      ...
                      <TD width="57%" align=center vAlign=bottom style="font-size: 10pt; font-family: verdana,arial"><p align="center" class="style1">Reporte De Consumo Por Dependencia<br> Compra General</p>                        <p align="center" class="style1">&nbsp;</p></TD>
                      <TD width="17%" align=right vAlign=bottom style="font-size: 10pt; font-family: verdana,arial"><p align="center"><img src="./images/logo_mineco.png" width="307" height="113"></TD>
                    </TR>
                  </TBODY>
                </TABLE>
                  <p style="margin-top: 0; margin-bottom: 0"><BR clear=all>
                  </p>
                  <form name="form1" method="post" action="rep_consumo.php" target="_blank">
                    <table cellspacing=10 cellpadding=0 
                        border=0 id="table27" width="59%">
                      <tr>
                        <td align="center" bordercolor="#0000FF" class="grey2"><span lang="es-gt"><font color="#FFFFFF">Fecha inicial </font></span></td>
                      ...
                      <tr>
                        <td align="center" bordercolor="#0000FF" class="grey2"><span lang="es-gt"><font color="#FFFFFF">Fecha final </font></span></td>
                        <td align="center" bordercolor="#0000FF" bgcolor="#FFFFFF"><span lang="es-gt"><span lang="es-gt">
  ...
  <tr bgcolor="#BBC8E3">
    <td height="22" colspan="6"><span class="defaultfieldname">DEPENDENCIA</span></td>
  </tr>
  <tr>
...
{	
	$consulta=mssql_query("select iddireccion, nombre from direccion order by nombre");
	echo "<select name='select1' id='select1' onChange='cargaContenido(this.id)'>";
	echo "<option value='0'>Seleccione Dependencia</option>";
