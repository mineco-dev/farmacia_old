...
function agregar4() {
	...
	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"bien["+contLin4+"][2]\" type=\"text\" id=\"textfield\" size=\"9\">";
	
	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"bien["+contLin4+"][3]\" type=\"text\" id=\"textfield\" size=\"9\">";
	...
	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"bien["+contLin4+"][7]\" type=\"text\" id=\"textfield\" size=\"50\" disabled>";
...
<table width="99%" border=1 cellspacing="0" id="tabla4">
  <tr>
    ...
    <th width="115" rowspan="2" scope="col"><div align="center" class="Estilo2">Codigo</div></th>
    <th width="141" rowspan="2" scope="col"><div align="center" class="Estilo2">Categoria</div></th>
    <th width="143" rowspan="2" scope="col"><div align="center" class="Estilo2">Sub-Categoria</div></th>
    <th width="144" rowspan="2" scope="col"><span class="Estilo2">Renglon</span></th>
    <th width="381" rowspan="2" scope="col"><span class="Estilo2">Producto</span></th>
