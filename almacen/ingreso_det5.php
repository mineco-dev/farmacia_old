...
<script language="javascript">
 ...
 while(valores<contLin4) {
	  ...
	  var num1 = String(document.getElementById(['precio_total['+valores+']']).value);
      var num2 = String(document.getElementById(['total['+valores+']']).value);
	 
	  document.getElementById(['total['+valores+']']).value = num2;	  
...
function agregar4() {
	...
	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"bien["+contLin4+"][7]\" type=\"text\" id=\"textfield\" size=\"45\">";
	...
	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"precio_total["+contLin4+"]\" type=\"text\" id=\"precio_total["+contLin4+"]\" onblur=\"javascript:suma2()\" size=\"7\">";
	
	td = tr.insertCell();
	td.innerHTML = 	"<input name=\"total["+contLin4+"]\" type=\"text\" id=\"total["+contLin4+"]\"  size=\"7\" disabled>";
...
<table width="99%" border=1 cellspacing="0" id="tabla4">
  <tr>
    <th width="11" rowspan="2" scope="col"><span class="Estilo2">#</span></th>
    
   
    <th width="154" rowspan="2" scope="col"><div align="center" class="Estilo2">Codigo</div></th>
    <th width="187" rowspan="2" scope="col"><div align="center" class="Estilo2">Categoria</div></th>
    <th width="152" rowspan="2" scope="col"><div align="center" class="Estilo2">Sub-Categoria</div></th>
    <th width="130" rowspan="2" scope="col"><span class="Estilo2">Renglon</span></th>
    <th width="301" rowspan="2" scope="col"><span class="Estilo2">Producto</span></th>
    <th width="86" rowspan="2" scope="col"><span class="Estilo2">Cantidad Ingresada</span></th>
    <th width="78" rowspan="2" scope="col"><span class="Estilo2">Costo unitario</span></th>
    <th width="82" rowspan="2" scope="col"><span class="Estilo2">Precio Total</span></th>
      <th width="82" rowspan="2" scope="col"><span class="Estilo2">Total Factura</span></th>
  </tr>
  <tr>
  </tr>
</table>
