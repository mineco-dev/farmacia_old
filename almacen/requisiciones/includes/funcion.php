...
function getTabla($strquery,$ccol,$ncol,$campos,$tamano,$dbms,$width,$mod,$eli,$ver)
{
	...
	$col2 = "#FFFFFF";
	$impresion = 
	"<table width=\"$width%\" border=\"0\" align=\"center\" class=\"table\">
	...
	if (strlen(trim($ver)) > 0)	$impresion = $impresion . "<td width=\"10%\" class=\"white\">Modificar</td>";
	...
	while($Fields=$dbms->MoveNext())
	{
		...
		if (strlen(trim($ver)) > 0)
			$impresion = $impresion . "<td><span class=\"Estilo1 glyphicon glyphicon-pencil\"><a href=\"$ver".$Fields[$campos[$cnt]]."\" title=\"ver\"><img src=\"requisiciones/imagenes/edit.jpg\" width=\"16\" height=\"16\" border=\"0\"/></span></td>";
	...
	if ($cantidad > 1) 
		...
		print "<img src=\"requisiciones/imagenes/atencion.png\" border=\"0\"/ width=\"16\" height=\"16\"> no hay datos ingresados...<br>";
}
