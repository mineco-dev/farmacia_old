...
where cat_bodega.codigo_empresa = ".$_REQUEST['Id']." ORDER BY cat_bodega.bodega";	
					...
					{
						echo'<option value="'.$row_bodega["codigo_bodega"].'">'.$row_bodega["codigo_bodega"].'-'.$row_bodega["bodega"].'</option>';
					}
					echo('</select>');				
