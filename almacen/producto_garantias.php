    ...
    <table width="100%" border="0" bordercolor="#ECE9D8">
      ...
      <tr>
        <td>        <div align="left" class="Estilo1">
          <div align="left">
            <p><strong><strong>            [<a href="producto_garantias.php?in=A" alt="Muestra los registros que inician con A">A</a>] [<a href="producto_garantias.php?in=B">B</a>] [<a href="producto_garantias.php?in=C">C</a>] [<a href="producto_garantias.php?in=D">D</a>] [<a href="producto_garantias.php?in=E">E</a>] [<a href="producto_garantias.php?in=F">F</a>] [<a href="producto_garantias.php?in=G">G</a>] [<a href="producto_garantias.php?in=H">H</a>] [<a href="producto_garantias.php?in=I">I</a>] [<a href="producto_garantias.php?in=J">J</a>] [<a href="producto_garantias.php?in=K">K</a>] [<a href="producto_garantias.php?in=L">L</a>] [<a href="producto_garantias.php?in=M">M</a>] [<a href="producto_garantias.php?in=N">N</a>] [<a href="producto_garantias.php?in=O">O</a>] [<a href="producto_garantias.php?in=P">P</a>] [<a href="producto_garantias.php?in=Q">Q</a>] [<a href="producto_garantias.php?in=R">R</a>] [<a href="producto_garantias.php?in=S">S</a>] [<a href="producto_garantias.php?in=T">T</a>] [<a href="producto_garantias.php?in=U">U</a>] [<a href="producto_garantias.php?in=V">V</a>] [<a href="producto_garantias.php?in=W">W</a>] [<a href="producto_garantias.php?in=X">X</a>] [<a href="producto_garantias.php?in=Y">Y</a>] [<a href="producto_garantias.php?in=Z">Z</a>] <a href="producto_garantias.php?in=all">[TODO]</a>
                </strong></strong></p>
            <p><strong><strong>
...
INNER JOIN cat_empresa e ON e.codigo_empresa = i.codigo_empresa
							where (p.producto like '%$busqueda%' or p.uso like '%$busqueda%') and p.activo=1 and i.codigo_empresa='6' order by bodega";																		
				}
				else	
...
INNER JOIN cat_bodega b ON b.codigo_bodega = i.codigo_bodega
INNER JOIN cat_empresa e ON e.codigo_empresa = i.codigo_empresa
							        where p.producto like '$inicial%' and i.codigo_empresa='6'";
						else
							$consulta = "SELECT     (p.producto +' - '+ p.marca +' EN '+ m.unidad_medida) as producto, i.rowid, p.codigo_subcategoria,
p.codigo_categoria,  p.activo, i.existencia, p.codigo_producto, p.uso, b.bodega, e.empresa 
FROM     cat_producto p
...
INNER JOIN cat_bodega b ON b.codigo_bodega = i.codigo_bodega
INNER JOIN cat_empresa e ON e.codigo_empresa = i.codigo_empresa
							where p.producto like 'A%' and i.codigo_empresa='6'";
				}
				conectardb($almacen);
