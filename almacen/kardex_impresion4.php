...
echo '<tr><table width="1015" border="1" cellpadding="1" cellspacing="1" align="center">
<td width="5px"><span class="blue">'.$vector[0].'</span></td>
<td width="5px"><span class="blue">'.$vector[2].'</span></td>
<td width="10px"><span class="blue">'.$vector[3].'</span></td>
<td width="10px"><span class="blue">'.$vector[4].'</span></td>
<td width="10px"><span class="blue">'.$vector[5].'</span></td>
<td width="10px"><span class="blue">'.$vector[6].'</span></td>
<td width="10px"><span class="blue">'.$vector[7].'</span></td>
<td width="10px"><span class="blue">'.$vector[8].'</span></td>
<td width="10px"><span class="blue">'.$vector[9].'</span></td>
<td width="10px"><span class="blue">'.$vector[10].'</span></td>
<td width="10px"><span class="blue">'.$vector[11].'</span></td>
<td width="18px"><span class="blue">'.$vector[12].'</span></td>
</tr></table>';										
					$tmp++;
					$i++;
