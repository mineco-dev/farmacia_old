...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 id="table23">
          ...
          <TBODY>
            <TR>
              <TD width="100%" bgColor=#ffffff style="font-size: 10pt; font-family: verdana,arial" align="center"><TABLE cellSpacing=0 cellPadding=0 width="83%" border=0 id="table25">
                  ...
                  <form name="form1" method="post" action="test.php" target="_blank"> <!--llamada a php para impresion-->
  ...
  <tr bgcolor="#BBC8E3">
    <td height="22" colspan="6"><span class="defaultfieldname">SELECCIONE LA DEPENDENCIA DE LA QUE DESEA VER EL CONSUMO: </span></td>
  </tr>
  <tr>
    <td height="22" colspan="6"><?PHP
	 ...
	 ?>      </td>
                       ...
                       <tr>
                        <td width="180" align="center" bordercolor="#0000FF" bgcolor="#FFFFFF"><span lang="es-gt"></span></td>
                        <td width="244" align="center" bordercolor="#0000FF" bgcolor="#FFFFFF"><span lang="es-gt">
...
{	$consulta=mssql_query("select distinct(iddireccion), nombre, siglas from direccion order by nombre");
	echo "<select id='select1' onChange='cargaContenido(this.id)'>";
