...
{	
	...
	{	
		...
		$proveedor=strtoupper($_REQUEST["txt_proveedor"]);	
		...
		{
			echo "este nit ya esta ingresado";
			$existe=true;
		}
		if ($existe==false)
		{			/*			
...
function Validar(form)
{
   ...
   if (form.txt_proveedor.value == "" && form.txt_buscar.value == "")
  { 
  	alert("Escriba el nombre del proveedor"); 
	form.txt_proveedor.focus(); 
	return;
 }
...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    <li class="TabbedPanelsTab" tabindex="0"><strong>Ingreso de un nuevo proveedor al catologo</strong></li>
    ...
    <div class="TabbedPanelsContent">
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="panel">
        ...
        <tr>
          <td colspan="4">&nbsp;</td>
             ...
             <td valign="top">&nbsp;</td>
                <td>Nit</td>
                <td colspan="2"><input name="txt_nit" type="text" id="txt_nit" value="" size="18"></td>
              </tr>
          ...
          <td colspan="2">&nbsp;</td>
              ...
              <tr>
               <td valign="top">&nbsp;</td>
                <td>Proveedor</td>
                <td colspan="2"><input name="txt_proveedor" type="text" id="txt_proveedor" size="40">
       ...
       <tr>
               <td valign="top">&nbsp;</td>
                <td>Direccion</td>
                <td colspan="2"><input name="txt_direccion" type="text" id="txt_direccion" size="60">
                 <div align="left"></div></td>
              </tr>
       ...
       <tr>
               <td valign="top">&nbsp;</td>
                <td>Telefonos</td>
                <td colspan="2"><input name="txt_telefonos" type="text" id="txt_telefonos" size="40">
                 <div align="left"></div></td>
              </tr>
     ...
     <tr>
       ...
       <tr>
               <td valign="top">&nbsp;</td>
                <td>Contacto</td>
                <td colspan="2"><input name="txt_contacto" type="text" id="txt_contacto" size="40">
                 <div align="left"></div></td>
              </tr>
     <tr>
          <td valign="top">&nbsp;</td>
       ...
       <tr>
               <td valign="top">&nbsp;</td>
                <td>Correo</td>
                <td colspan="2"><input name="txt_correo" type="text" id="txt_correo" size="40">
                 <div align="left"></div></td>
              </tr>
     <tr>
          <td colspan="4">&nbsp;</td>
  ...
  <div class="TabbedPanelsContentGroup">
    <div class="TabbedPanelsContent">
      ...
      <tr>
        <td>        <div align="left" class="Estilo1">
          <div align="left"><strong><strong>            [<a href="nuevo_proveedor.php?in=A" alt="Muestra los registros que inician con A">A</a>] [<a href="nuevo_proveedor.php?in=B">B</a>] [<a href="nuevo_proveedor.php?in=C">C</a>] [<a href="nuevo_proveedor.php?in=D">D</a>] [<a href="nuevo_proveedor.php?in=E">E</a>] [<a href="nuevo_proveedor.php?in=F">F</a>] [<a href="nuevo_proveedor.php?in=G">G</a>] [<a href="nuevo_proveedor.php?in=H">H</a>] [<a href="nuevo_proveedor.php?in=I">I</a>] [<a href="nuevo_proveedor.php?in=J">J</a>] [<a href="nuevo_proveedor.php?in=K">K</a>] [<a href="nuevo_proveedor.php?in=L">L</a>] [<a href="nuevo_proveedor.php?in=M">M</a>] [<a href="nuevo_proveedor.php?in=N">N</a>] [<a href="nuevo_proveedor.php?in=O">O</a>] [<a href="nuevo_proveedor.php?in=P">P</a>] [<a href="nuevo_proveedor.php?in=Q">Q</a>] [<a href="nuevo_proveedor.php?in=R">R</a>] [<a href="nuevo_proveedor.php?in=S">S</a>] [<a href="nuevo_proveedor.php?in=T">T</a>] [<a href="nuevo_proveedor.php?in=U">U</a>] [<a href="nuevo_proveedor.php?in=V">V</a>] [<a href="nuevo_proveedor.php?in=W">W</a>] [<a href="nuevo_proveedor.php?in=X">X</a>] [<a href="nuevo_proveedor.php?in=Y">Y</a>] [<a href="nuevo_proveedor.php?in=Z">Z</a>] <a href="nuevo_proveedor.php?in=all">[TODO]</a>                  <input name="txt_buscar" type="text" id="txt_buscar2" size="20">
    ...
    <table class="tborder" cellpadding="0" cellspacing="1" border="0" width="100%" id="table17">
      <tr align="center" bgcolor="#aeccf2" class="thead">
        <td width="11%" height="19" class="titulotabla"><strong><strong>Nit</strong></strong></td>
        <td width="30%" class="titulotabla"><strong>Nombre</strong></td>
        <td width="32%" class="titulotabla"><strong>Direccion</strong></td>
        <td width="21%" class="titulotabla"><strong>Telefonos</strong></td>
        <td width="6%" colspan="-1" class="thead Estilo3"><span class="titulotabla"><strong>Editar</strong></span></td>
      </tr>
		<?PHP
				...
				while($row=$fetch_array($result))
				{
					...
					{										
					echo '<tr class='.$clase.'>';								
					echo '<td>'.$row["nit"].'</td><td>'.$row["nombre"].'</td><td>'.$row["direccion"].'</td><td>'.$row["telefonos"].'</td><td><center><a href="editar_proveedor.php?id='.$row["rowid"].'"><img src="../images/iconos/ico_editar.jpg" alt="Modificar información"></a></center></td></tr>';					
					}
					else
					echo '<tr class='.$clase.'><td>'.$row["nit"].'</td><td>'.$row["nombre"].'</td><td>'.$row["direccion"].'</td><td>'.$row["telefonos"].'</td><td><center><a href="editar_proveedor.php?id='.$row["rowid"].'"><img src="../images/iconos/ico_editar.jpg" alt="Modificar información"></a></center></td></tr>';										
					$i++;
				}
				$free_result($result);
			 ?>
