...
<p align="left">PUBLICACIONES Y ANUNCIOS</p>
<form action="gcrear_publicacion.php" method="post" enctype="multipart/form-data"> 
    <table width="681" border="0">
      <tr>
        <td width="144" height="105" class="detalletabla1">Descripci&oacute;n:</td>
        <td width="527" class="detalletabla1"><textarea name="cadenatexto" cols="50" rows="4" id="cadenatexto"></textarea></td>
      </tr>
