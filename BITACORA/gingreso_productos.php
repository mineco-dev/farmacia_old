   ...
   { 
	...
	{						
		...
		if (!$existe)
		{
			...
			$qry_ingreso_inventario.="(existencia, ultimo_ingreso, usuario_ingreso, codigo_empresa, codigo_bodega, codigo_producto, codigo_categoria, codigo_subcategoria, costo_inicial, ultimo_costo, cantidad_comprometida)";
			$qry_ingreso_inventario.="values ('$ingresado[$cnt]', getdate(), '$nombre_usuario', $cbo_empresa, $cbo_bodega, '$codigoproducto', '$categoria', '$subcategoria', '$costo_unitario[$cnt]', '$costo_unitario[$cnt]', 0)";			
		}
		//print($qry_ingreso_inventario);
