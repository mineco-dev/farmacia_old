...
function getTabla($strquery,$ccol,$ncol,$campos,$tamano,$dbms,$width,$mod,$eli,$ver)
{
	...
	while($Fields=$dbms->MoveNext())
	{
		...
		if (strlen(trim($mod)) > 0)
			$impresion = $impresion . "<td><span class=\"Estilo1\"><a href=\"$mod".$Fields[$campos[$cnt]]."\"><img src=\"../ingresos_egresos/imagenes/modificar.png\" border=\"0\"/></span></td>";
		if (strlen(trim($eli)) > 0)
			$impresion = $impresion . "<td><span class=\"Estilo1\"><a href=\"$eli".$Fields[$campos[$cnt]]."\"><img src=\"../ingresos_egresos/imagenes/borrar.png\" border=\"0\"/></span></td>";
		if (strlen(trim($ver)) > 0)
			$impresion = $impresion . "<td><span class=\"Estilo1\"><a href=\"$ver".$Fields[$campos[$cnt]]."\" title=\"ver\"><img src=\"../ingresos_egresos/imagenes/ver.png\" border=\"0\"/></span></td>";
