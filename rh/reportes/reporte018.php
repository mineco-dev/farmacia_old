...
<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" id="table17">     
      ...
      <tr align="center" bgcolor="#006699" class="boxTitleBgLightBlue">
          ...
          <td width="12%"><strong>Informe</strong></td>
</tr>
<?	
...
*/
					if ($vector[5]=="")
					{$link='<a href="crear.php?id='.$vector[0].'&consultor='.$vector[1].'"><img src="../../images/iconos/ico_ingresar.gif" border="0" alt="Agregar informe">';
					}
					else
					{$link='<a href="editar.php?id='.$vector[0].'&consultor='.$vector[1].'"><img src="../../images/iconos/ico_editar.gif" border="0" alt="Sobreescribir el informe existente">';	
					}
					$mes_actual=1;
					...
					echo '<tr class='.$clase.'><td>'.$i.'</td><td> '.$vector[1].'</td><td> '.$vector[2].'</td><td> '.$vector[3].'</td><td>Q. '.$vector[4].'</td><td bgcolor='.$estado.' align="center">'.$link.'</td></tr>';										
						$tmp++;
						$i++;
