        ...
        <td><div align="center">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="15%"><div align="center"><img src="../../images/logo_rpt.gif" width="82"></div></td>
            </tr>
          </table>
          </div></td>
      </tr>
...
<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" id="table17">     
      ...
      <tr align="center" bgcolor="#006699" class="boxTitleBgLightBlue">
          ...
          <td width="12%" colspan="2"><strong>Informe</strong></td>
</tr>
<?	
...
if ($_REQUEST["rg"]) //cuando se desea un reporte por renglones
{
	...
	if ($_REQUEST["rg"]==3) //cuando es 018
	{
		$query = "select  a.idasesor, (a.nombre+' '+a.nombre2+' '+a.apellido+' '+a.apellido2) as nombre_empleado,
				...
				left join direccion d on g.entidad_gobierno=d.iddireccion
				 left join puesto p on  p.id_puesto=g.puesto 
 				 left join asesor_informe i on  i.idasesor=a.idasesor 
...
*/
					...
					$subir='<a href="crear.php?id='.$vector[0].'&consultor='.$vector[1].'"><img src="../../images/iconos/ico_plus.gif" border="0" alt="Subir informe"></a>';
					
					if ($vector[5]=="")
					{
					$consultar='<img src="../../images/iconos/ico_ver.jpg" border="0" alt="Consultar"></a>'; 
					}
					else
					{
					$consultar='<a href="informes/'.$vector[5].'" target="_blank"><img src="../../images/iconos/ico_ver.jpg" border="0" alt="Consultar">'; 

					}					
					
					
					$mes_actual=(int)date("m");
					if ($vector[6] < $mes_actual)	
					{ $estado='#FF0000'; }
					else { $estado='#009900';}
					include("../../includes/format_table.php");						
					echo '<tr class='.$clase.'><td>'.$i.'</td><td> '.$vector[1].'</td><td> '.$vector[2].'</td><td> '.$vector[3].'</td><td>Q. '.$vector[4].'</td><td bgcolor='.$estado.' align="center">'.$subir.'</td><td align="center">'.$consultar.'</td></tr>';										
						$tmp++;
						$i++;
