...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="0">Datos Académicos</li>
    <li class="TabbedPanelsTab" tabindex="0">Experiencia Laboral</li>
    <li class="TabbedPanelsTab" tabindex="0">Historial Médico</li>
...
adjunte copia de C&eacute;dula</div-->
          ...
          <tr class="Estilo1">
			...
			?>
           <span class="Estilo6" Numero**: >                                               
            <input type="text" name="num_licencia" size = "20" value=" <? echo $row[28]; ?>" > </span>  
        </table></div>
    <div class="TabbedPanelsContent">
