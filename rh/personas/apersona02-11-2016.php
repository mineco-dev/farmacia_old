...
if ($flag != 1) {	
	...
	if ($opnacionalidad == 1) // nacional
	{
		...
		,idgrupoetnico,tipolicencia,licencia,iddepartamento_nac1,idmunicipio_nac1,iddepartamento_dpi,idmunicipio_pdi,id_linguistica) 
		...
		'$lnac','$mnac','$dpiext','$munidpi','$lingui')";
...
//print $sqpersona;
	...
	$fecha_ingresoper =  "$ano1-$mes1-$dia1";
		echo		$sqpersona2 = "  insert into tb_datos_laborales (
             id_asesor,
...
$sql = "select id_partida_presupuestaria, nombre_partida from tb_partida";
    ...
    <td><select name="reglon_presupuestario" class="TituloMedios Estilo73" id="select13" >
        <option value='0'> Ninguno </option>
        <? 
$sql = "select id_reglon_presupuestario, reglon from tb_reglon_presupuestario";
  ...
  <tr>
    ...
    <td><select name="puestoOficial_nonimal" class="TituloMedios Estilo73" id="select14" >
        <option value='0'> Ninguno </option>
        <? 
...
$sql = "select id_direccion_pertenece, direccion_nombre from tb_direccion_pertenece";
  ...
  <tr>
    ...
    <td><select name="unidad_nonimal" class="TituloMedios Estilo73" id="select18" >
        <option value='0'> Ninguno </option>
        <? 
$sql = "select id_unidad, nombre_unidad from dbo.tb_unidad_asesor where activo =1";
    ...
    <td><span class="Estilo73">Unidad a la que pertenece <font color="#FF0000"><strong>**</strong></font></span></td>
    <td><select name="unidad_funcional" class="TituloMedios Estilo73" id="select26" >
        <option value='0'> Ninguno </option>
        <? 
$sql = "select id_unidad, nombre_unidad from dbo.tb_unidad_asesor where activo =1";
			$result = mssql_query($sql);
  ...
  <tr>
    ...
    <td><select name="Ubicacion_nominal" class="TituloMedios Estilo73" id="select19" >
        <option value='0'> Ninguno </option>
        <? 
...
<table width="1116" border="0">
  <tr>
    ...
    <td><span class="Estilo73">DPI Extendido en</span></td>
