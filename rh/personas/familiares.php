...
<table width="73%" border=0 cellspacing="0" id="tabla4">
  <tr>
    ...
    <th class="HelloUser" scope="col">&nbsp;</th>
    <th class="HelloUser" scope="col">&nbsp;</th>
    <th colspan="3" class="HelloUser" scope="col">Fecha de nacimineto </th>
    <th class="HelloUser" scope="col">&nbsp;</th>
  </tr>
  <tr>
	<th width="31" class="HelloUser" scope="col">#</th>
    <th width="129" class="HelloUser" scope="col">Nombre</th>
    <th width="150" class="HelloUser" scope="col"><div align="center">Tipo de Parentesco</div></th>
