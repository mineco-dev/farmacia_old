...
$query = mssql_query("select id_estadoEstudio, tipo from dbo.tb_estadoEstudio where activo =1 ");																									
	if ($query)
		{
...
function agregar10() {
	...
	td = tr.insertCell();
	td.innerHTML = 	"<select name=\"estadoEstudio["+contLin10+"]\" id=\"select\">';
	echo $esta;
	echo '</select>";		
...
<table width="73%" border=0 cellspacing="0" id="tabla10">
  <tr>
    ...
    <th class="HelloUser" scope="col">&nbsp;</th>
    <th class="HelloUser" scope="col">&nbsp;</th>
    <th colspan="3" class="HelloUser" scope="col">Fecha de egreso </th>
  </tr>
  <tr>
    <th width="31" height="15" class="HelloUser" scope="col">#</th>
    <th width="179" class="HelloUser" scope="col">Nivel Academico </th>
    <th width="359" class="HelloUser" scope="col"><div align="center">Centro de Estudios </div></th>
    <th width="179" class="HelloUser" scope="col">Titulo</th>
    <th width="179" class="HelloUser" scope="col">Estado</th>
    <th width="40" class="HelloUser" scope="col">a&ntilde;o</th>
