...
{	
 ...
 $sqls = "	 select id_unidad_ejecutora,id_reglon_presupuestario, id_direccion_pertenece,id_pueto_funcional
	  , id_puesto_nominal, id_viceministerio, year(fecha_ingreso),activo, id_sede, day(fecha_ingreso), month(fecha_ingreso),id_fuente,id_partida_presupuestaria
 ...
 <div id="TabbedPanels1" class="TabbedPanels">
  ...
  <div id="view1">
    <table width="1116" border="0">
      ...
      <tr>
        <td width="94" height="32"><span class="Estilo73">
          <?
			if (!empty($row[39]) )
			{
        ...
        <td width="418">
          <span class="Estilo73">DPI<font color="#FF0000">*</font><font color="#FF0000"></font></span><strong><span class="Estilo73"><font color="#FF0000"><strong>*</strong></font></span>
        ...
        <td width="434"><span class="Estilo7">
      ...
      <tr>
        ...
        <td><span class="Estilo74">
		  ...
		  <select name="registro2" class="TituloMedios" id="registro2" onchange="javascript:cargarCombo('subactividad.php', 'registro2', 'Div_Subactividad2')" >
			...
			while ($row = mssql_fetch_array($result))
			  ...
			  if ($depar_naci ==  $row[0] )
					{
						print '<option selected value="'. $row['codigo_registro'].'">'.$row['nombre_departamento'].'</option>';		
					}else{
						print '<option  value="'. $row['codigo_registro'].'">'.$row['nombre_departamento'].'</option>';		
					}
      ...
      <tr>
		...
		<div class="Estilo73" id="Div_Subactividad2">
	...
	$cdepartamento = $res['codigo_departamento']; 
			...
			while ($row = mssql_fetch_array($result))
			  ...
			  if ($muni_naci ==  $row[0] )
					{
						print '<option selected value="'. $row['codigo_municipio'].'">'.$row['nombre_municipio'].'</option>';		
					}else{
						print '<option  value="'. $row['codigo_municipio'].'">'.$row['nombre_municipio'].'</option>';		
					}
...
$sql = "select idgrupoetnico, grupoetnico from asesor_grupoetnico";
          ...
          <? 
					...
					if ($grupo ==$grupoet['idgrupoetnico'])
					{
	...
	$cdepartamento = $res['codigo_departamento']; 
      ...
      <tr>
        ...
        <td><span class="Estilo74">
          <select name="select3" class="TituloMedios" id="select3" onchange="javascript:cargarCombo('subactividad.php', 'registro2', 'Div_Subactividad2')" >
            <option value=''> Seleccione </option>
            <?      
			$sql = "select dpi.codigo_registro,dpi.registro, dep.nombre_departamento, dep.codigo_departamento from dbo.tb_registro as dpi inner join dbo.tb_departamento as dep on dpi.codigo_departamento= dep.codigo_departamento where dpi.codigo_departamento >0";
			$result = mssql_query($sql);
...
<td width="1" align="center" bordercolor="#990066" background="../imagen/blue_bg.gif" bgcolor="#000000"><span class="Estilo7" lang="es-gt" xml:lang="es-gt"><font color="#FFFFFF">Titulo Obtenido</font></span></td>
  ...
  <div id="view3">
    <table width="1117" border="0">
      <tr>
        ...
        <td width="212"><select name="unidad_ejecutora" class="TituloMedios Estilo73" id="select5" >
            <option value='0'> Ninguno </option>
            <? 
$sql = "select id_unidad_ejecutora, unidad_ejecutora from tb_unidad_ejecutora";
        ...
        <td width="508"><select name="reglon_presupuestario" class="TituloMedios Estilo73" id="select6" >
            <option value='0'> Ninguno </option>
            <? 
$sql = "select id_reglon_presupuestario, reglon from tb_reglon_presupuestario";
			...
			while ($row = mssql_fetch_array($result))
			  { 
			  		if ($reglon_presupuestario ==$row[0])
					{
						print '<option selected value="'.$row[0].'">'.$row[1].'</option>';		
					}else{
						print '<option value="'.$row[0].'">'.$row[1].'</option>';	
...
$sql = "select id_partida_presupuestaria, nombre_partida from tb_partida";
        ...
        <td><select name="fuentes" class="TituloMedios Estilo73" id="select14" >
          <option value='0'> Ninguno </option>
          <? 
