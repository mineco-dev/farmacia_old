	...
	else
	{
		...
		ajax.onreadystatechange=function()
		{
			if (ajax.readyState==4)
			{
				...
				if(respuesta=="OK")
				{
					var texto="<img src='ok.gif' alt='Ok'><br>Solicitud Ingresada Exitosamente.<br>Le Se ha enviado un mensaje al correo electronico.<br><br><button style='width:45px; height:18px; font-size:10px;' onClick='ocultaMensaje()' type='button'>Ok</button>";
				}
