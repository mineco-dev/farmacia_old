	...
	function funcion_correos($codpersona)
		...
		$result = mssql_query($qry_insertar_correo);	
					...
					{	
							  ...
							  print"<TD width='135'><span class='style9'><input type='checkbox' name='checkbox_correo[$cnt]' id='checkbox' /> </span></TD>";							
							  print"</tr>";		 																				
						$cnt ++;
					}
		}
...
$opnacionalidad = 1;
	...
	if ($opnacionalidad == 1) // nacional
	{
		...
		nombre_estado_provincia, year(fecha_nacimiento),month(fecha_nacimiento),day(fecha_nacimiento),zona,tipolicencia,licencia,iddepartamento_reside,gafete,idgrupoetnico,direccion_para_notificaciones,igss,empadronamiento,gruposanguineo,altura,peso,idasesor FROM asesor WHERE gafete = '$num_gafete'";
        ...
        <table width="100%" border="0" align="center" cellspacing="0">
          ...
          <tr class="Estilo1">
            ...
            <td class="Estilo7"><span class="Estilo22"><strong>
              ...
              &nbsp;&nbsp;
              <input name="validar" type="submit" class="TabbedPanelsContentGroup" value="Buscar" />
            </strong></span></td>
          ...
          <tr class="Estilo7">
			...
			<table width="100%" border="0">
              ...
              <tr class="Estilo7">
                ...
                <td width="33%" colspan="-1"><input type="file" name="fileField" id="fileField" /></td>
              </tr>
              <tr class="Estilo7">
...
adjunte copia de C&eacute;dula</div-->
          ...
          <tr class="Estilo1">
			...
			while ($ww = mssql_fetch_array($result))
			  { 
				...
				?>
              		<? 
					if ($row[16] == $ww['codigo_profesion'])
					{
	                    print '<option selected value="'.$ww['codigo_profesion'].'">'.$ww['profesion'].'</option>';						
					}else{
	                    print '<option value="'.$ww['codigo_profesion'].'">'.$ww['profesion'].'</option>';						
					}
               } 			   
			   ?>
            </select></td>
          ...
          <tr class="Estilo1">
            ...
            <input type="text" name="num_licencia" size = "20" value=" <? echo $row[28]; ?> ">            &nbsp;</td>
          </tr>
        </table>
      </div>
      <div class="TabbedPanelsContent">
...
$sql = "select codigo_departamento, nombre_departamento from tb_departamento";
          ...
          <tr>
            ...
            <td colspan="2"><input type="text" name="direccion_para_notificaciones" size="40" value="<? echo $row[32];?>">&nbsp;</td>
            <td >&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
                    ...
                    <div align="center">
                      <table width="735" 
                        ...
                        <tbody>
                          <tr>
                            <td width="184" align="center" bordercolor="#990066" background="../imagen/blue_bg.gif" bgcolor="#000000"><font color="#FFFFFF">Codigo </font></td>
                            <td width="437" align="center" bordercolor="#990066" background="../imagen/blue_bg.gif" bgcolor="#000000"><span class="Estilo7" lang="es-gt" xml:lang="es-gt"><font color="#FFFFFF">Numero Telefono</font></span></td>
                            <td width="110" align="center" bordercolor="#990066" background="../imagen/blue_bg.gif" bgcolor="#000000"><span class="GrayLink" lang="es-gt" xml:lang="es-gt"><font color="#FFFFFF">Eliminar</font></span></td>
                            </tr>
                          <?
...
<td width="250" align="center" bordercolor="#990066" background="../imagen/blue_bg.gif" bgcolor="#000000"><span class="GrayLink" lang="es-gt" xml:lang="es-gt"><font color="#FFFFFF">Partida </font></span></td>
...
?>
  ...
  <p align="center">
    <input name="cmd_guardar" type="button" class="TuringHelp" id="cmd_guardar" onClick="Validar(this.form)" value="Guardar Datos" >
  </p>
</form>
