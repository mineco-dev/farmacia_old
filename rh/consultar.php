...
<h2 class="style4">&nbsp;</h2>
<table width="97%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#f8f8f8" class="GrayBasicFont">
  <tr>
      ...
      <tr>
        ...
        <table width="98%" border="0" cellspacing="4" cellpadding="0">
          <tr>
            ...
            <td>&nbsp;</td>
            <td width="34%" colspan="2" rowspan="6">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><select name="cantidad" id="cantidad">
			  	<option value="1">Caballerias</option>
			  	<option value="2">Toneladas</option>
			  	<option value="3">Costales</option>
			  	<option value="4">Cubetas</option>
			  </select>&nbsp;</td>
            <td>&nbsp;</td>
            </tr>
          <tr>
            <td width="17%" class="TuringHelp">Descripcion General del Bien </td>
            <td width="47%"><textarea name="descripcion" cols="50" rows="6"> <? print $vector[0];?></textarea></td>
          <td width="2%">&nbsp;</td>
            </tr>
          <tr>
...
<button type="button" id="botonIngreso" onclick="nuevoEvento('ingreso')">Insertar            
          ...
          <tr>
            <td height="22" class="HelloUser"></td>
            <td><div class="mensaje" id="error"></div> </td>
          </tr>
            <tr>
              <td height="22" class="HelloUser"></td>
              <td> <input name="search1" type="text" id="ingreso" size="25" maxlenght="100" />
<button type="button" id="botonIngreso" onclick="nuevoEvento('ingreso')">Verificar       &nbsp;</td>
            </tr>
            <tr>
              <td height="22" class="HelloUser"></td>
              <td>&nbsp;</td>
