...
$opnacionalidad = 1;
		...
		if (!((strpos($tipo_archivo, "gif") || strpos($tipo_archivo, "jpg") || strpos($tipo_archivo, "jpg") || strpos($tipo_archivo, "pdf")) && ($tamano_archivo < 100000))) { 
...
if ($flag != 1) {	
	...
	{
		$idnacionalidad = 1;								//INSERT 1ER BLOQUE  DENTRO DEL IF Y ELSE

		echo $sqpersona = "insert into asesor(nombre,nombre2,nombre3,apellido,apellido2, 
...
<body>
<table width="598" border="0" align="center" cellspacing="0">
  <tr bgcolor="#0066CC">
    <td colspan="7" bgcolor="#FFFFFF"><div align="left"><span class="Estilo1 Estilo2 style1"><span class="titulo">Formulario de Ingreso de Personas al Sistema</span></span><span class="style5">&nbsp;&nbsp;</span><span class="Estilo67"><font color="#6699FF" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Fecha</font> <font face="Arial, Helvetica, sans-serif"> <? echo'<font color="#003399"><strong>'.date("d")."/".date("m")."/".date("Y").'</strong></font>'; ?> <? echo'<font color="#003399"><strong>'.$hora.'</strong></font>'; ?> </font></span></div></td>
  </tr>
  &nbsp;
  <tr>
...
<form action="apersona.php?inserta=1" method="get" enctype="multipart/form-data" name="form1" id="form1">
...
<? include("salarios.php");?>
 <!--se agrega para el boton guardar-->
   <!-- <p align="center">
      <input name="cmd_guardar2" type="button" onclick="Validar(this.form)" id="cmd_guardar2" value="Guardar Datos" />
    </p> -->
</div>
	...
	?>
          ...
          <tr class="Estilo7">
			...
			<table width="100%" border="0">
              <tr class="Estilo7">
                <td width="20%" class="Estilo7"><div align="left"><span class="style8">DPI</span></div></td>
                <td width="32%" class="Estilo7"><input name="DPI" type="text" class="Estilo7" id="DPI" size="30" onKeyUp="javascript:this.value=this.value.toUpperCase();" /> </td>
                <td colspan="2" class="Estilo7"><div align="right" class="Estilo22">Fotografia</div></td>
                <td width="35%" colspan="-1"><input type="file" name="userfile" id="userfile" /></td>
              </tr>
              <tr class="Estilo7">
                <td class="Estilo7">&nbsp;</td>
                <td class="Estilo7"><span class="Estilo22">
...
adjunte copia de C&eacute;dula</div-->
				...
				<input name="igss" type="text" class="Estilo7" id="igss" onKeyUp="javascript:this.value.toUpperCase();"/>
				</span></span></td>
              </tr>
              <tr class="Estilo1">
                ...
                <td class="Estilo7"><span class="Estilo47">
                  <div align="left"><div id="Div_Subactividades">
                     ...
                     <select name="idgrupo"  id="idgrupo" class="TituloMedios"> <option value='0'>seleccione</option> <!--<option value='0'>seleccione</option>-->
                      </select>
                    </div></div>
                </span> </td>
...
$sql = "select codigo_departamento, nombre_departamento from tb_departamento";
    ...
    <input name="cmd_guardar" type="button" onClick="Validar(this.form)" id="cmd_guardar" value="Guardar Datos" >
      ...
      <table width="100%">
     	...
     	<tr>
     	  <td><? include("experiencia_laboral.php"); ?><!--se agrega para el boton guardar-->
    <!-- <p align="center">
    <input name="cmd_guardar" type="button" onClick="Validar(this.form)" id="cmd_guardar" value="Guardar Datos" >
  </p></td> -->
   	  </tr>
