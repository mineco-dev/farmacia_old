...
<table width="100%"  border="0">
  <tr>
    ...
    <td width="10%"><div align="center"><img src="imagen/consulta.gif" width="50" height="50"></div></td>
  </tr>
  <tr>
		...
		if (isset($obj)) //verifico si hay objeto seleccionado
		{
			...
			while($row_qry_plantilla=$fetch_array($res_qry_plantilla))
			{
				if (!isset($campo))
				{
					...
					if (!isset($nombrecampollave)) $nombrecampollave=$row_qry_plantilla["nombre_campo"];
