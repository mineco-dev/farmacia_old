      ...
      <tr align="center" bgcolor="#006699" class="thead">
		...
		<?
				...
				$consulta = "SELECT (a.apellido +' '+ a.apellido2 +' '+ a.apellidocasada +', '+ a.nombre +' '+ a.nombre2 +' '+ a.nombre3) as empleado, a.activo, a.idasesor, a.gafete,
							...
							where (a.apellido like '%$busqueda%' or a.apellido2 like '%$busqueda%' or a.nombre like '%$busqueda%' or a.nombre2 like '%$busqueda%' or d.nombre like '%$busqueda%' or a.gafete like '%$busqueda%') and g.oficial =1";
				...
				if (isset($_REQUEST["in"]))	
				{
					...
					if ($inicial!="all")
						$consulta = "SELECT (a.apellido +' '+ a.apellido2 +' '+ a.apellidocasada +', '+ a.nombre +' '+ a.nombre2 +' '+ a.nombre3) as empleado, a.activo, a.idasesor, a.gafete,
									...
									inner join tb_contratacion_gobierno g on a.idasesor=g.idasesor
									inner join direccion d on g.entidad_gobierno=d.iddireccion	
									where a.apellido like '$inicial%' and g.oficial =1";
				...
				else
				{
					$consulta =     "SELECT top 10(a.apellido +' '+ a.apellido2 +' '+ a.apellidocasada +', '+ a.nombre +' '+ a.nombre2 +' '+ a.nombre3) as empleado, a.activo, a.idasesor, a.gafete,
									...
									inner join tb_contratacion_gobierno g on a.idasesor=g.idasesor
									inner join direccion d on g.entidad_gobierno=d.iddireccion	
							     	where a.apellido like 'a%' and g.oficial =1";
				}
