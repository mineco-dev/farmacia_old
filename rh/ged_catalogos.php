...
<table width="100%"  border="0">
  ...
  <tr>
	...
	{	
		...
		{
			conectardb($rrhh);			
			//// devuelve la plantilla de acuerdo al tipo de objeto seleccionado	
				...
				$qry_insert.="usuario_modifico='$nombre_usuario', fecha_modificado=getdate(), activo=1 where $nombrecampollave=$txt_id";			
				$cnt=1;										
