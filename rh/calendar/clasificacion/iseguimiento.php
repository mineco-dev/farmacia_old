<?php 
						...
						$codigo_verificador = $_COOKIE['usuario1'];
...
<table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#f8f8f8" class="GrayBasicFont">
  <tr>
    <td height="285"><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><span class="HelpGrayOption"><img src="../imagen/seguimiento.jpg" alt="." width="237" height="30" /></span></td>
        <td>&nbsp;</td>
        </tr>
      <tr>
        <td colspan="2">&nbsp;
        <table width="100%" border="0" cellspacing="5" cellpadding="0">
          ...
          <tr>
            ...
            <td colspan="7" rowspan="5" class="RedMsgWriting"><p>El seguimiento se inserto correctamente </p>
              <p align="center"><a href="repdoctos.php" target="_self"><img src="../imagen/bac.jpg" alt="." width="71" height="18" border="0" /></a></p></td>
          </tr>
          <tr>
