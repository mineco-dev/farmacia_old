...
<h2 class="style4">&nbsp;</h2>
<FORM ACTION="itransferencia.php">
<table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#f8f8f8" class="GrayBasicFont">
  <tr>
    <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="583"><img src="../imagen/transferirexpedientes.jpg" alt="." width="237" height="30" /></td>
        <td width="71">&nbsp;</td>
        </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="0">
          <tr class="BasicFontInBorder2">
            ...
            <td colspan="7" class="HelpGrayOption">Expediente: <? print "2008-".$codigo;?>&nbsp;
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td class="label">       <input type="text" name="fecha" value = "<? print date("Y-m-d");?>" disabled />
	                    &nbsp;
            ...
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td class="BasicFontInBorder3"><div align="center"><span class="EditPreferencesBrackets">Asignacion de Estatus </span></div></td>
            </tr>
          <tr>
            <td width="1%" class="HelloUser">&nbsp;</td>
            <td width="13%" class="TuringHelp">Observaciones:</td>
            <td width="6%">&nbsp;</td>
            <td width="56%" class="label"><textarea name="observaciones" cols="50" rows="8"> </textarea></td>
            <td width="2%">&nbsp;</td>
            <td width="2%">&nbsp;</td>
            <td width="2%">&nbsp;</td>
            <td width="20%" class="Error404Title">
			  <div align="left">			    
          ...
          <tr>
            <td class="HelloUser">&nbsp;</td>
            <td class="TuringHelp">Verificador:</td>
            <td>&nbsp;</td>
            <td class="label"><select name="codigo_verificador" id="asigna">
                <?
						require ('../class/conexion.inc');
						$db = mysql_connect($SERVIDOR,$USUARIO,$PASSWORD);
						mysql_select_db($BASE_DATOS,$db);
						$select = mysql_query("SELECT codigo_verificador,nombre_verificador FROM tb_verificadores");
						if ($select)
						{
							while($vec = mysql_fetch_row($select))
							{	
...
&nbsp;</td>
          ...
          <tr>
            ...
            <td class="HelloUser">&nbsp;</td>
            <td>&nbsp;</td>
            <td><input name="btnInsertar" type="submit" value="Transferir Expediente">&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
