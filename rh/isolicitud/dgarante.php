...
<FORM ACTION="verificador1.php" method="post" name="form1" style="margin-bottom: 0">
		<div id="transparencia">
			<div id="transparenciaMensaje">aaaaaaaaaaaa</div>
		</div>
	<table width="828" align="left" class="dp-vb">
		<tbody>
		  ...
		  <tr align="left">
            <td colspan="4" bgcolor="#328DCF"><div align="center" class="vars"></div></td>
				...
				<tr>
				  ...
				  <td align="left">&nbsp;</td>
				  <td align="left" bgcolor="#F8F8F8"><input type="hidden" name="num_contrato" value="<? print $num_contrato;?>" />
			      <input type="hidden" name="logico" value="<? print $logico;?>" />
			      <input type="hidden" name="num_persona" value="<? print $row[24];?>" /></td>
		  </tr>
				<tr>
				  ...
				  <td align="left"><span class="campo">
					...
					$consulta=mysql_query("SELECT id_tipo_persona, descripcion FROM tb_tipo_persona WHERE id_tipo_persona = 5");
...
//					echo "<option value='0'>Elige</option>";
  ...
  &nbsp;</td>
				...
				<tr>
				  <td>&nbsp;</td>
				  <td bgcolor="#DDDDDD" class="mb_loading"><strong>El ACREEDOR GARANTIZADO se inscribe:</strong></td>
				...
				<tr>
				  <td class="label">&nbsp;</td>
				  <td bgcolor="#328DCF" class="campo"><input name="link" type="radio" class="dp_selected" value="agarantizado.php" /></td>
				  <td colspan="2" bgcolor="#328DCF" class="dp_selected"><label> Acreedor Garantizado como persona Individual</label></td>
		  </tr>
				<tr>
				  <td class="label">&nbsp;</td>
				  <td bgcolor="#328DCF" class="campo"><input name="link" type="radio" class="dp_selected" value="agarantizadog.php" /></td>
				  <td colspan="2" bgcolor="#328DCF" class="dp_selected"><label>Acreedor Garantizado  por medio de un Gestor Apoderado</label></td>
		  </tr>
				<tr>
				  <td class="label">&nbsp;</td>
				  <td bgcolor="#328DCF" class="campo"><span class="ayuda">
                    <input name="link" type="radio" class="dp_selected" value="agarantizador.php" />
                  </span></td>
