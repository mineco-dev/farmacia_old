...
if ($link == 'agarantizado.php')
{
	$vari = '1';
}
if ($link == 'agarantizadog.php')
{
	$vari = '6';
}
if ($link == 'agarantizador.php')
{
	$vari = '3';
}
...
<FORM ACTION="<? print $link?>" method="get" name="form1" style="margin-bottom: 0">
	...
	<table width="560" class="dp-vb">
		<tbody>
		  ...
		  <tr>
		    <td colspan="2" class="dp_today">VERIFICACION DE DATOS DEL ACREEDOR GARANTIZADO </td>
	      </tr>
		  <tr>
		    <td>&nbsp;</td>
		    <td align="left">&nbsp;</td>
		  ...
		  <tr>
		  <td width="108">&nbsp;</td>
		  <td width="238" align="left"><input type="hidden" name="num_contrato" value="<? print $num_contrato;?>" />
		    <input type="hidden" name="codigo_persona" value="<? print $codigo_persona;?>" /></td>
		  </tr>
