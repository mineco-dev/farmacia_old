...
<table width="100%"  border="0">
  <tr>
    <td width="18%" height="25"><div align="left"><img src="../images/rrhh123.png" width="301" height="95"></div></td>
    <td width="72%"><p align="center" class="titulocategoria Estilo1">DIRECCION DE RECURSOS HUMANOS </p>
      <p align="center" class="titulocategoria"> MANTENIMIENTO DE CATALOGOS </p></td>
    <td width="10%"><div align="center"><img src="imagen/rrhh12.png" width="62" height="56"></div></td>
  </tr>
  <tr>
		...
		if (isset($obj)) //verifico si hay objeto seleccionado
		{
			...
			while($row_qry_plantilla=$fetch_array($res_qry_plantilla))
			{
				...
				if ($row_qry_plantilla["codigo_tipo_campo"]==1)
				{
					...
					if (!isset($orden)) $orden=$row_qry_plantilla["nombre_campo"];

					$qry_datos_insertados="select * from $tabladestino order by $orden";					
				...
				if ($row_qry_plantilla["codigo_tipo_campo"]==5)
				{
					...
					echo '<input name="'.$row_qry_plantilla["nombre_campo"].'" type="text" id="'.$row_qry_plantilla["nombre_campo"].'" size="'.$row_qry_plantilla["tamano"].'" disabled>';
				}
				else
...
<br>
  ...
  <?	
	  ...
	  while($row_qry_insertados=$fetch_array($res_qry_insertados))
	  {
		  ...
		  if ($status==1)
		  	echo '<tr><td width="50">&nbsp;</td><td class='.$clase.'>'.$row_qry_insertados["1"].'</td><td class='.$clase.'><center><a href="ed_catalogos.php?id='.$row_qry_insertados[0].'&obj='.$obj.'"><img src="../images/iconos/ico_editar.gif" alt="Modificar" border="0"></a></center></td><td class='.$clase.'><center><a href="status.php?id='.$row_qry_insertados[0].'&st=2&txt_obj='.$obj.'"><img src="../images/iconos/ico_activo.gif" alt="Desactivar" border="0"></a></center></td></tr>';					
		  	else
			echo '<tr><td width="50">&nbsp;</td><td class='.$clase.'>'.$row_qry_insertados["1"].'</td><td class='.$clase.'><center><a href="ed_catalogos.php?id='.$row_qry_insertados[0].'&obj='.$obj.'"><img src="../images/iconos/ico_editar.gif" alt="Modificar" border="0"></a></center></td><td class='.$clase.'><center><a href="status.php?id='.$row_qry_insertados[0].'&st=1&txt_obj='.$obj.'"><img src="../images/iconos/ico_desactivado.gif" alt="Activar" border="0"></a></center></td></tr>';					
		  $i++;
	   }
