    ...
    <table width="100%" border="0" bordercolor="#ECE9D8">
      <tr>
        <td colspan="2"><div align="left" class="titulocategoria">
          <div align="center"> B&Uacute;SQUEDA DE EMPLEADOS MINECO </div>
        </div></td>
      </tr>
      <tr>
        <td colspan="2">&nbsp;</td>
      ...
      <tr>
        <td colspan="2"><strong><strong>[<a href="busca_persona.php?in=A" alt="Muestra los registros que inician con A">A</a>] [<a href="busca_persona.php?in=B">B</a>] [<a href="busca_persona.php?in=C">C</a>] [<a href="busca_persona.php?in=D">D</a>] [<a href="busca_persona.php?in=E">E</a>] [<a href="busca_persona.php?in=F">F</a>] [<a href="busca_persona.php?in=G">G</a>] [<a href="busca_persona.php?in=H">H</a>] [<a href="busca_persona.php?in=I">I</a>] [<a href="busca_persona.php?in=J">J</a>] [<a href="busca_persona.php?in=K">K</a>] [<a href="busca_persona.php?in=L">L</a>] [<a href="busca_persona.php?in=M">M</a>] [<a href="busca_persona.php?in=N">N</a>] [<a href="busca_persona.php?in=O">O</a>] [<a href="busca_persona.php?in=P">P</a>] [<a href="busca_persona.php?in=Q">Q</a>] [<a href="busca_persona.php?in=R">R</a>] [<a href="busca_persona.php?in=S">S</a>] [<a href="busca_persona.php?in=T">T</a>] [<a href="busca_persona.php?in=U">U</a>] [<a href="busca_persona.php?in=V">V</a>] [<a href="busca_persona.php?in=W">W</a>] [<a href="busca_persona.php?in=X">X</a>] [<a href="busca_persona.php?in=Y">Y</a>] [<a href="busca_persona.php?in=Z">Z</a>] <a href="busca_persona.php">[TODO]</a></strong></strong></td>
      </tr>
      <tr>
				...
				if (isset($_REQUEST["in"]))	
				{
					...
					if ($inicial!="all")
						$consulta = "SELECT (a.apellido +' '+ a.apellido2 +' '+ a.apellidocasada +', '+ a.nombre +' '+ a.nombre2 +' '+ a.nombre3) as empleado, a.activo, a.idasesor, a.gafete,
									...
									FROM asesor a 
									inner join tb_contratacion_gobierno g on a.idasesor=g.idasesor
									inner join direccion d on g.entidad_gobierno=d.iddireccion	
									where a.apellido like '%$inicial%' and g.oficial =1 and a.activo=1" ;
							...
							$consulta = "SELECT (a.apellido +' '+ a.apellido2 +' '+ a.apellidocasada +', '+ a.nombre +' '+ a.nombre2 +' '+ a.nombre3) as empleado, a.activo, a.idasesor, a.gafete,
										...
										inner join direccion d on g.entidad_gobierno=d.iddireccion											
										where a.activo=1
							 			order by a.apellido, a.apellido2, a.apellidocasada, a.nombre and a.activo=1";
				}
				else
				{
					$consulta =     "SELECT top 20(a.apellido +' '+ a.apellido2 +' '+ a.apellidocasada +', '+ a.nombre +' '+ a.nombre2 +' '+ a.nombre3) as empleado, a.activo, a.idasesor, a.gafete,
				                    d.nombre AS dependencia
									FROM asesor a 
									inner join tb_contratacion_gobierno g on a.idasesor=g.idasesor
									inner join direccion d on g.entidad_gobierno=d.iddireccion	
							     	where a.apellido like 'a%' and g.oficial =1  and a.activo=1"  ;
				}
				$servidordb=conectardb($rrhh);
