...
/*	if ( $sstipo != 1)
 ...
 if ( isset($_POST['inserta']) && ($_POST['inserta'] == 1) ) 
	{
		$verifica = "select actividad_economica from actividad_economica where actividad_economica = '$_POST[actividad]'";
		$resver = mssql_query($verifica);
		if (mssql_num_rows($resver) > 0) 
			{
			 envia_msg('La actividad economica que desea ingresar ya existe en el sistema');
			}
		else
			{
				$sql="insert into actividad_economica (actividad_economica) 
...
<form name="form1" method="post" action="actividad_economica.php" onSubmit="return Verifica()">
<!--form name="form1" method="post" action="asesoringreso.php"-->
  ...
  <tr bgcolor="#0066CC">
    <td colspan="7"><div align="center"><span class="Estilo1 Estilo2"> CATALOGO <BR> ACTIVIDAD ECON�MICA</span></div></td>
    </tr>
  <!--tr>
  ...
  <tr><Td><br></Td></tr>
  <tr class="Estilo1" >
    <td class="Estilo22" align="right">Actividad Econ�mica <font color="#FF0000"><strong>**</strong></font></td>
    <td class="Estilo7"><input name="actividad" type="text" class="Estilo7" maxsize="50"  size="50" onKeyUp="javascript:this.value=this.value.toUpperCase();"></td>
  </tr>
