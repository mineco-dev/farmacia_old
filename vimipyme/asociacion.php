...
/*	if ( $sstipo != 1)
 ...
 if ( isset($_POST['inserta']) && ($_POST['inserta'] == 1) ) 
	{
		$verifica = "select asociacion from camara_asociacion where asociacion = '$_POST[asociacion]'";
		$resver = mssql_query($verifica);
		if (mssql_num_rows($resver) > 0) 
			{
			 envia_msg('La Asociacion o C�mara que desea ingresar ya existe en el sistema');
			}
		else
			{
				$sql="insert into camara_asociacion (asociacion) 
						values ('$_POST[asociacion]') ";
...
<form name="form1" method="post" action="asociacion.php" onSubmit="return Verifica()">
<!--form name="form1" method="post" action="asesoringreso.php"-->
  ...
  <tr bgcolor="#0066CC">
    <td colspan="7"><div align="center"><span class="Estilo1 Estilo2"> CATALOGO <BR>
    ASOCIACIONES O CAMARAS </span></div></td>
    </tr>
  <!--tr>
  ...
  <tr><Td><br></Td></tr>
  <tr class="Estilo1" >
    <td class="Estilo22" align="right">Asociaci&oacute;n o C&aacute;mara<font color="#FF0000"><strong>**</strong></font></td>
    <td class="Estilo7"><input name="asociacion" type="text" class="Estilo7" maxsize="50"  size="50" onKeyUp="javascript:this.value=this.value.toUpperCase();"></td>
  </tr>
